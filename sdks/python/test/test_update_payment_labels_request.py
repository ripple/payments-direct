...
class TestUpdatePaymentLabelsRequest(unittest.TestCase):
    """UpdatePaymentLabelsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePaymentLabelsRequest:
        """Test UpdatePaymentLabelsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePaymentLabelsRequest`
        """
        model = UpdatePaymentLabelsRequest()
        if include_optional:
            return UpdatePaymentLabelsRequest(
                labels_to_add = [
    ...
    def testUpdatePaymentLabelsRequest(self):
        """Test UpdatePaymentLabelsRequest"""
