...
class TestAfricaBankPayout(unittest.TestCase):
    """AfricaBankPayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AfricaBankPayout:
        """Test AfricaBankPayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AfricaBankPayout`
        """
        model = AfricaBankPayout()
        if include_optional:
