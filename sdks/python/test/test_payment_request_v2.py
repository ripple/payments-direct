...
class TestPaymentRequestV2(unittest.TestCase):
    """PaymentRequestV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentRequestV2:
        """Test PaymentRequestV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentRequestV2`
        """
        model = PaymentRequestV2()
        if include_optional:
