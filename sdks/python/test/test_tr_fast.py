...
class TestTrFast(unittest.TestCase):
    """TrFast unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrFast:
        """Test TrFast
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrFast`
        """
        model = TrFast()
        if include_optional:
            return TrFast(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                iban = 'TR048072888001528021798096012345678910111213141516171819202122232425',
                bank_code = 'C0'
            )
        else:
            return TrFast(
