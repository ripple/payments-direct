...
class TestCreateFinancialInstrumentResponse(unittest.TestCase):
    """CreateFinancialInstrumentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateFinancialInstrumentResponse:
        """Test CreateFinancialInstrumentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateFinancialInstrumentResponse`
        """
        model = CreateFinancialInstrumentResponse()
        if include_optional:
            return CreateFinancialInstrumentResponse(
                financial_instrument_id = '2f4ac57f-c5ba-4051-b51f-b3565778717b'
            )
        else:
            return CreateFinancialInstrumentResponse(
                financial_instrument_id = '2f4ac57f-c5ba-4051-b51f-b3565778717b',
    ...
    def testCreateFinancialInstrumentResponse(self):
        """Test CreateFinancialInstrumentResponse"""
