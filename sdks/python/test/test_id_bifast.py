...
class TestIdBifast(unittest.TestCase):
    """IdBifast unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdBifast:
        """Test IdBifast
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdBifast`
        """
        model = IdBifast()
        if include_optional:
            return IdBifast(
