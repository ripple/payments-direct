...
class TestBusinessIdentityLocalizedHanzi(unittest.TestCase):
    """BusinessIdentityLocalizedHanzi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessIdentityLocalizedHanzi:
        """Test BusinessIdentityLocalizedHanzi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessIdentityLocalizedHanzi`
        """
        model = BusinessIdentityLocalizedHanzi()
        if include_optional:
            return BusinessIdentityLocalizedHanzi(
    ...
    def testBusinessIdentityLocalizedHanzi(self):
        """Test BusinessIdentityLocalizedHanzi"""
