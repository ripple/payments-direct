...
class TestQuoteApi(unittest.TestCase):
    ...
    def test_create_quote_collection_v2(self) -> None:
        """Test case for create_quote_collection_v2

        Create quote collection
        """
        pass

    def test_get_quote_collection_v2(self) -> None:
        """Test case for get_quote_collection_v2

        Get quote collection
        """
        pass

    def test_get_quote_v2(self) -> None:
        """Test case for get_quote_v2
