...
class TestGetBalances400ResponseErrorsInner(unittest.TestCase):
    """GetBalances400ResponseErrorsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBalances400ResponseErrorsInner:
        """Test GetBalances400ResponseErrorsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBalances400ResponseErrorsInner`
        """
        model = GetBalances400ResponseErrorsInner()
        if include_optional:
            return GetBalances400ResponseErrorsInner(
                code = 'SYS_003',
                type = 'SYSTEM_ERROR',
    ...
    def testGetBalances400ResponseErrorsInner(self):
        """Test GetBalances400ResponseErrorsInner"""
