...
class TestBusinessIdentityRegistrationInner(unittest.TestCase):
    """BusinessIdentityRegistrationInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessIdentityRegistrationInner:
        """Test BusinessIdentityRegistrationInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessIdentityRegistrationInner`
        """
        model = BusinessIdentityRegistrationInner()
        if include_optional:
            return BusinessIdentityRegistrationInner(
                number = '123ABC',
    ...
    def testBusinessIdentityRegistrationInner(self):
        """Test BusinessIdentityRegistrationInner"""
