...
class TestSearchPaymentsRequestV2(unittest.TestCase):
    """SearchPaymentsRequestV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchPaymentsRequestV2:
        """Test SearchPaymentsRequestV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchPaymentsRequestV2`
        """
        model = SearchPaymentsRequestV2()
        if include_optional:
            return SearchPaymentsRequestV2(
    ...
    def testSearchPaymentsRequestV2(self):
        """Test SearchPaymentsRequestV2"""
