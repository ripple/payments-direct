...
class TestCnIndividual(unittest.TestCase):
    """CnIndividual unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CnIndividual:
        """Test CnIndividual
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CnIndividual`
        """
        model = CnIndividual()
        if include_optional:
            return CnIndividual(
