...
class TestBusinessIdentityAddress(unittest.TestCase):
    """BusinessIdentityAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessIdentityAddress:
        """Test BusinessIdentityAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessIdentityAddress`
        """
        model = BusinessIdentityAddress()
        if include_optional:
            return BusinessIdentityAddress(
    ...
    def testBusinessIdentityAddress(self):
        """Test BusinessIdentityAddress"""
