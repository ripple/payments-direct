...
class TestIndividualIdentityAddress(unittest.TestCase):
    """IndividualIdentityAddress unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndividualIdentityAddress:
        """Test IndividualIdentityAddress
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndividualIdentityAddress`
        """
        model = IndividualIdentityAddress()
        if include_optional:
            return IndividualIdentityAddress(
    ...
    def testIndividualIdentityAddress(self):
        """Test IndividualIdentityAddress"""
