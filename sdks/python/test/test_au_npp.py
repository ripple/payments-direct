...
class TestAuNpp(unittest.TestCase):
    """AuNpp unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AuNpp:
        """Test AuNpp
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AuNpp`
        """
        model = AuNpp()
        if include_optional:
            return AuNpp(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                bsb_code = '048072012345',
                account_number = '40'
            )
        else:
            return AuNpp(
