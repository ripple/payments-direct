...
class TestTronWallet(unittest.TestCase):
    """TronWallet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TronWallet:
        """Test TronWallet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TronWallet`
        """
        model = TronWallet()
        if include_optional:
            return TronWallet(
