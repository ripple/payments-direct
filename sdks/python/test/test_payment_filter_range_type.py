...
class TestPaymentFilterRangeType(unittest.TestCase):
    """PaymentFilterRangeType unit test stubs"""
    ...
    def testPaymentFilterRangeType(self):
        """Test PaymentFilterRangeType"""
        # inst = PaymentFilterRangeType()
