...
class TestPayoutExecutionDetails(unittest.TestCase):
    """PayoutExecutionDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PayoutExecutionDetails:
        """Test PayoutExecutionDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PayoutExecutionDetails`
        """
        model = PayoutExecutionDetails()
        if include_optional:
    ...
    def testPayoutExecutionDetails(self):
        """Test PayoutExecutionDetails"""
