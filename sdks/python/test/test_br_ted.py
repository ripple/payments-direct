...
class TestBrTed(unittest.TestCase):
    """BrTed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrTed:
        """Test BrTed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrTed`
        """
        model = BrTed()
        if include_optional:
            return BrTed(
