...
class TestTransactionDetailsV2(unittest.TestCase):
    """TransactionDetailsV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TransactionDetailsV2:
        """Test TransactionDetailsV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TransactionDetailsV2`
        """
        model = TransactionDetailsV2()
        if include_optional:
    ...
    def testTransactionDetailsV2(self):
        """Test TransactionDetailsV2"""
