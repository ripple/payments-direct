...
class TestPaymentFilter(unittest.TestCase):
    """PaymentFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentFilter:
        """Test PaymentFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentFilter`
        """
        model = PaymentFilter()
        if include_optional:
