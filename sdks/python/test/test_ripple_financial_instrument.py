...
class TestRippleFinancialInstrument(unittest.TestCase):
    """RippleFinancialInstrument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RippleFinancialInstrument:
        """Test RippleFinancialInstrument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RippleFinancialInstrument`
        """
        model = RippleFinancialInstrument()
        if include_optional:
            return RippleFinancialInstrument(
    ...
    def testRippleFinancialInstrument(self):
        """Test RippleFinancialInstrument"""
