...
class TestPaymentFilterV2(unittest.TestCase):
    """PaymentFilterV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentFilterV2:
        """Test PaymentFilterV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentFilterV2`
        """
        model = PaymentFilterV2()
        if include_optional:
            return PaymentFilterV2(
                payment_ids = [
