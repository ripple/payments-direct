...
class TestFeeSummaryV2(unittest.TestCase):
    """FeeSummaryV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeeSummaryV2:
        """Test FeeSummaryV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FeeSummaryV2`
        """
        model = FeeSummaryV2()
        if include_optional:
            return FeeSummaryV2(
