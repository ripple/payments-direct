...
class TestCnTrade(unittest.TestCase):
    """CnTrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CnTrade:
        """Test CnTrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CnTrade`
        """
        model = CnTrade()
        if include_optional:
            return CnTrade(
