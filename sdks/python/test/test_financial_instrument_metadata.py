...
class TestFinancialInstrumentMetadata(unittest.TestCase):
    """FinancialInstrumentMetadata unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FinancialInstrumentMetadata:
        """Test FinancialInstrumentMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FinancialInstrumentMetadata`
        """
        model = FinancialInstrumentMetadata()
        if include_optional:
            return FinancialInstrumentMetadata(
    ...
    def testFinancialInstrumentMetadata(self):
        """Test FinancialInstrumentMetadata"""
