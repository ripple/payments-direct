...
class TestIndividualIdentity(unittest.TestCase):
    """IndividualIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndividualIdentity:
        """Test IndividualIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndividualIdentity`
        """
    ...
    def testIndividualIdentity(self):
        """Test IndividualIdentity"""
