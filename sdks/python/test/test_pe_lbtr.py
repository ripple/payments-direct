...
class TestPeLbtr(unittest.TestCase):
    """PeLbtr unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeLbtr:
        """Test PeLbtr
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeLbtr`
        """
        model = PeLbtr()
        if include_optional:
            return PeLbtr(
