...
class TestListFinancialInstrumentsResponse(unittest.TestCase):
    """ListFinancialInstrumentsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListFinancialInstrumentsResponse:
        """Test ListFinancialInstrumentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListFinancialInstrumentsResponse`
        """
        model = ListFinancialInstrumentsResponse()
        if include_optional:
            return ListFinancialInstrumentsResponse(
                data = [
                    ripple_payments_direct.models.financial_instrument_metadata.financial-instrument-metadata(
    ...
    def testListFinancialInstrumentsResponse(self):
        """Test ListFinancialInstrumentsResponse"""
