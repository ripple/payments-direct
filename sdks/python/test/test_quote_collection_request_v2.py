...
class TestQuoteCollectionRequestV2(unittest.TestCase):
    """QuoteCollectionRequestV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteCollectionRequestV2:
        """Test QuoteCollectionRequestV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteCollectionRequestV2`
        """
        model = QuoteCollectionRequestV2()
        if include_optional:
            return QuoteCollectionRequestV2(
                quote_amount = 123.45,
    ...
    def testQuoteCollectionRequestV2(self):
        """Test QuoteCollectionRequestV2"""
