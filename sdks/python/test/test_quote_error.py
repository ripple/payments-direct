...
class TestQuoteError(unittest.TestCase):
    """QuoteError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteError:
        """Test QuoteError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteError`
        """
        model = QuoteError()
        if include_optional:
            return QuoteError(
