...
class TestPutRippleFinancialInstrument(unittest.TestCase):
    """PutRippleFinancialInstrument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutRippleFinancialInstrument:
        """Test PutRippleFinancialInstrument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutRippleFinancialInstrument`
        """
        model = PutRippleFinancialInstrument()
        if include_optional:
            return PutRippleFinancialInstrument(
    ...
    def testPutRippleFinancialInstrument(self):
        """Test PutRippleFinancialInstrument"""
