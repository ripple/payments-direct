...
class TestGetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner(unittest.TestCase):
    """GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner:
        """Test GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner`
        """
        model = GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner()
        if include_optional:
            return GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner(
                tenant = 'rocketfuel',
                amount = 100,
                currency = 'USD',
                operation = '',
                txn_source = '',
                status = '',
                created_dttm = '2024-06-01T00:00Z',
                updated_dttm = '2024-06-01T00:00Z',
    ...
    def testGetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner(self):
        """Test GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner"""
