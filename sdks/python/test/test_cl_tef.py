...
class TestClTef(unittest.TestCase):
    """ClTef unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClTef:
        """Test ClTef
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClTef`
        """
        model = ClTef()
        if include_optional:
            return ClTef(
