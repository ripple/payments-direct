...
class TestRippleFinancialInstrumentEntry(unittest.TestCase):
    """RippleFinancialInstrumentEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RippleFinancialInstrumentEntry:
        """Test RippleFinancialInstrumentEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RippleFinancialInstrumentEntry`
        """
        model = RippleFinancialInstrumentEntry()
        if include_optional:
            return RippleFinancialInstrumentEntry(
    ...
    def testRippleFinancialInstrumentEntry(self):
        """Test RippleFinancialInstrumentEntry"""
