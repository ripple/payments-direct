...
class TestTotalFeeBreakdownV2(unittest.TestCase):
    """TotalFeeBreakdownV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotalFeeBreakdownV2:
        """Test TotalFeeBreakdownV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotalFeeBreakdownV2`
        """
        model = TotalFeeBreakdownV2()
        if include_optional:
            return TotalFeeBreakdownV2(
                calculated_fee = 2.43,
    ...
    def testTotalFeeBreakdownV2(self):
        """Test TotalFeeBreakdownV2"""
