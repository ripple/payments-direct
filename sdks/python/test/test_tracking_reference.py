...
class TestTrackingReference(unittest.TestCase):
    """TrackingReference unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackingReference:
        """Test TrackingReference
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingReference`
        """
        model = TrackingReference()
        if include_optional:
    ...
    def testTrackingReference(self):
        """Test TrackingReference"""
