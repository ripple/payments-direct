...
class TestTotalFeeBreakdown(unittest.TestCase):
    """TotalFeeBreakdown unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TotalFeeBreakdown:
        """Test TotalFeeBreakdown
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TotalFeeBreakdown`
        """
        model = TotalFeeBreakdown()
        if include_optional:
    ...
    def testTotalFeeBreakdown(self):
        """Test TotalFeeBreakdown"""
