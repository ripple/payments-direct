...
class TestQuoteCollection(unittest.TestCase):
    """QuoteCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteCollection:
        """Test QuoteCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteCollection`
        """
        ...
        if include_optional:
            return QuoteCollection(
                ...
                quotes = [
                    ripple_payments_direct.models.quote.Quote(
