...
class TestGetBalances200ResponseBalancesInner(unittest.TestCase):
    """GetBalances200ResponseBalancesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBalances200ResponseBalancesInner:
        """Test GetBalances200ResponseBalancesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBalances200ResponseBalancesInner`
        """
        model = GetBalances200ResponseBalancesInner()
        if include_optional:
    ...
    def testGetBalances200ResponseBalancesInner(self):
        """Test GetBalances200ResponseBalancesInner"""
