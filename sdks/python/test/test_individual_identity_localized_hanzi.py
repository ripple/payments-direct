...
class TestIndividualIdentityLocalizedHanzi(unittest.TestCase):
    """IndividualIdentityLocalizedHanzi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndividualIdentityLocalizedHanzi:
        """Test IndividualIdentityLocalizedHanzi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndividualIdentityLocalizedHanzi`
        """
        model = IndividualIdentityLocalizedHanzi()
        if include_optional:
            return IndividualIdentityLocalizedHanzi(
                first_name = '伟',
                last_name = '张',
    ...
    def testIndividualIdentityLocalizedHanzi(self):
        """Test IndividualIdentityLocalizedHanzi"""
