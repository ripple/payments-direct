...
class TestQuoteCollectionV2(unittest.TestCase):
    """QuoteCollectionV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteCollectionV2:
        """Test QuoteCollectionV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteCollectionV2`
        """
        model = QuoteCollectionV2()
        if include_optional:
            return QuoteCollectionV2(
                quote_collection_id = '11111111-aaaa-2222-bbbb-222222222222',
                quotes = [
                    ripple_payments_direct.models.quote_v2.QuoteV2(
                        quote_id = '7ea3399c-1234-5678-8d8f-d320ea406630', 
                        quote_status = 'ACTIVE', 
                        quote_amount_type = 'SOURCE_AMOUNT', 
                        source_amount = 123.45, 
                        destination_amount = 2438.19, 
                        source_currency = 'USD', 
                        destination_currency = 'MXN', 
                        source_country = 'US', 
                        destination_country = 'MX', 
                        payin_category = 'PRE_FUNDING', 
                        adjusted_exchange_rate = ripple_payments_direct.models.adjusted_exchange_rate.AdjustedExchangeRate(
                            adjusted_rate = 2, ), 
                        fees = [
                            ripple_payments_direct.models.fee_summary_v2.FeeSummaryV2(
                                total_fee = 12.23, 
                                fee_currency = 'USD', 
                                fee_breakdown = [
                                    ripple_payments_direct.models.total_fee_breakdown_v2.TotalFeeBreakdownV2(
                                        calculated_fee = 2.43, 
                                        fee_name = 'Service fee', 
                                        fee_description = 'The service fee charged for this transaction.', 
                                        payment_rail = 'ACH/ Wire etc', )
                                    ], )
                            ], 
                        taxes = [
                        ...
                        created_at = '2023-11-02T18:26:00.000123Z', 
                        expires_at = '2023-11-02T18:26:00.000123Z', 
                        payment_rail = 'SPEI', )
                    ]
            )
        else:
    ...
    def testQuoteCollectionV2(self):
        """Test QuoteCollectionV2"""
