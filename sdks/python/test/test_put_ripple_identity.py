...
class TestPutRippleIdentity(unittest.TestCase):
    """PutRippleIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutRippleIdentity:
        """Test PutRippleIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutRippleIdentity`
        """
        model = PutRippleIdentity()
        if include_optional:
            return PutRippleIdentity(
    ...
    def testPutRippleIdentity(self):
        """Test PutRippleIdentity"""
