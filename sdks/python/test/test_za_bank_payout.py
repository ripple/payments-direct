...
class TestZaBankPayout(unittest.TestCase):
    """ZaBankPayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZaBankPayout:
        """Test ZaBankPayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZaBankPayout`
        """
        model = ZaBankPayout()
        if include_optional:
            return ZaBankPayout(
