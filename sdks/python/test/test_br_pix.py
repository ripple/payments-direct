...
class TestBrPix(unittest.TestCase):
    """BrPix unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BrPix:
        """Test BrPix
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BrPix`
        """
        model = BrPix()
        if include_optional:
            return BrPix(
                ...
                bank_code = 'C01234567',
                branch_number = '04800123',
                pix_key = ERROR_TO_EXAMPLE_VALUE,
                pix_key_type = ''
            )
        else:
            return BrPix(
