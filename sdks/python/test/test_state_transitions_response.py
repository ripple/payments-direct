...
class TestStateTransitionsResponse(unittest.TestCase):
    """StateTransitionsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateTransitionsResponse:
        """Test StateTransitionsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateTransitionsResponse`
        """
        model = StateTransitionsResponse()
        if include_optional:
            return StateTransitionsResponse(
                state_transitions = [
                    ripple_payments_direct.models.state_transition.StateTransition(
    ...
    def testStateTransitionsResponse(self):
        """Test StateTransitionsResponse"""
