...
class TestLedgerPublicApi(unittest.TestCase):
    """LedgerPublicApi unit test stubs"""

    def setUp(self) -> None:
        self.api = LedgerPublicApi()
    ...
    def test_get_statements_transactions_for_customer(self) -> None:
        """Test case for get_statements_transactions_for_customer
