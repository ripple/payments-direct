...
class TestPutIdentityRequestV3(unittest.TestCase):
    """PutIdentityRequestV3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutIdentityRequestV3:
        """Test PutIdentityRequestV3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutIdentityRequestV3`
        """
        model = PutIdentityRequestV3()
        if include_optional:
            return PutIdentityRequestV3(
                nick_name = 'nickName',
    ...
    def testPutIdentityRequestV3(self):
        """Test PutIdentityRequestV3"""
