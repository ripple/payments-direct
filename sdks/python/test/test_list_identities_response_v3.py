...
class TestListIdentitiesResponseV3(unittest.TestCase):
    """ListIdentitiesResponseV3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ListIdentitiesResponseV3:
        """Test ListIdentitiesResponseV3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ListIdentitiesResponseV3`
        """
        model = ListIdentitiesResponseV3()
        if include_optional:
            return ListIdentitiesResponseV3(
                data = [
                    ripple_payments_direct.models.identity_response_v3.identity-response-v3(
                        ...
                        nick_name = 'nickName', 
                        internal_id = '2f4ac57f-c5ba-4051-b51f-b3565778717b', 
                        tags = [
                            'tag1'
                            ], 
                        version = 2, 
    ...
    def testListIdentitiesResponseV3(self):
        """Test ListIdentitiesResponseV3"""
