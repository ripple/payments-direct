...
class TestUgBankPayout(unittest.TestCase):
    """UgBankPayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UgBankPayout:
        """Test UgBankPayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UgBankPayout`
        """
        model = UgBankPayout()
        if include_optional:
            return UgBankPayout(
