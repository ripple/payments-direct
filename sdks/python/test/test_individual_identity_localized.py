...
class TestIndividualIdentityLocalized(unittest.TestCase):
    """IndividualIdentityLocalized unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndividualIdentityLocalized:
        """Test IndividualIdentityLocalized
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndividualIdentityLocalized`
        """
        model = IndividualIdentityLocalized()
        if include_optional:
            return IndividualIdentityLocalized(
    ...
    def testIndividualIdentityLocalized(self):
        """Test IndividualIdentityLocalized"""
