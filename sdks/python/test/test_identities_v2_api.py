...
class TestIdentitiesV2Api(unittest.TestCase):
    """IdentitiesV2Api unit test stubs"""

    def setUp(self) -> None:
        self.api = IdentitiesV2Api()

    def tearDown(self) -> None:
        pass

    def test_create_identity_v2(self) -> None:
        """Test case for create_identity_v2

        Create a new identity
        """
        pass

    def test_deactivate_identity_v2(self) -> None:
        """Test case for deactivate_identity_v2

        Delete an identity
        """
        pass

    def test_get_identities_v2(self) -> None:
        """Test case for get_identities_v2

        Get a list of identities
        """
        pass

    def test_get_identity_by_id_v2(self) -> None:
        """Test case for get_identity_by_id_v2
