...
class TestStateTransitionsResponseV2(unittest.TestCase):
    """StateTransitionsResponseV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateTransitionsResponseV2:
        """Test StateTransitionsResponseV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateTransitionsResponseV2`
        """
        model = StateTransitionsResponseV2()
        if include_optional:
            return StateTransitionsResponseV2(
                state_transitions = [
                    ripple_payments_direct.models.state_transition_v2.StateTransitionV2(
                        updated_from = 'INITIATED', 
                        updated_to = 'INITIATED', 
                        updated_at = '2024-08-13T20:15:50.990995Z', )
                    ]
            )
        else:
            return StateTransitionsResponseV2(
    ...
    def testStateTransitionsResponseV2(self):
        """Test StateTransitionsResponseV2"""
