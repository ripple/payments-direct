...
class TestCnIndividualTrade(unittest.TestCase):
    """CnIndividualTrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CnIndividualTrade:
        """Test CnIndividualTrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CnIndividualTrade`
        """
        model = CnIndividualTrade()
        if include_optional:
            return CnIndividualTrade(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                account_number = 'C0',
                account_holder_name = 'N0'
            )
        else:
            return CnIndividualTrade(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
    ...
    def testCnIndividualTrade(self):
        """Test CnIndividualTrade"""
