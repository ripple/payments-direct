...
class TestGetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner(unittest.TestCase):
    """GetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner:
        """Test GetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner`
        """
        model = GetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner()
        if include_optional:
    ...
    def testGetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner(self):
        """Test GetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner"""
