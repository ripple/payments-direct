...
class TestNgBankPayout(unittest.TestCase):
    """NgBankPayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NgBankPayout:
        """Test NgBankPayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NgBankPayout`
        """
        model = NgBankPayout()
        if include_optional:
            return NgBankPayout(
