...
class TestHkBankPayout(unittest.TestCase):
    """HkBankPayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HkBankPayout:
        """Test HkBankPayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HkBankPayout`
        """
        model = HkBankPayout()
        if include_optional:
            return HkBankPayout(
                ...
                swift_code = 'AEIOTGCKC0L01234567',
                currency = 'E012'
            )
        else:
            return HkBankPayout(
