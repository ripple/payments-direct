...
class TestIndividualIdentityIdentityDocumentsInner(unittest.TestCase):
    """IndividualIdentityIdentityDocumentsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IndividualIdentityIdentityDocumentsInner:
        """Test IndividualIdentityIdentityDocumentsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IndividualIdentityIdentityDocumentsInner`
        """
        model = IndividualIdentityIdentityDocumentsInner()
        if include_optional:
            return IndividualIdentityIdentityDocumentsInner(
                id_number = '123ABC',
                id_type = '',
    ...
    def testIndividualIdentityIdentityDocumentsInner(self):
        """Test IndividualIdentityIdentityDocumentsInner"""
