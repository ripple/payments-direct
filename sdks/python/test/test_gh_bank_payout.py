...
class TestGhBankPayout(unittest.TestCase):
    """GhBankPayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GhBankPayout:
        """Test GhBankPayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GhBankPayout`
        """
        model = GhBankPayout()
        if include_optional:
            return GhBankPayout(
