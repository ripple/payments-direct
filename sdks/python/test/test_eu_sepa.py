...
class TestEuSepa(unittest.TestCase):
    """EuSepa unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EuSepa:
        """Test EuSepa
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EuSepa`
        """
        model = EuSepa()
        if include_optional:
            return EuSepa(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                iban = 'AE80GCKEC0L3O4GI7XHK0J01234567891011121314'
            )
        else:
            return EuSepa(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
