...
class TestStateTransitionV2(unittest.TestCase):
    """StateTransitionV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StateTransitionV2:
        """Test StateTransitionV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StateTransitionV2`
        """
        model = StateTransitionV2()
        if include_optional:
    ...
    def testStateTransitionV2(self):
        """Test StateTransitionV2"""
