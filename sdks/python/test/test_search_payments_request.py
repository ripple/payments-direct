...
class TestSearchPaymentsRequest(unittest.TestCase):
    """SearchPaymentsRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchPaymentsRequest:
        """Test SearchPaymentsRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchPaymentsRequest`
        """
        model = SearchPaymentsRequest()
        if include_optional:
    ...
    def testSearchPaymentsRequest(self):
        """Test SearchPaymentsRequest"""
