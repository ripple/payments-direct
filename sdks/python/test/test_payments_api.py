...
class TestPaymentsApi(unittest.TestCase):
    ...
    def test_get_payment_state_transitions_by_id(self) -> None:
        """Test case for get_payment_state_transitions_by_id

        Get state transitions by payment ID
        """
        pass

    def test_search_payments(self) -> None:
    ...
    def test_update_payment_labels(self) -> None:
        """Test case for update_payment_labels
