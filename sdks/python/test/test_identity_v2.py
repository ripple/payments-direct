...
class TestIdentityV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> IdentityV2:
        """Test IdentityV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityV2`
        """
        model = IdentityV2()
        if include_optional:
            return IdentityV2(
