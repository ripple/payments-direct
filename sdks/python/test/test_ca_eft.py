...
class TestCaEft(unittest.TestCase):
    """CaEft unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CaEft:
        """Test CaEft
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CaEft`
        """
        model = CaEft()
        if include_optional:
            return CaEft(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                institution_number = '4012',
                transit_number = '401234',
                account_number = '40123456',
                account_type = ''
            )
        else:
            return CaEft(
