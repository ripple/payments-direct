...
class TestGetBalances200Response(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetBalances200Response:
        """Test GetBalances200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBalances200Response`
        """
        model = GetBalances200Response()
        if include_optional:
            return GetBalances200Response(
                timestamp = '2025-01-10T00:00Z',
                balances = [
