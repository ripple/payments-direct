...
class TestArInterbanking(unittest.TestCase):
    """ArInterbanking unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArInterbanking:
        """Test ArInterbanking
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArInterbanking`
        """
        model = ArInterbanking()
        if include_optional:
            return ArInterbanking(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                bank_code = '048012',
                account_number = '04807288800152802179800123456789101112131415161718192021',
                account_type = ''
            )
        else:
            return ArInterbanking(
