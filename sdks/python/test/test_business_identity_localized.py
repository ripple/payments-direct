...
class TestBusinessIdentityLocalized(unittest.TestCase):
    """BusinessIdentityLocalized unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessIdentityLocalized:
        """Test BusinessIdentityLocalized
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessIdentityLocalized`
        """
        model = BusinessIdentityLocalized()
        if include_optional:
            return BusinessIdentityLocalized(
    ...
    def testBusinessIdentityLocalized(self):
        """Test BusinessIdentityLocalized"""
