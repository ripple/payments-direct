...
class TestAeIpi(unittest.TestCase):
    """AeIpi unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AeIpi:
        """Test AeIpi
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AeIpi`
        """
        model = AeIpi()
        if include_optional:
            return AeIpi(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                iban = 'AE048072888001528021798012345678910111213141516171819202122'
            )
        else:
            return AeIpi(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
