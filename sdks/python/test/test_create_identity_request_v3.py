...
class TestCreateIdentityRequestV3(unittest.TestCase):
    """CreateIdentityRequestV3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateIdentityRequestV3:
        """Test CreateIdentityRequestV3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateIdentityRequestV3`
        """
        model = CreateIdentityRequestV3()
        if include_optional:
            return CreateIdentityRequestV3(
                nick_name = 'nickName',
    ...
    def testCreateIdentityRequestV3(self):
        """Test CreateIdentityRequestV3"""
