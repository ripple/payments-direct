...
class TestThPromptpay(unittest.TestCase):
    """ThPromptpay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThPromptpay:
        """Test ThPromptpay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThPromptpay`
        """
        model = ThPromptpay()
        if include_optional:
            return ThPromptpay(
