...
class TestRwBankPayout(unittest.TestCase):
    """RwBankPayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RwBankPayout:
        """Test RwBankPayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RwBankPayout`
        """
        model = RwBankPayout()
        if include_optional:
            return RwBankPayout(
