...
class TestGetStatementsTransactionsForCustomer200ResponseInner(unittest.TestCase):
    """GetStatementsTransactionsForCustomer200ResponseInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetStatementsTransactionsForCustomer200ResponseInner:
        """Test GetStatementsTransactionsForCustomer200ResponseInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetStatementsTransactionsForCustomer200ResponseInner`
        """
        model = GetStatementsTransactionsForCustomer200ResponseInner()
        if include_optional:
            return GetStatementsTransactionsForCustomer200ResponseInner(
                ...
                statement_transactions = [
                    ripple_payments_direct.models.get_statements_transactions_for_customer_200_response_inner_statement_transactions_inner.getStatementsTransactionsForCustomer_200_response_inner_statementTransactions_inner(
                        tenant = 'rocketfuel', 
                        amount = 100, 
                        currency = 'USD', 
                        operation = '', 
    ...
    def testGetStatementsTransactionsForCustomer200ResponseInner(self):
        """Test GetStatementsTransactionsForCustomer200ResponseInner"""
