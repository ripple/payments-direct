...
class TestAdjustedExchangeRate(unittest.TestCase):
    """AdjustedExchangeRate unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdjustedExchangeRate:
        """Test AdjustedExchangeRate
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdjustedExchangeRate`
        """
        model = AdjustedExchangeRate()
        if include_optional:
    ...
    def testAdjustedExchangeRate(self):
        """Test AdjustedExchangeRate"""
