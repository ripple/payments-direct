...
class TestUpdatePaymentLabelsResponse(unittest.TestCase):
    """UpdatePaymentLabelsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePaymentLabelsResponse:
        """Test UpdatePaymentLabelsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePaymentLabelsResponse`
        """
        model = UpdatePaymentLabelsResponse()
        if include_optional:
    ...
    def testUpdatePaymentLabelsResponse(self):
        """Test UpdatePaymentLabelsResponse"""
