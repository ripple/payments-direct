...
class TestCnCfxps(unittest.TestCase):
    """CnCfxps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CnCfxps:
        """Test CnCfxps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CnCfxps`
        """
        model = CnCfxps()
        if include_optional:
            return CnCfxps(
