...
class TestGetFinancialInstrumentResponse(unittest.TestCase):
    """GetFinancialInstrumentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetFinancialInstrumentResponse:
        """Test GetFinancialInstrumentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetFinancialInstrumentResponse`
        """
        model = GetFinancialInstrumentResponse()
        if include_optional:
            return GetFinancialInstrumentResponse(
                financial_instrument = None,
                identity = ripple_payments_direct.models.get_identity_response_v3.get-identity-response-v3(
    ...
    def testGetFinancialInstrumentResponse(self):
        """Test GetFinancialInstrumentResponse"""
