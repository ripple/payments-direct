...
class TestUsFedwire(unittest.TestCase):
    """UsFedwire unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsFedwire:
        """Test UsFedwire
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsFedwire`
        """
        model = UsFedwire()
        if include_optional:
            return UsFedwire(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                bank_routing_number = '4012345678',
                account_number = '40123'
            )
        else:
            return UsFedwire(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
