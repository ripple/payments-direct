...
class TestGetBalances400Response(unittest.TestCase):
    """GetBalances400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GetBalances400Response:
        """Test GetBalances400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetBalances400Response`
        """
        model = GetBalances400Response()
        if include_optional:
            return GetBalances400Response(
                status = 400,
                errors = [
                    ripple_payments_direct.models.get_balances_400_response_errors_inner.getBalances_400_response_errors_inner(
                        code = 'SYS_003', 
                        type = 'SYSTEM_ERROR', 
                        title = 'Internal Server Error', 
                        description = 'The payout category value must be one of BANK, EWALLET, CASH_PICKUP, or ATM.', 
                        timestamp = '2024-01-02T14:16Z', )
                    ]
            )
        else:
            return GetBalances400Response(
    ...
    def testGetBalances400Response(self):
        """Test GetBalances400Response"""
