...
class TestMxSpei(unittest.TestCase):
    """MxSpei unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MxSpei:
        """Test MxSpei
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MxSpei`
        """
        model = MxSpei()
        if include_optional:
            return MxSpei(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                clabe = '401234567891011121314151617'
            )
        else:
            return MxSpei(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
