...
class TestSolWallet(unittest.TestCase):
    """SolWallet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SolWallet:
        """Test SolWallet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SolWallet`
        """
        model = SolWallet()
        if include_optional:
            return SolWallet(
