...
class TestZmBankPayout(unittest.TestCase):
    """ZmBankPayout unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZmBankPayout:
        """Test ZmBankPayout
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ZmBankPayout`
        """
        model = ZmBankPayout()
        if include_optional:
            return ZmBankPayout(
