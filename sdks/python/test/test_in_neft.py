...
class TestInNeft(unittest.TestCase):
    """InNeft unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InNeft:
        """Test InNeft
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InNeft`
        """
        model = InNeft()
        if include_optional:
            return InNeft(
                bank_name = ERROR_TO_EXAMPLE_VALUE,
                ifsc_code = 'AEIO0ZGCKEC012345678910',
