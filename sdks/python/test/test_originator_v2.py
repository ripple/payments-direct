...
class TestOriginatorV2(unittest.TestCase):
    """OriginatorV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OriginatorV2:
        """Test OriginatorV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OriginatorV2`
        """
        model = OriginatorV2()
        if include_optional:
            return OriginatorV2(
