...
class TestJpZengin(unittest.TestCase):
    """JpZengin unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JpZengin:
        """Test JpZengin
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JpZengin`
        """
        model = JpZengin()
        if include_optional:
            return JpZengin(
