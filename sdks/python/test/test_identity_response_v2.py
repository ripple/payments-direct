...
class TestIdentityResponseV2(unittest.TestCase):
    """IdentityResponseV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityResponseV2:
        """Test IdentityResponseV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityResponseV2`
        """
        model = IdentityResponseV2()
        if include_optional:
    ...
    def testIdentityResponseV2(self):
        """Test IdentityResponseV2"""
