...
class TestDestinationV2(unittest.TestCase):
    """DestinationV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DestinationV2:
        """Test DestinationV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DestinationV2`
        """
        model = DestinationV2()
        if include_optional:
