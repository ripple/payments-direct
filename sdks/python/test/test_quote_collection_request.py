...
class TestQuoteCollectionRequest(unittest.TestCase):
    """QuoteCollectionRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteCollectionRequest:
        """Test QuoteCollectionRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteCollectionRequest`
        """
        model = QuoteCollectionRequest()
        if include_optional:
            return QuoteCollectionRequest(
                quote_amount = 123.45,
    ...
    def testQuoteCollectionRequest(self):
        """Test QuoteCollectionRequest"""
