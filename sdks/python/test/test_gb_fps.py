...
class TestGbFps(unittest.TestCase):
    """GbFps unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GbFps:
        """Test GbFps
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GbFps`
        """
        model = GbFps()
        if include_optional:
            return GbFps(
