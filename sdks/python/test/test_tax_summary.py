...
class TestTaxSummary(unittest.TestCase):
    """TaxSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaxSummary:
        """Test TaxSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaxSummary`
        """
        model = TaxSummary()
        if include_optional:
            return TaxSummary(
