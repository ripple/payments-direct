...
class TestIdentityResponseV3(unittest.TestCase):
    """IdentityResponseV3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IdentityResponseV3:
        """Test IdentityResponseV3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IdentityResponseV3`
        """
        model = IdentityResponseV3()
        if include_optional:
            return IdentityResponseV3(
    ...
    def testIdentityResponseV3(self):
        """Test IdentityResponseV3"""
