...
class TestRippleIdentity(unittest.TestCase):
    """RippleIdentity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RippleIdentity:
        """Test RippleIdentity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RippleIdentity`
        """
        model = RippleIdentity()
        if include_optional:
            return RippleIdentity(
