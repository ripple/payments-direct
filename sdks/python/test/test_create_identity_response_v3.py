...
class TestCreateIdentityResponseV3(unittest.TestCase):
    """CreateIdentityResponseV3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateIdentityResponseV3:
        """Test CreateIdentityResponseV3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateIdentityResponseV3`
        """
        model = CreateIdentityResponseV3()
        if include_optional:
    ...
    def testCreateIdentityResponseV3(self):
        """Test CreateIdentityResponseV3"""
