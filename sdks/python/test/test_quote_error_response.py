...
class TestQuoteErrorResponse(unittest.TestCase):
    """QuoteErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> QuoteErrorResponse:
        """Test QuoteErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `QuoteErrorResponse`
        """
        model = QuoteErrorResponse()
        if include_optional:
            return QuoteErrorResponse(
                errors = [
                    ripple_payments_direct.models.quote_error.QuoteError(
                        code = 'SYS_100', 
    ...
    def testQuoteErrorResponse(self):
        """Test QuoteErrorResponse"""
