...
class BusinessIdentityRegistrationInner(BaseModel):
    """
    ...
    type: StrictStr = Field(description="Type of business identification document. Accepted values are:  - `INCORPORATION_CERTIFICATE` — Certificate of Incorporation Number   - `TAX_ID` — Tax Identification Number ")
