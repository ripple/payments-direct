...
class QuoteErrorResponse(BaseModel):
    ...
    QuoteErrorResponse
    """ # noqa: E501
    errors: List[QuoteError] = Field(description="List of quote errors")
    status: StrictInt = Field(description="Response status code")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [QuoteError.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None,
