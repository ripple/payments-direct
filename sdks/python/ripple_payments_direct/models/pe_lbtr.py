...
class PeLbtr(BaseModel):
    ...
    swift_code: Annotated[str, Field(min_length=8, strict=True, max_length=11)] = Field(description="SWIFT/BIC code of the identity's bank", alias="swiftCode")
    account_number: Annotated[str, Field(min_length=10, strict=True, max_length=20)] = Field(description="The identity's bank account number", alias="accountNumber")
    account_type: StrictStr = Field(description="The identity's account type", alias="accountType")
    __properties: ClassVar[List[str]] = ["bankName", "swiftCode", "accountNumber", "accountType"]
