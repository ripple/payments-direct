...
class TaxBreakdown(BaseModel):
    ...
    """ # noqa: E501
    tax_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="tax amount for this tax line item.", alias="taxAmount")
    tax_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=128)]] = Field(default=None, description="The name of the tax.", alias="taxName")
    tax_description: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="GST service fee tax .", alias="taxDescription")
    tax_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The tax rate applied to calculate the tax amount.", alias="taxRate")
    __properties: ClassVar[List[str]] = ["taxAmount", "taxName", "taxDescription", "taxRate"]
