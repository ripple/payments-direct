...
class FeeSummaryV2(BaseModel):
    ...
    fee_breakdown: Optional[List[TotalFeeBreakdownV2]] = Field(default=None, description="An array of fees that provides a breakdown of how the total fees is calculated for this quote.", alias="feeBreakdown")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "feeBreakdown": [TotalFeeBreakdownV2.from_dict(_item) for _item in obj["feeBreakdown"]] if obj.get("feeBreakdown") is not None else None
        })
        return _obj
