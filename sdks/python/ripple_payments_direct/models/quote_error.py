...
class QuoteError(BaseModel):
    ...
    QuoteError
    """ # noqa: E501
    code: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="Unique identifier of an error")
    title: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="Error message providing a brief summary of the error")
    type: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="Identifies the problem type")
    description: Annotated[str, Field(min_length=1, strict=True, max_length=1024)] = Field(description="Provides more technical information")
    timestamp: datetime = Field(description="The time when this error occurred, specified in UTC.")
    __properties: ClassVar[List[str]] = ["code", "title", "type", "description", "timestamp"]
