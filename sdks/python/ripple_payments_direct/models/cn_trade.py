...
class CnTrade(BaseModel):
    ...
    bank_code: Annotated[str, Field(min_length=1, strict=True, max_length=32)] = Field(description="Beneficiary Bank Code (CNAPS). List provided in the Ripple Docs Bank Codes utility.", alias="bankCode")
