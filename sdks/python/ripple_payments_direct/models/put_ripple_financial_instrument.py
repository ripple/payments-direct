...
class PutRippleFinancialInstrument(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["usAch", "usFedwire", "mxSpei", "euSepa", "gbFps", "africaBankPayout", "brPix", "coPse", "brTed", "caEft"]
