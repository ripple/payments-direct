...
class Destination(BaseModel):
    ...
    beneficiary_identity_id: Optional[Annotated[str, Field(strict=True, max_length=36)]] = Field(default=None, description="The unique ID associated with the payment beneficiary's identity record.", alias="beneficiaryIdentityId")
    ...
    __properties: ClassVar[List[str]] = ["destinationAmount", "destinationCountry", "destinationCurrency", "destinationBlockchainNetwork", "beneficiaryIdentityId", "beneficiaryIdentityVersion", "beneficiaryIdentityNickName", "payout"]
