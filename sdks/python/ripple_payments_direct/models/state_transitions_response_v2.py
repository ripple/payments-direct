...
class StateTransitionsResponseV2(BaseModel):
    """
    StateTransitionsResponseV2
    """ # noqa: E501
    state_transitions: List[StateTransitionV2] = Field(alias="stateTransitions")
    __properties: ClassVar[List[str]] = ["stateTransitions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stateTransitions": [StateTransitionV2.from_dict(_item) for _item in obj["stateTransitions"]] if obj.get("stateTransitions") is not None else None
        })
        return _obj
