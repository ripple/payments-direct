...
class QuoteCollectionRequest(BaseModel):
    ...
    """ # noqa: E501
    quote_amount: Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]] = Field(description="The amount for which you wish to receive a collection of quotes.", alias="quoteAmount")
