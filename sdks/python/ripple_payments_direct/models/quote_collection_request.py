...
class QuoteCollectionRequest(BaseModel):
    """
    ...
    payout_category: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="The name of the payout category.", alias="payoutCategory")
    payin_category: Annotated[str, Field(min_length=1, strict=True, max_length=128)] = Field(description="The name of the pay in category indicating how this payment will be funded. The values FUNDED and T_PLUS_ONE are deprecated and will be removed in a future release.", alias="payinCategory")
    ...
    __properties: ClassVar[List[str]] = ["quoteAmount", "quoteAmountType", "sourceCurrency", "destinationCurrency", "sourceCountry", "destinationCountry", "payoutCategory", "payinCategory", "destinationBlockchainNetwork"]
