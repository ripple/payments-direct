...
class UpdatePaymentLabelsRequest(BaseModel):
    """
    Request body containing the list of labels you want to add to or remove from the payment.
    """ # noqa: E501
    labels_to_add: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=100)]], Field(max_length=10)]] = Field(default=None, description="Application-defined labels for grouping and categorizing payments (e.g., campaign IDs, workflow tags, or batch identifiers). Labels are optional and mutable; they can be added or removed over the payment’s lifetime.", alias="labelsToAdd")
    labels_to_remove: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=100)]], Field(max_length=10)]] = Field(default=None, description="Application-defined labels for grouping and categorizing payments (e.g., campaign IDs, workflow tags, or batch identifiers). Labels are optional and mutable; they can be added or removed over the payment’s lifetime.", alias="labelsToRemove")
    __properties: ClassVar[List[str]] = ["labelsToAdd", "labelsToRemove"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "labelsToAdd": obj.get("labelsToAdd"),
            "labelsToRemove": obj.get("labelsToRemove")
        })
        return _obj
