...
class UpdatePaymentLabelsRequest(BaseModel):
    ...
    """ # noqa: E501
    labels_to_add: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=100)]], Field(max_length=10)]] = Field(default=None, description="List of labels associated with the payment. A label typically contains a UUID of your choice, designated as the batchId.", alias="labelsToAdd")
    labels_to_remove: Optional[Annotated[List[Annotated[str, Field(strict=True, max_length=100)]], Field(max_length=10)]] = Field(default=None, description="List of labels associated with the payment. A label typically contains a UUID of your choice, designated as the batchId.", alias="labelsToRemove")
