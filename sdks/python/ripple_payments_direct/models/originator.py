...
class Originator(BaseModel):
    ...
    """ # noqa: E501
    originator_identity_id: Optional[Annotated[str, Field(strict=True, max_length=36)]] = Field(default=None, description="The unique ID associated with the payment originator's identity record.", alias="originatorIdentityId")
