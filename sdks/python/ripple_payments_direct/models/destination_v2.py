...
class DestinationV2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["beneficiaryFinancialInstrumentId", "destinationAmount", "destinationCountry", "destinationCurrency", "destinationBlockchainNetwork", "beneficiaryIdentityId", "beneficiaryIdentityVersion", "beneficiaryIdentityNickName", "payout"]
