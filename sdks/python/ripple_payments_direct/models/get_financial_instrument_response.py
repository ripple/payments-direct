...
class GetFinancialInstrumentResponse(BaseModel):
    """
    This object contains the details of a financial instrument and optional identity if requested.
    """ # noqa: E501
    financial_instrument: RippleFinancialInstrumentEntry = Field(alias="financialInstrument")
    identity: Optional[GetIdentityResponseV3] = None
    __properties: ClassVar[List[str]] = ["financialInstrument", "identity"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of financial_instrument
        if self.financial_instrument:
            _dict['financialInstrument'] = self.financial_instrument.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "financialInstrument": RippleFinancialInstrumentEntry.from_dict(obj["financialInstrument"]) if obj.get("financialInstrument") is not None else None,
            "identity": GetIdentityResponseV3.from_dict(obj["identity"]) if obj.get("identity") is not None else None
        })
        return _obj
