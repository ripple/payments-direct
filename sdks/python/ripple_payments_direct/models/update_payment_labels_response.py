...
class UpdatePaymentLabelsResponse(BaseModel):
    ...
    """ # noqa: E501
    labels: Annotated[List[Annotated[str, Field(strict=True, max_length=100)]], Field(max_length=10)] = Field(description="List of labels associated with the payment. A label typically contains a UUID of your choice, designated as the batchId.")
