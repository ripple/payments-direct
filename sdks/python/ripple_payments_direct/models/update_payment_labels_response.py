...
class UpdatePaymentLabelsResponse(BaseModel):
    """
    Response body for modifying payment labels
    """ # noqa: E501
    labels: Annotated[List[Annotated[str, Field(strict=True, max_length=100)]], Field(max_length=10)] = Field(description="Application-defined labels for grouping and categorizing payments (e.g., campaign IDs, workflow tags, or batch identifiers). Labels are optional and mutable; they can be added or removed over the payment’s lifetime.")
