...
class MxSpei(BaseModel):
    ...
    clabe: Annotated[str, Field(min_length=18, strict=True, max_length=18)] = Field(description="The identity's CLABE account identification code")
    __properties: ClassVar[List[str]] = ["bankName", "clabe"]
    ...
    def clabe_validate_regular_expression(cls, value):
        """Validates the regular expression"""
