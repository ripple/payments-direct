...
class ListIdentitiesResponseV2(BaseModel):
    """
    ListIdentitiesResponseV2
    """ # noqa: E501
    data: Optional[List[IdentityV2]] = Field(default=None, description="The list of the identities that match the query parameters")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [IdentityV2.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
