...
class AdjustedExchangeRate(BaseModel):
    """
    Foreign Exchange (FX) rate used to calculate the quote.
    """ # noqa: E501
    adjusted_rate: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value of the Foreign Exchange (FX) rate.", alias="adjustedRate")
    __properties: ClassVar[List[str]] = ["adjustedRate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "adjustedRate": obj.get("adjustedRate")
        })
        return _obj
