...
class BusinessIdentityLocalizedHanzi(BaseModel):
    """
    Localized identity fields in Chinese Hanzi characters (汉字).
    """ # noqa: E501
    business_name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="Business legal name in Chinese Hanzi characters. ", alias="businessName")
