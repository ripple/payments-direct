...
class CreateIdentityResponseV3(BaseModel):
    """
    CreateIdentityResponseV3
    """ # noqa: E501
    identity_id: StrictStr = Field(description="The unique ID of the identity", alias="identityId")
    version: StrictStr = Field(description="The version number of the identity")
    __properties: ClassVar[List[str]] = ["identityId", "version"]
