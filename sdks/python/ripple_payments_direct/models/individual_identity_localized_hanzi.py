...
class IndividualIdentityLocalizedHanzi(BaseModel):
    """
    Localized identity fields in Chinese Hanzi characters (汉字).
    """ # noqa: E501
    first_name: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="Individual given name in Chinese Hanzi characters.", alias="firstName")
    last_name: Optional[Annotated[str, Field(strict=True, max_length=32)]] = Field(default=None, description="Individual family name in Chinese Hanzi characters.", alias="lastName")
    business_name: Optional[Annotated[str, Field(strict=True, max_length=256)]] = Field(default=None, description="Business name associated with the individual in Chinese Hanzi characters, for trade payments. ", alias="businessName")
    __properties: ClassVar[List[str]] = ["firstName", "lastName", "businessName"]
