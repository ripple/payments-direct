...
class CnIndividual(BaseModel):
    ...
    """ # noqa: E501
    bank_name: Annotated[str, Field(min_length=2, strict=True, max_length=140)] = Field(description="Beneficiary Bank Name in English. Published list available at docs.ripple.com.", alias="bankName")
    bank_code: Annotated[str, Field(min_length=1, strict=True, max_length=16)] = Field(description="Beneficiary Bank Code. Published bank code list at docs.ripple.com.", alias="bankCode")
