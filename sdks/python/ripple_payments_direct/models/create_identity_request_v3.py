...
class CreateIdentityRequestV3(BaseModel):
    """
    ...
    validate_payout_rails: Optional[List[StrictStr]] = Field(default=None, description="The payment rails to validate the identity against", alias="validatePayoutRails")
