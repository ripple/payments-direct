...
class GetBalances400Response(BaseModel):
    """
    GetBalances400Response
    """ # noqa: E501
    status: StrictInt = Field(description="The HTTP status code representing the error response")
    errors: List[GetBalances400ResponseErrorsInner] = Field(description="An array containing details about the errors encountered")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "errors": [GetBalances400ResponseErrorsInner.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
