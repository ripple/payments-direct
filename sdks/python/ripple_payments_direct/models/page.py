...
class Page(BaseModel):
    ...
    """ # noqa: E501
    size: Optional[Annotated[int, Field(le=100, strict=True, ge=1)]] = Field(default=20, description="Size of the page")
    last_page_token: Optional[StrictStr] = Field(default=None, description="The unique reference ID of the last fetched item. To retrieve subsequent item(s) if any, specify this value as the value of the `Page.list` field in the  `POST /payments/filter` operation request body.", alias="lastPageToken")
    __properties: ClassVar[List[str]] = ["size", "lastPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "lastPageToken": obj.get("lastPageToken")
        })
        return _obj
