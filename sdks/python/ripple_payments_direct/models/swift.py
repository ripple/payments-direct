...
class Swift(BaseModel):
    ...
    swift_code: Annotated[str, Field(min_length=8, strict=True, max_length=11)] = Field(description="The SWIFT/BIC code of the identity's bank", alias="swiftCode")
    account_holder_name: Annotated[str, Field(min_length=1, strict=True, max_length=140)] = Field(description="The name of the account holder", alias="accountHolderName")
    account_number: Annotated[str, Field(min_length=2, strict=True, max_length=34)] = Field(description="The account number of the identity's bank account", alias="accountNumber")
    __properties: ClassVar[List[str]] = ["bankName", "swiftCode", "accountHolderName", "accountNumber"]
