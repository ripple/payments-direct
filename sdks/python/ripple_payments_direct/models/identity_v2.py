...
class IdentityV2(BaseModel):
    ...
    nick_name: StrictStr = Field(description="The nickname of the identity provided at the time of identity creation.", alias="nickName")
    ...
    __properties: ClassVar[List[str]] = ["identityId", "nickName", "createdAt", "identityType", "useCaseType"]
