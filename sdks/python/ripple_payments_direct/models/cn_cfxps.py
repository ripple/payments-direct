...
class CnCfxps(BaseModel):
    ...
    """ # noqa: E501
    bank_name: Annotated[str, Field(min_length=2, strict=True, max_length=140)] = Field(description="Beneficiary Bank Name. Looked up from swiftCode.", alias="bankName")
    swift_code: Annotated[str, Field(min_length=8, strict=True, max_length=11)] = Field(description="Beneficiary Bank SWIFT/BIC Code. See the China entry in the bank code lookup in the integration resources for the supported list.", alias="swiftCode")
    account_number: Annotated[str, Field(min_length=1, strict=True, max_length=34)] = Field(description="Beneficiary Account Number.", alias="accountNumber")
    account_holder_name: Annotated[str, Field(min_length=1, strict=True, max_length=140)] = Field(description="Beneficiary Account Holder Name (English).", alias="accountHolderName")
    __properties: ClassVar[List[str]] = ["bankName", "swiftCode", "accountNumber", "accountHolderName"]
