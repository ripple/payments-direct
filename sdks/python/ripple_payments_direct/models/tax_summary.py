...
class TaxSummary(BaseModel):
    ...
    """ # noqa: E501
    total_taxes: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The value of the total taxes included in this quote.", alias="totalTaxes")
    tax_currency: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The currency in which taxes are charged.", alias="taxCurrency")
    tax_breakdown: Optional[List[TaxBreakdown]] = Field(default=None, description="An array of taxes with details such as tax description, rate, name and tax amount.", alias="taxBreakdown")
    __properties: ClassVar[List[str]] = ["totalTaxes", "taxCurrency", "taxBreakdown"]

    @field_validator('tax_currency')
    def tax_currency_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "taxBreakdown": [TaxBreakdown.from_dict(_item) for _item in obj["taxBreakdown"]] if obj.get("taxBreakdown") is not None else None
        })
        return _obj
