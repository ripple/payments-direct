...
class ZaBankPayout(BaseModel):
    ...
    bank_code: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="Ripple Bank Code (RBC) for the destination bank in South Africa. See the Bank Codes resource in Ripple Docs for the authoritative list of supported values.", alias="bankCode")
