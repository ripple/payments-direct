...
class PaymentError(BaseModel):
    ...
    PaymentError
    """ # noqa: E501
    code: StrictStr = Field(description="A unique identifier for  the error")
    ...
    description: StrictStr = Field(description="A more detailed explanation of the error, potentially including information about what caused the error and the next steps")
    timestamp: datetime
