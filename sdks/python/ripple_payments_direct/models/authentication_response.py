...
class AuthenticationResponse(BaseModel):
    ...
    """ # noqa: E501
    access_token: Optional[StrictStr] = Field(default=None, description="The bearer token you use when authenticating with a Ripple API.")
    scope: Optional[StrictStr] = Field(default=None, description="List of scopes applied to your `access_token`.")
    expires_in: Optional[StrictInt] = Field(default=None, description="How long your `access_token` is valid. You need to request a new token when it expires.")
    token_type: Optional[StrictStr] = Field(default=None, description="The type of token. Ripple APIs use `Bearer` auth tokens.")
    __properties: ClassVar[List[str]] = ["access_token", "scope", "expires_in", "token_type"]
