...
class TrackingReference(BaseModel):
    ...
    """ # noqa: E501
    reference_type: Optional[StrictStr] = Field(default=None, description="The type or category of this tracking reference. Known values include IMAD and OMAD for Fedwire transfers, but additional types may be provided depending on the payment rail and payout partner. ", alias="referenceType")
    value: Optional[StrictStr] = Field(default=None, description="The tracking reference value. Use this to locate the transaction with the payout partner or payment rail operator. Format varies by referenceType.")
    display_name: Optional[StrictStr] = Field(default=None, description="A human-readable name for this tracking reference, suitable for display in user interfaces.", alias="displayName")
    description: Optional[StrictStr] = Field(default=None, description="A detailed description of what this tracking reference represents and how it can be used.")
    __properties: ClassVar[List[str]] = ["referenceType", "value", "displayName", "description"]
