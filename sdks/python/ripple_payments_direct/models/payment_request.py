...
class PaymentRequest(BaseModel):
    ...
    originator_identity_id: Optional[StrictStr] = Field(default=None, description="The identity ID of the payment originator in UUID format. You can find the identity ID using the `GET /identities` operation.", alias="originatorIdentityId")
    beneficiary_identity_id: StrictStr = Field(description="The identity ID of the payment beneficiary in UUID format. You can find the identity ID using the `GET /identities` operation.", alias="beneficiaryIdentityId")
    ...
    __properties: ClassVar[List[str]] = ["quoteId", "originatorIdentityId", "beneficiaryIdentityId", "internalId", "purposeCode", "sourceOfCash", "paymentLabels", "paymentMemo"]
