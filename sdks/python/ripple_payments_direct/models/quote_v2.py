...
class QuoteV2(BaseModel):
    ...
    fees: Optional[List[FeeSummaryV2]] = Field(default=None, description="A summary of fees included in this quote.")
    ...
    __properties: ClassVar[List[str]] = ["quoteId", "quoteStatus", "quoteAmountType", "sourceAmount", "destinationAmount", "sourceCurrency", "destinationCurrency", "sourceCountry", "destinationCountry", "payinCategory", "adjustedExchangeRate", "fees", "taxes", "createdAt", "expiresAt", "paymentRail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fees": [FeeSummaryV2.from_dict(_item) for _item in obj["fees"]] if obj.get("fees") is not None else None,
