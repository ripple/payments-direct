...
class PaymentWithDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["paymentId", "cryptoTransactionHash", "initiatedAt", "expiresAt", "lastStateUpdatedAt", "paymentState", "originator", "destination", "adjustedExchangeRate", "fees", "taxes", "sourceOfCash", "purposeCode", "transactionDetails", "errors", "paymentLabels", "paymentMemo"]
