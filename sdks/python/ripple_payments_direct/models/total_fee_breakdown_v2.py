...
class TotalFeeBreakdownV2(BaseModel):
    """
    A breakdown of the total fees included in this quote.
    """ # noqa: E501
    calculated_fee: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value of the fee when the configured fee unit is applied against the `value`.", alias="calculatedFee")
    fee_name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=128)]] = Field(default=None, description="The name of the fee.", alias="feeName")
    fee_description: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="Description of the fee.", alias="feeDescription")
    payment_rail: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=30)]] = Field(default=None, description="The payment rail associated with this fee line item.", alias="paymentRail")
    __properties: ClassVar[List[str]] = ["calculatedFee", "feeName", "feeDescription", "paymentRail"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calculatedFee": obj.get("calculatedFee"),
