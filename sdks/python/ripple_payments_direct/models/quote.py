...
class Quote(BaseModel):
    ...
    source_amount: Optional[Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="Amount to be sent by the originator. The value is rounded to the number of decimal places defined by the ISO 4217 standard for the source currency (for example, 2 for USD/EUR, 0 for JPY/KRW, 3 for BHD/KWD), using HALF_UP rounding mode. ", alias="sourceAmount")
    destination_amount: Optional[Union[Annotated[float, Field(strict=True, ge=1)], Annotated[int, Field(strict=True, ge=1)]]] = Field(default=None, description="Amount to be received by the beneficiary. The value is rounded to the number of decimal places defined by the ISO 4217 standard for the destination currency (for example, 2 for USD/EUR, 0 for JPY/KRW, 3 for BHD/KWD), using HALF_UP rounding mode. ", alias="destinationAmount")
    ...
    payment_rail: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=50)]] = Field(default=None, description="The payment rail used for this quote.", alias="paymentRail")
    __properties: ClassVar[List[str]] = ["quoteId", "quoteStatus", "quoteAmountType", "sourceAmount", "destinationAmount", "sourceCurrency", "destinationCurrency", "sourceCountry", "destinationCountry", "payoutCategory", "payinCategory", "adjustedExchangeRate", "fees", "taxes", "createdAt", "expiresAt", "destinationBlockchainNetwork", "paymentRail"]
