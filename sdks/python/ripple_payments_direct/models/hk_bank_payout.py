...
class HkBankPayout(BaseModel):
    ...
    """ # noqa: E501
    bank_name: Annotated[str, Field(min_length=2, strict=True, max_length=140)] = Field(description="The name of the beneficiary's bank", alias="bankName")
    account_number: Annotated[str, Field(min_length=2, strict=True, max_length=30)] = Field(description="Bank account number (BBAN)", alias="accountNumber")
    account_holder_name: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="Name of the account holder", alias="accountHolderName")
    swift_code: Annotated[str, Field(min_length=8, strict=True, max_length=11)] = Field(description="SWIFT/BIC code of the bank", alias="swiftCode")
    currency: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=5)]] = Field(default=None, description="Currency code. Only HKD is supported for Hong Kong Bank Payout.")
    __properties: ClassVar[List[str]] = ["bankName", "accountNumber", "accountHolderName", "swiftCode", "currency"]
