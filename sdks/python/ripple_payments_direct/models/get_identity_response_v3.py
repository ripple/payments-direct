...
class GetIdentityResponseV3(BaseModel):
    ...
    identity_state: Optional[StrictStr] = Field(default=None, description="The state of the identity.", alias="identityState")
    ...
    __properties: ClassVar[List[str]] = ["identityType", "paymentRole", "internalId", "business", "individual"]
