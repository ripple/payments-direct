...
class BusinessIdentityLocalized(BaseModel):
    """
    ...
    """ # noqa: E501
    hanzi: Optional[BusinessIdentityLocalizedHanzi] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hanzi": BusinessIdentityLocalizedHanzi.from_dict(obj["hanzi"]) if obj.get("hanzi") is not None else None
        })
        return _obj
