...
class AuNpp(BaseModel):
    ...
    bsb_code: Annotated[str, Field(min_length=6, strict=True, max_length=6)] = Field(description="The 6-digit Bank-State-Branch (BSB) routing code", alias="bsbCode")
    account_number: Annotated[str, Field(min_length=1, strict=True, max_length=11)] = Field(description="The identity's bank account number", alias="accountNumber")
    __properties: ClassVar[List[str]] = ["bankName", "bsbCode", "accountNumber"]
    ...
    @field_validator('bsb_code')
    def bsb_code_validate_regular_expression(cls, value):
        """Validates the regular expression"""
