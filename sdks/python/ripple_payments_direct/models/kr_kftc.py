...
class KrKftc(BaseModel):
    ...
    bank_code: Annotated[str, Field(min_length=1, strict=True, max_length=10)] = Field(description="KFTC-assigned Korean domestic clearing code. See the Bank Codes resource in Ripple Docs for the authoritative list of supported values.", alias="bankCode")
