...
class PaymentWithDetailsV2(BaseModel):
    """
    ...
    taxes: Optional[List[TaxSummary]] = Field(default=None, description="A summary of taxes included in the payment quote.")
    ...
    transaction_details: Optional[TransactionDetailsV2] = Field(default=None, alias="transactionDetails")
    errors: Optional[List[PaymentError]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.errors:
            ...
            _dict['errors'] = _items
        # override the default output from pydantic by calling `to_dict()` of payout_execution_details
        if self.payout_execution_details:
            _dict['payoutExecutionDetails'] = self.payout_execution_details.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jitFundingExpiresAt": obj.get("jitFundingExpiresAt"),
            "lastStateUpdatedAt": obj.get("lastStateUpdatedAt"),
            "paymentState": obj.get("paymentState"),
            "originator": OriginatorV2.from_dict(obj["originator"]) if obj.get("originator") is not None else None,
            "destination": DestinationV2.from_dict(obj["destination"]) if obj.get("destination") is not None else None,
            ...
            "transactionDetails": TransactionDetailsV2.from_dict(obj["transactionDetails"]) if obj.get("transactionDetails") is not None else None,
            ...
            "payoutExecutionDetails": PayoutExecutionDetails.from_dict(obj["payoutExecutionDetails"]) if obj.get("payoutExecutionDetails") is not None else None
        })
        return _obj
