...
class ListFinancialInstrumentsResponse(BaseModel):
    """
    ListFinancialInstrumentsResponse
    """ # noqa: E501
    data: Optional[List[FinancialInstrumentMetadata]] = Field(default=None, description="The list of the financial instruments that match the query parameters")
    next_token: Optional[StrictStr] = Field(default=None, description="The token to retrieve the next page of results", alias="nextToken")
    __properties: ClassVar[List[str]] = ["data", "nextToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [FinancialInstrumentMetadata.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
