...
class GetBalances200ResponseBalancesInner(BaseModel):
    """
    ...
    def funding_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['FUNDED']):
            raise ValueError("must be one of enum values ('FUNDED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reservedBalance": obj.get("reservedBalance")
        })
        return _obj
