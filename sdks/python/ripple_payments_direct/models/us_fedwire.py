...
class UsFedwire(BaseModel):
    ...
    bank_routing_number: Annotated[str, Field(min_length=9, strict=True, max_length=9)] = Field(description="9-digit ABA Routing Transit Number (RTN) of the beneficiary’s bank.", alias="bankRoutingNumber")
    account_number: Annotated[str, Field(min_length=4, strict=True, max_length=21)] = Field(description="The identity's account number to be credited.", alias="accountNumber")
    __properties: ClassVar[List[str]] = ["bankName", "bankRoutingNumber", "accountNumber"]
