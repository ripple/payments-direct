...
class IndividualIdentityAddress(BaseModel):
    ...
    state_or_province: Annotated[str, Field(min_length=1, strict=True, max_length=140)] = Field(description="Information that locates and identifies the state / county for the party, as defined by postal services", alias="stateOrProvince")
    postal_code: Annotated[str, Field(min_length=3, strict=True, max_length=15)] = Field(description="Postal code for the individual's address", alias="postalCode")
