...
class IndividualIdentityAddress(BaseModel):
    """
    Holds general information about the individual
    """ # noqa: E501
    street_address: List[Annotated[str, Field(min_length=1, strict=True, max_length=70)]] = Field(description="Allows the street address of the individual to be held", alias="streetAddress")
    country: Annotated[str, Field(min_length=2, strict=True, max_length=2)] = Field(description="Allows the Country of the individual to be held. Use Alpha-2 Code as defined in the [ISO CountryCode ISO 3166-1](https://www.iso.org/obp/ui/#search) list.")
    city: Annotated[str, Field(min_length=1, strict=True, max_length=140)] = Field(description="City")
    state_or_province: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=140)]] = Field(default=None, description="Information that locates and identifies the state / county for the party, as defined by postal services", alias="stateOrProvince")
    postal_code: Optional[Annotated[str, Field(min_length=3, strict=True, max_length=15)]] = Field(default=None, description="Postal code for the individual's address", alias="postalCode")
