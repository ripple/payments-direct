...
class BusinessIdentity(BaseModel):
    ...
    """ # noqa: E501
    business_name: Annotated[str, Field(min_length=1, strict=True, max_length=140)] = Field(description="Business Legal Name", alias="businessName")
    ...
    registration: Optional[List[BusinessIdentityRegistrationInner]] = Field(default=None, description="Unique and unambiguous way to identify a business or organization. An array of objects, each containing unique identification of an organization, as assigned by an institution, using an identification scheme.")
    ...
    __properties: ClassVar[List[str]] = ["businessName", "address", "email", "phone", "registration", "incorporationCountry"]
    ...
    def incorporation_country_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if value is None:
            return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in registration (list)
        _items = []
        if self.registration:
            for _item_registration in self.registration:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": BusinessIdentityAddress.from_dict(obj["address"]) if obj.get("address") is not None else None,
            "email": obj.get("email"),
            "phone": obj.get("phone"),
