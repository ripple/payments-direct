...
class AfricaBankPayout(BaseModel):
    """
    ...
    country: StrictStr = Field(description="The country of the identity’s bank, using the Alpha-2 code as defined in ISO 3166-1.   Allowed values are:  - `GH`   - `NG`   - `RW`   - `UG`   - `ZA`   - `ZM` ")
    __properties: ClassVar[List[str]] = ["bankName", "bankCode", "accountNumber", "country"]
