...
class IdBifast(BaseModel):
    ...
    bank_code: Annotated[str, Field(min_length=1, strict=True, max_length=16)] = Field(description="Bank Indonesia-assigned domestic clearing code. See the Bank Codes resource in Ripple Docs for the authoritative list of supported values.", alias="bankCode")
