...
class CnIndividualTrade(BaseModel):
    """
    ...
    """ # noqa: E501
    bank_name: Annotated[str, Field(min_length=2, strict=True, max_length=140)] = Field(description="Beneficiary Bank Name.", alias="bankName")
    ...
    account_holder_name: Annotated[str, Field(min_length=1, strict=True, max_length=140)] = Field(description="Beneficiary Account Holder Name (Hanzi). Account name in Chinese Hanzi characters. For sole proprietors, bank account may be registered under business name.", alias="accountHolderName")
    __properties: ClassVar[List[str]] = ["bankName", "accountNumber", "accountHolderName"]
