...
class IdentityResponseV3(BaseModel):
    """
    IdentityResponseV3
    """ # noqa: E501
    ...
    updated_at: datetime = Field(description="The time at which the identity was last updated", alias="updatedAt")
    ...
    internal_id: Optional[StrictStr] = Field(default=None, description="The client-provided unique identifier supplied when the identity was created or last updated.", alias="internalId")
