...
class GbFps(BaseModel):
    ...
    sort_code: Annotated[str, Field(min_length=6, strict=True, max_length=6)] = Field(description="The sort code of the identity's bank account", alias="sortCode")
    account_number: Annotated[str, Field(min_length=8, strict=True, max_length=8)] = Field(description="The account number of the identity's bank account", alias="accountNumber")
    __properties: ClassVar[List[str]] = ["bankName", "sortCode", "accountNumber"]
