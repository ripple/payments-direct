...
class ClTef(BaseModel):
    ...
    account_number: Annotated[str, Field(min_length=6, strict=True, max_length=34)] = Field(description="The identity's bank account number", alias="accountNumber")
