...
class UsAch(BaseModel):
    ...
    bank_routing_number: Annotated[str, Field(min_length=9, strict=True, max_length=9)] = Field(description="The identity's bank routing number", alias="bankRoutingNumber")
    account_number: Annotated[str, Field(min_length=4, strict=True, max_length=21)] = Field(description="The identity's account number into which the funds must be credited", alias="accountNumber")
    ...
    __properties: ClassVar[List[str]] = ["bankName", "bankRoutingNumber", "accountNumber", "accountType"]
    ...
    def bank_routing_number_validate_regular_expression(cls, value):
        """Validates the regular expression"""
