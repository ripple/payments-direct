...
class ThPromptpay(BaseModel):
    ...
    bank_code: Annotated[str, Field(min_length=1, strict=True, max_length=16)] = Field(description="Domestic bank code for the identity's bank in Thailand. See the Bank Codes resource in Ripple Docs for the authoritative list of supported values.", alias="bankCode")
