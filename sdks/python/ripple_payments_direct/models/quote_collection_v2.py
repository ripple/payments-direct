...
class QuoteCollectionV2(BaseModel):
    """
    QuoteCollectionV2
    """ # noqa: E501
    quote_collection_id: Annotated[str, Field(min_length=1, strict=True, max_length=36)] = Field(description="Unique ID that represents this quote collection.", alias="quoteCollectionId")
    quotes: Annotated[List[QuoteV2], Field(min_length=0)] = Field(description="List of quotes")
    __properties: ClassVar[List[str]] = ["quoteCollectionId", "quotes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "quoteCollectionId": obj.get("quoteCollectionId"),
            "quotes": [QuoteV2.from_dict(_item) for _item in obj["quotes"]] if obj.get("quotes") is not None else None
        })
        return _obj
