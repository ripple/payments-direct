...
class Payment(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["paymentId", "cryptoTransactionHash", "initiatedAt", "expiresAt", "lastStateUpdatedAt", "paymentState", "originator", "destination", "adjustedExchangeRate", "fees", "sourceOfCash", "purposeCode", "transactionDetails", "paymentLabels", "paymentMemo"]
