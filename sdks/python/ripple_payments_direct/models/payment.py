...
class Payment(BaseModel):
    ...
    source_of_cash: Optional[StrictStr] = Field(default=None, description="The source of cash may be required depending on corridor and payout partner. Valid values for the source of cash vary by corridor.", alias="sourceOfCash")
    ...
    __properties: ClassVar[List[str]] = ["paymentId", "cryptoTransactionHash", "initiatedAt", "expiresAt", "lastStateUpdatedAt", "paymentState", "originator", "destination", "adjustedExchangeRate", "fees", "taxes", "sourceOfCash", "purposeCode", "transactionDetails", "paymentLabels", "paymentMemo"]
