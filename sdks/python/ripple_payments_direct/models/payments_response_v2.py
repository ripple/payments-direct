...
class PaymentsResponseV2(BaseModel):
    """
    PaymentsResponseV2
    """ # noqa: E501
    data: Optional[List[PaymentV2]] = Field(default=None, description="Array of Payment objects")
    filter: Optional[PaymentFilterV2] = None
    sort: Optional[SortV2] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PaymentV2.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "filter": PaymentFilterV2.from_dict(obj["filter"]) if obj.get("filter") is not None else None,
            "sort": SortV2.from_dict(obj["sort"]) if obj.get("sort") is not None else None,
