...
class GetBalances200Response(BaseModel):
    """
    Customer available prefund balance details.
    """ # noqa: E501
    timestamp: datetime = Field(description="Timestamp of the balance response.")
    balances: List[GetBalances200ResponseBalancesInner] = Field(description="List of available prefund balances.")
    __properties: ClassVar[List[str]] = ["timestamp", "balances"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "balances": [GetBalances200ResponseBalancesInner.from_dict(_item) for _item in obj["balances"]] if obj.get("balances") is not None else None
        })
        return _obj
