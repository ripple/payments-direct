...
class PayoutExecutionDetails(BaseModel):
    ...
    """ # noqa: E501
    payment_rail_used: Optional[StrictStr] = Field(default=None, description="The payment rail or network used to execute the payout (e.g., FEDWIRE, ACH, RTP, SEPA). ", alias="paymentRailUsed")
