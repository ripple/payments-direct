...
class CreateIdentityRequestV2(BaseModel):
    """
    CreateIdentityRequestV2
    """ # noqa: E501
    pii_data: Dict[str, Any] = Field(description="PII data in JSON format.  You must use the correct `piiData` schema for the type of identity you want to create.  **Note**: Reach out to your Ripple liaison to get this schema. ", alias="piiData")
    ...
    __properties: ClassVar[List[str]] = ["piiData", "identityType", "nickName", "useCaseType"]
