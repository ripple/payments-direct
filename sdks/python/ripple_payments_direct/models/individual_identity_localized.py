...
class IndividualIdentityLocalized(BaseModel):
    """
    ...
    """ # noqa: E501
    hanzi: Optional[IndividualIdentityLocalizedHanzi] = None
    __properties: ClassVar[List[str]] = ["hanzi"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of hanzi
        if self.hanzi:
            _dict['hanzi'] = self.hanzi.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "hanzi": IndividualIdentityLocalizedHanzi.from_dict(obj["hanzi"]) if obj.get("hanzi") is not None else None
        })
        return _obj
