...
class ValidateTokenResponse(BaseModel):
    ...
    seconds_to_expiry: Optional[StrictInt] = Field(default=None, description="Remaining time in seconds before the tested token expires.")
    __properties: ClassVar[List[str]] = ["message", "seconds_to_expiry"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seconds_to_expiry": obj.get("seconds_to_expiry")
        })
        return _obj
