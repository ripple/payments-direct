...
class PaymentV2(BaseModel):
    ...
    payment_state: StrictStr = Field(description="Current state of a payment.  The payment lifecycle currently uses the following values:  - `QUOTED`  - `INITIATED`  - `VALIDATING`  - `TRANSFERRING`  - `COMPLETED`  - `FAILED`  - `RETURNED`  - `DECLINED`  Additional states may be introduced in the future without breaking existing integrations. ", alias="paymentState")
    ...
    fees: Optional[List[FeeSummary]] = Field(default=None, description="A summary of fees included in the payment quote.")
    ...
    __properties: ClassVar[List[str]] = ["paymentId", "cryptoTransactionHash", "initiatedAt", "expiresAt", "lastStateUpdatedAt", "paymentState", "originator", "destination", "adjustedExchangeRate", "fees", "taxes", "sourceOfCash", "purposeCode", "transactionDetails", "paymentLabels", "receiverRelationship", "paymentMemo"]
