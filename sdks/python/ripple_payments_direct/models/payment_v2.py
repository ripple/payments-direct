...
class PaymentV2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["paymentId", "cryptoTransactionHash", "initiatedAt", "expiresAt", "jitFundingExpiresAt", "lastStateUpdatedAt", "paymentState", "originator", "destination", "adjustedExchangeRate", "fees", "taxes", "sourceOfCash", "purposeCode", "transactionDetails", "paymentLabels", "receiverRelationship", "paymentMemo"]
