...
class GetStatementsTransactionsForCustomer200Response(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "statementTransactions": [GetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner.from_dict(_item) for _item in obj["statementTransactions"]] if obj.get("statementTransactions") is not None else None
        })
        return _obj
