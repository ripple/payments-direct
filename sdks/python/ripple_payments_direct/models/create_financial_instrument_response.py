...
class CreateFinancialInstrumentResponse(BaseModel):
    """
    CreateFinancialInstrumentResponse
    """ # noqa: E501
    financial_instrument_id: StrictStr = Field(description="The unique ID of the financial instrument", alias="financialInstrumentId")
    __properties: ClassVar[List[str]] = ["financialInstrumentId"]
