...
class UpdateFinancialInstrumentResponse(BaseModel):
    ...
    africa_bank_payout: Optional[AfricaBankPayout] = Field(default=None, alias="africaBankPayout")
    ...
    __properties: ClassVar[List[str]] = ["usAch", "usFedwire", "mxSpei", "euSepa", "gbFps", "africaBankPayout", "brPix", "coPse", "brTed", "caEft", "currency", "label", "financialInstrumentType", "country", "financialInstrumentId", "createdAt", "updatedAt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of africa_bank_payout
        if self.africa_bank_payout:
            _dict['africaBankPayout'] = self.africa_bank_payout.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "africaBankPayout": AfricaBankPayout.from_dict(obj["africaBankPayout"]) if obj.get("africaBankPayout") is not None else None,
