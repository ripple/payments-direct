...
class UpdateFinancialInstrumentResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["usAch", "usFedwire", "mxSpei", "euSepa", "gbFps", "ngBankPayout", "brPix", "coPse", "brTed", "caEft", "swift", "currency", "label", "financialInstrumentType", "country", "financialInstrumentId", "createdAt", "updatedAt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of swift
        if self.swift:
            _dict['swift'] = self.swift.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "swift": Swift.from_dict(obj["swift"]) if obj.get("swift") is not None else None,
