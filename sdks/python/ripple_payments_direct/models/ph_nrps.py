...
class PhNrps(BaseModel):
    ...
    swift_code: Annotated[str, Field(min_length=8, strict=True, max_length=11)] = Field(description="The SWIFT/BIC code of the beneficiary bank. Constrained to the SWIFT/BIC code list published on Ripple Docs.", alias="swiftCode")
    account_number: Annotated[str, Field(min_length=1, strict=True, max_length=30)] = Field(description="The identity's bank account number", alias="accountNumber")
    __properties: ClassVar[List[str]] = ["bankName", "swiftCode", "accountNumber"]
