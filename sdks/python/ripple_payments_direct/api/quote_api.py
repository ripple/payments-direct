...
class QuoteApi:
    ...
    @validate_call
    def create_quote_collection_v2(
        self,
        quote_collection_request_v2: Annotated[QuoteCollectionRequestV2, Field(description="Create quote collection request")],
        ...
        :param quote_collection_request_v2: Create quote collection request (required)
        :type quote_collection_request_v2: QuoteCollectionRequestV2
        ...
        _param = self._create_quote_collection_v2_serialize(
            quote_collection_request_v2=quote_collection_request_v2,
    ...
    @validate_call
    def create_quote_collection_v2_with_http_info(
        self,
        quote_collection_request_v2: Annotated[QuoteCollectionRequestV2, Field(description="Create quote collection request")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_quote_collection_v2_without_preload_content(
        self,
        quote_collection_request_v2: Annotated[QuoteCollectionRequestV2, Field(description="Create quote collection request")],
        _request_timeout: Union[
            None,
    ...
    def _create_quote_collection_v2_serialize(
        self,
        quote_collection_request_v2,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if quote_collection_request_v2 is not None:
            _body_params = quote_collection_request_v2
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v3/quotes/quote-collection',
    ...
    def get_quote_collection_v2(
        ...
        _param = self._get_quote_collection_v2_serialize(
    ...
    @validate_call
    def get_quote_collection_v2_with_http_info(
        self,
        quote_collection_id: Annotated[StrictStr, Field(description="The unique identifier of the quote collection you want to retrieve")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_quote_collection_v2_without_preload_content(
        self,
        quote_collection_id: Annotated[StrictStr, Field(description="The unique identifier of the quote collection you want to retrieve")],
        _request_timeout: Union[
            None,
    ...
    def _get_quote_collection_v2_serialize(
        self,
        quote_collection_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/quotes/quote-collection/{quote-collection-id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_quote_v2(
        ...
        _param = self._get_quote_v2_serialize(
            quote_id=quote_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_quote_v2_with_http_info(
        self,
        quote_id: Annotated[StrictStr, Field(description="The unique identifier of the quote to retrieve")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_quote_v2_without_preload_content(
        self,
        quote_id: Annotated[StrictStr, Field(description="The unique identifier of the quote to retrieve")],
        _request_timeout: Union[
            None,
    ...
    def _get_quote_v2_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v3/quotes/{quote-id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
