...
class LedgerPublicApi:
    ...
    def get_balances(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            ...
            '401': "GetBalances401Response",
            '500': "GetBalances500Response",
        }
    ...
    def get_statements_transactions_for_customer(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetStatementsTransactionsForCustomer200Response",
            '400': "GetBalances400Response",
    ...
    def get_statements_transactions_for_customer_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetStatementsTransactionsForCustomer200Response]:
        """Get ledger transactions
