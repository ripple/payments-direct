...
from ripple_payments_direct.api_response import ApiResponse, T as ApiResponseT
import ripple_payments_direct.models
from ripple_payments_direct import rest
from ripple_payments_direct.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/2025.11/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ripple_payments_direct.models, klass)
