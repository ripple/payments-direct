...
Retrieve identities for your organization with optional filters.
...
with ripple_payments_direct.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("Exception when calling IdentitiesV3Api->get_identity_by_internal_id: %s\n" % e)
```
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **internal_id** | **str**| The Internal ID of the identity to retrieve. | 
