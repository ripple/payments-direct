...
**network** | **str** | The default name of the blockchain network for this instrument | [optional] [readonly] [default to 'SOLANA']
...
json = "{}"
# create an instance of SolWallet from a JSON string
sol_wallet_instance = SolWallet.from_json(json)
# print the JSON string representation of the object
print(SolWallet.to_json())

# convert the object into a dict
sol_wallet_dict = sol_wallet_instance.to_dict()
# create an instance of SolWallet from a dict
sol_wallet_from_dict = SolWallet.from_dict(sol_wallet_dict)
```
