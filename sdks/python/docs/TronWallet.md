...
**network** | **str** | The default name of the blockchain network for this instrument | [optional] [readonly] [default to 'TRON']
...
json = "{}"
# create an instance of TronWallet from a JSON string
tron_wallet_instance = TronWallet.from_json(json)
# print the JSON string representation of the object
print(TronWallet.to_json())

# convert the object into a dict
tron_wallet_dict = tron_wallet_instance.to_dict()
# create an instance of TronWallet from a dict
tron_wallet_from_dict = TronWallet.from_dict(tron_wallet_dict)
```
