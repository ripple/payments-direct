...
**identity_state** | **str** | The state of the identity   * ACTIVE   * DEACTIVATED  | 
**nick_name** | **str** | The nickname for the identity provided at the time of identity creation | [optional] 
**internal_id** | **str** | The client-provided unique identifier supplied when the identity was created or last updated. | [optional] 
