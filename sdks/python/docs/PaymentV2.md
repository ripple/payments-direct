...
**fees** | [**List[FeeSummary]**](FeeSummary.md) | A summary of fees included in the payment quote. | [optional] 
...
json = "{}"
# create an instance of PaymentV2 from a JSON string
payment_v2_instance = PaymentV2.from_json(json)
# print the JSON string representation of the object
print(PaymentV2.to_json())

# convert the object into a dict
payment_v2_dict = payment_v2_instance.to_dict()
# create an instance of PaymentV2 from a dict
payment_v2_from_dict = PaymentV2.from_dict(payment_v2_dict)
```
