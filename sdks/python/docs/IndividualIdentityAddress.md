...
**city** | **str** | City | 
**state_or_province** | **str** | Information that locates and identifies the state / county for the party, as defined by postal services | [optional] 
**postal_code** | **str** | Postal code for the individual&#39;s address | [optional] 
