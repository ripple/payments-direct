...
------------ | ------------- | ------------- | -------------
**NickName** | Pointer to **string** | The new nickname for the identity | [optional] 
...
### NewPutIdentityRequestV3WithDefaults
...
`func (o *PutIdentityRequestV3) GetOriginatorAccountNumber() string`
...
`func (o *PutIdentityRequestV3) GetOriginatorAccountNumberOk() (*string, bool)`
...
`func (o *PutIdentityRequestV3) SetOriginatorAccountNumber(v string)`

SetOriginatorAccountNumber sets OriginatorAccountNumber field to given value.

### HasOriginatorAccountNumber

`func (o *PutIdentityRequestV3) HasOriginatorAccountNumber() bool`
