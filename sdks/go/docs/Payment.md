...
`func (o *Payment) SetJitFundingExpiresAt(v time.Time)`

SetJitFundingExpiresAt sets JitFundingExpiresAt field to given value.

### HasJitFundingExpiresAt

`func (o *Payment) HasJitFundingExpiresAt() bool`
