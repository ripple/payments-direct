...
`func (o *RippleFinancialInstrumentEntry) GetSwift() Swift`

GetSwift returns the Swift field if non-nil, zero value otherwise.

### GetSwiftOk

`func (o *RippleFinancialInstrumentEntry) GetSwiftOk() (*Swift, bool)`
...
`func (o *RippleFinancialInstrumentEntry) SetSwift(v Swift)`

SetSwift sets Swift field to given value.

### HasSwift

`func (o *RippleFinancialInstrumentEntry) HasSwift() bool`
