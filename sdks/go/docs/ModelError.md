...
`func NewModelError(code string, title string, type_ string, description string, timestamp time.Time, ) *ModelError`
...
`func (o *ModelError) GetTimestamp() time.Time`

GetTimestamp returns the Timestamp field if non-nil, zero value otherwise.

### GetTimestampOk

`func (o *ModelError) GetTimestampOk() (*time.Time, bool)`
...
`func (o *ModelError) SetTimestamp(v time.Time)`
