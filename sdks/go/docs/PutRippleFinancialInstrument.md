...
`func (o *PutRippleFinancialInstrument) GetAfricaBankPayout() AfricaBankPayout`

GetAfricaBankPayout returns the AfricaBankPayout field if non-nil, zero value otherwise.

### GetAfricaBankPayoutOk

`func (o *PutRippleFinancialInstrument) GetAfricaBankPayoutOk() (*AfricaBankPayout, bool)`
...
`func (o *PutRippleFinancialInstrument) SetAfricaBankPayout(v AfricaBankPayout)`

SetAfricaBankPayout sets AfricaBankPayout field to given value.

### HasAfricaBankPayout

`func (o *PutRippleFinancialInstrument) HasAfricaBankPayout() bool`
