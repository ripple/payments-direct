...
`func (o *PaymentRailObjects) GetAfricaBankPayout() AfricaBankPayout`

GetAfricaBankPayout returns the AfricaBankPayout field if non-nil, zero value otherwise.

### GetAfricaBankPayoutOk

`func (o *PaymentRailObjects) GetAfricaBankPayoutOk() (*AfricaBankPayout, bool)`
...
`func (o *PaymentRailObjects) SetAfricaBankPayout(v AfricaBankPayout)`

SetAfricaBankPayout sets AfricaBankPayout field to given value.

### HasAfricaBankPayout

`func (o *PaymentRailObjects) HasAfricaBankPayout() bool`
