...
**BeneficiaryIdentityNickName** | Pointer to **string** | The beneficiary&#39;s nickname at the identity version this payment references. Editing the nickname later does not change the value returned for this payment. | [optional] 
