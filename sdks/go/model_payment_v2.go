...
// checks if the PaymentV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentV2{}

// PaymentV2 struct for PaymentV2
...
func (o PaymentV2) MarshalJSON() ([]byte, error) {
...
func (o PaymentV2) ToMap() (map[string]interface{}, error) {
...
func (o *PaymentV2) UnmarshalJSON(data []byte) (err error) {
	...
	varPaymentV2 := _PaymentV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaymentV2)

	if err != nil {
		return err
	}

	*o = PaymentV2(varPaymentV2)

	return err
}

type NullablePaymentV2 struct {
	value *PaymentV2
	isSet bool
}

func (v NullablePaymentV2) Get() *PaymentV2 {
	return v.value
}

func (v *NullablePaymentV2) Set(val *PaymentV2) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentV2) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentV2(val *PaymentV2) *NullablePaymentV2 {
	return &NullablePaymentV2{value: val, isSet: true}
}

func (v NullablePaymentV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
