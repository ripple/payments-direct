...
// checks if the GetStatementsTransactionsForCustomer200ResponseInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetStatementsTransactionsForCustomer200ResponseInner{}

// GetStatementsTransactionsForCustomer200ResponseInner A page of ledger statement transactions and pagination metadata.
type GetStatementsTransactionsForCustomer200ResponseInner struct {
	...
	StatementTransactions []GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner `json:"statementTransactions,omitempty"`
}
...
func NewGetStatementsTransactionsForCustomer200ResponseInner() *GetStatementsTransactionsForCustomer200ResponseInner {
	this := GetStatementsTransactionsForCustomer200ResponseInner{}
	return &this
}
...
func (o *GetStatementsTransactionsForCustomer200ResponseInner) GetStatementTransactions() []GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner {
	if o == nil || IsNil(o.StatementTransactions) {
		var ret []GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner
		return ret
	}
...
// SetStatementTransactions gets a reference to the given []GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner and assigns it to the StatementTransactions field.
...
func (o GetStatementsTransactionsForCustomer200ResponseInner) MarshalJSON() ([]byte, error) {
...
func (o GetStatementsTransactionsForCustomer200ResponseInner) ToMap() (map[string]interface{}, error) {
...
type NullableGetStatementsTransactionsForCustomer200ResponseInner struct {
	value *GetStatementsTransactionsForCustomer200ResponseInner
	isSet bool
}

func (v NullableGetStatementsTransactionsForCustomer200ResponseInner) Get() *GetStatementsTransactionsForCustomer200ResponseInner {
	return v.value
}

func (v *NullableGetStatementsTransactionsForCustomer200ResponseInner) Set(val *GetStatementsTransactionsForCustomer200ResponseInner) {
	v.value = val
	v.isSet = true
}

func (v NullableGetStatementsTransactionsForCustomer200ResponseInner) IsSet() bool {
	return v.isSet
}

func (v *NullableGetStatementsTransactionsForCustomer200ResponseInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetStatementsTransactionsForCustomer200ResponseInner(val *GetStatementsTransactionsForCustomer200ResponseInner) *NullableGetStatementsTransactionsForCustomer200ResponseInner {
	return &NullableGetStatementsTransactionsForCustomer200ResponseInner{value: val, isSet: true}
}

func (v NullableGetStatementsTransactionsForCustomer200ResponseInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetStatementsTransactionsForCustomer200ResponseInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
