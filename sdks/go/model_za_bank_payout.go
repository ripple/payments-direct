...
// checks if the ZaBankPayout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZaBankPayout{}

// ZaBankPayout Rails: Bank Payout  Rail Definitions:   Bank Payout:     - Availability: 24/7/365     - Limit: R 300,000     - Settlement: Real time to 48 hours     - Cut-off time: Real time     - Banking holidays: Applicable  Routing Evaluation Order:   1. Bank Payout – Conditions: Account addressability, amount ≤ R 300,000 
type ZaBankPayout struct {
	// The name of the identity's bank
	BankName string `json:"bankName" validate:"regexp=^(?![ .,'&\\/()-])(?!.*([ .,'&\\/()-])\\\\1)[\\\\p{L}\\\\p{N} .,'&\\/()-]+(?<![ .,'&\\/-])?$"`
	// Ripple Bank Code (RBC) for the destination bank in South Africa. See the Bank Codes resource in Ripple Docs for the authoritative list of supported values.
...
type _ZaBankPayout ZaBankPayout
...
func (o ZaBankPayout) MarshalJSON() ([]byte, error) {
...
func (o ZaBankPayout) ToMap() (map[string]interface{}, error) {
...
func (o *ZaBankPayout) UnmarshalJSON(data []byte) (err error) {
	...
	varZaBankPayout := _ZaBankPayout{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZaBankPayout)

	if err != nil {
		return err
	}

	*o = ZaBankPayout(varZaBankPayout)

	return err
}

type NullableZaBankPayout struct {
	value *ZaBankPayout
	isSet bool
}

func (v NullableZaBankPayout) Get() *ZaBankPayout {
	return v.value
}

func (v *NullableZaBankPayout) Set(val *ZaBankPayout) {
	v.value = val
	v.isSet = true
}

func (v NullableZaBankPayout) IsSet() bool {
	return v.isSet
}

func (v *NullableZaBankPayout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZaBankPayout(val *ZaBankPayout) *NullableZaBankPayout {
	return &NullableZaBankPayout{value: val, isSet: true}
}

func (v NullableZaBankPayout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZaBankPayout) UnmarshalJSON(src []byte) error {
	v.isSet = true
