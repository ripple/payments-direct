...
// checks if the GetBalances401Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &GetBalances401Response{}

// GetBalances401Response struct for GetBalances401Response
type GetBalances401Response struct {
...
type _GetBalances401Response GetBalances401Response
...
func (o GetBalances401Response) MarshalJSON() ([]byte, error) {
...
func (o GetBalances401Response) ToMap() (map[string]interface{}, error) {
...
func (o *GetBalances401Response) UnmarshalJSON(data []byte) (err error) {
	...
	varGetBalances401Response := _GetBalances401Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetBalances401Response)

	if err != nil {
		return err
	}

	*o = GetBalances401Response(varGetBalances401Response)

	return err
}

type NullableGetBalances401Response struct {
	value *GetBalances401Response
	isSet bool
}

func (v NullableGetBalances401Response) Get() *GetBalances401Response {
	return v.value
}

func (v *NullableGetBalances401Response) Set(val *GetBalances401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableGetBalances401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableGetBalances401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGetBalances401Response(val *GetBalances401Response) *NullableGetBalances401Response {
	return &NullableGetBalances401Response{value: val, isSet: true}
}

func (v NullableGetBalances401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGetBalances401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
