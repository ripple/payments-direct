...
// StateType Lifecycle state of the identity:   • ACTIVE - The identity exists and can be used.   • BLOCKED - The identity exists but is restricted from use.   • DEACTIVATED - The identity is inactive and cannot be used for new payments. 
type StateType string

// List of state-type
const (
	STATETYPE_ACTIVE StateType = "ACTIVE"
	STATETYPE_BLOCKED StateType = "BLOCKED"
	STATETYPE_DEACTIVATED StateType = "DEACTIVATED"
)
