...
// checks if the ZmBankPayout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ZmBankPayout{}

// ZmBankPayout Rails: Bank Payout  Rail Definitions:   Bank Payout:     - Availability: 24/7/365     - Limit: ZK 150,000     - Settlement: Real time to 48 hours     - Cut-off time: Real time     - Banking holidays: Applicable  Routing Evaluation Order:   1. Bank Payout – Conditions: Account addressability, amount ≤ ZK 150,000 
type ZmBankPayout struct {
...
type _ZmBankPayout ZmBankPayout
...
func (o ZmBankPayout) MarshalJSON() ([]byte, error) {
...
func (o ZmBankPayout) ToMap() (map[string]interface{}, error) {
...
func (o *ZmBankPayout) UnmarshalJSON(data []byte) (err error) {
	...
	varZmBankPayout := _ZmBankPayout{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varZmBankPayout)

	if err != nil {
		return err
	}

	*o = ZmBankPayout(varZmBankPayout)

	return err
}

type NullableZmBankPayout struct {
	value *ZmBankPayout
	isSet bool
}

func (v NullableZmBankPayout) Get() *ZmBankPayout {
	return v.value
}

func (v *NullableZmBankPayout) Set(val *ZmBankPayout) {
	v.value = val
	v.isSet = true
}

func (v NullableZmBankPayout) IsSet() bool {
	return v.isSet
}

func (v *NullableZmBankPayout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableZmBankPayout(val *ZmBankPayout) *NullableZmBankPayout {
	return &NullableZmBankPayout{value: val, isSet: true}
}

func (v NullableZmBankPayout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableZmBankPayout) UnmarshalJSON(src []byte) error {
	v.isSet = true
