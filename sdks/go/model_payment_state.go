...
// PaymentState the model 'PaymentState'
type PaymentState string

// List of PaymentState
const (
	PAYMENTSTATE_INITIATED PaymentState = "INITIATED"
	PAYMENTSTATE_VALIDATING PaymentState = "VALIDATING"
	PAYMENTSTATE_TRANSFERRING PaymentState = "TRANSFERRING"
	PAYMENTSTATE_COMPLETED PaymentState = "COMPLETED"
	PAYMENTSTATE_FAILED PaymentState = "FAILED"
	PAYMENTSTATE_QUOTED PaymentState = "QUOTED"
	PAYMENTSTATE_RETURNED PaymentState = "RETURNED"
)

// All allowed values of PaymentState enum
var AllowedPaymentStateEnumValues = []PaymentState{
	"INITIATED",
	"VALIDATING",
	"TRANSFERRING",
	"COMPLETED",
...
func (v *PaymentState) UnmarshalJSON(src []byte) error {
	var value string
	err := json.Unmarshal(src, &value)
	if err != nil {
		return err
	}
	enumTypeValue := PaymentState(value)
	for _, existing := range AllowedPaymentStateEnumValues {
	...
	return fmt.Errorf("%+v is not a valid PaymentState", value)
}

// NewPaymentStateFromValue returns a pointer to a valid PaymentState
// for the value passed as argument, or an error if the value passed is not allowed by the enum
func NewPaymentStateFromValue(v string) (*PaymentState, error) {
	ev := PaymentState(v)
	if ev.IsValid() {
		return &ev, nil
	} else {
		return nil, fmt.Errorf("invalid value '%v' for PaymentState: valid values are %v", v, AllowedPaymentStateEnumValues)
	}
}

// IsValid return true if the value is valid for the enum, false otherwise
func (v PaymentState) IsValid() bool {
	for _, existing := range AllowedPaymentStateEnumValues {
		if existing == v {
			return true
		}
...
// Ptr returns reference to PaymentState value
func (v PaymentState) Ptr() *PaymentState {
	return &v
}

type NullablePaymentState struct {
	value *PaymentState
	isSet bool
}

func (v NullablePaymentState) Get() *PaymentState {
	return v.value
}

func (v *NullablePaymentState) Set(val *PaymentState) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentState) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentState) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentState(val *PaymentState) *NullablePaymentState {
	return &NullablePaymentState{value: val, isSet: true}
}

func (v NullablePaymentState) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentState) UnmarshalJSON(src []byte) error {
	v.isSet = true
