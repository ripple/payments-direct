...
func (r LedgerPublicAPIGetStatementsTransactionsForCustomerRequest) Execute() (*GetStatementsTransactionsForCustomer200Response, *http.Response, error) {
...
func (a *LedgerPublicAPIService) GetStatementsTransactionsForCustomerExecute(r LedgerPublicAPIGetStatementsTransactionsForCustomerRequest) (*GetStatementsTransactionsForCustomer200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetStatementsTransactionsForCustomer200Response
	)
