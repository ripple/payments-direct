...
// checks if the PaymentsResponseV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaymentsResponseV2{}

// PaymentsResponseV2 struct for PaymentsResponseV2
type PaymentsResponseV2 struct {
	// Array of Payment objects
	Data []PaymentV2 `json:"data,omitempty"`
...
// SetData gets a reference to the given []PaymentV2 and assigns it to the Data field.
...
func (o PaymentsResponseV2) MarshalJSON() ([]byte, error) {
...
func (o PaymentsResponseV2) ToMap() (map[string]interface{}, error) {
...
type NullablePaymentsResponseV2 struct {
	value *PaymentsResponseV2
	isSet bool
}

func (v NullablePaymentsResponseV2) Get() *PaymentsResponseV2 {
	return v.value
}

func (v *NullablePaymentsResponseV2) Set(val *PaymentsResponseV2) {
	v.value = val
	v.isSet = true
}

func (v NullablePaymentsResponseV2) IsSet() bool {
	return v.isSet
}

func (v *NullablePaymentsResponseV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaymentsResponseV2(val *PaymentsResponseV2) *NullablePaymentsResponseV2 {
	return &NullablePaymentsResponseV2{value: val, isSet: true}
}

func (v NullablePaymentsResponseV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaymentsResponseV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
