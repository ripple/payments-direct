...
// UseCaseType Classification of the identity:   • INDIVIDUAL - A natural person.   • BUSINESS - A legal entity such as a company or institution. 
type UseCaseType string

// List of useCaseType
const (
	USECASETYPE_INDIVIDUAL UseCaseType = "INDIVIDUAL"
	USECASETYPE_BUSINESS UseCaseType = "BUSINESS"
)
