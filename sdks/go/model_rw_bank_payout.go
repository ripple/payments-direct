...
// checks if the RwBankPayout type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RwBankPayout{}

// RwBankPayout Rails: RSwitch  Rail Definitions:   RSwitch:     - Availability: 24/7/365     - Limit: RWF 10,000,000     - Settlement: Real time to 48 hours     - Cut-off time: Real time     - Banking holidays: Applicable  Routing Evaluation Order:   1. RSwitch – Conditions: Account addressability, amount ≤ RWF 10,000,000 
type RwBankPayout struct {
...
type _RwBankPayout RwBankPayout
...
func (o RwBankPayout) MarshalJSON() ([]byte, error) {
...
func (o RwBankPayout) ToMap() (map[string]interface{}, error) {
...
func (o *RwBankPayout) UnmarshalJSON(data []byte) (err error) {
	...
	varRwBankPayout := _RwBankPayout{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRwBankPayout)

	if err != nil {
		return err
	}

	*o = RwBankPayout(varRwBankPayout)

	return err
}

type NullableRwBankPayout struct {
	value *RwBankPayout
	isSet bool
}

func (v NullableRwBankPayout) Get() *RwBankPayout {
	return v.value
}

func (v *NullableRwBankPayout) Set(val *RwBankPayout) {
	v.value = val
	v.isSet = true
}

func (v NullableRwBankPayout) IsSet() bool {
	return v.isSet
}

func (v *NullableRwBankPayout) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRwBankPayout(val *RwBankPayout) *NullableRwBankPayout {
	return &NullableRwBankPayout{value: val, isSet: true}
}

func (v NullableRwBankPayout) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRwBankPayout) UnmarshalJSON(src []byte) error {
	v.isSet = true
