...
// APIClient manages communication with the Payments Direct API API v1.0.0
...
type APIClient struct {
	...
	IdentitiesV2API *IdentitiesV2APIService

	IdentitiesV3API *IdentitiesV3APIService

	LedgerPublicAPI *LedgerPublicAPIService

	PaymentsAPI *PaymentsAPIService

	PaymentsV2API *PaymentsV2APIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.IdentitiesV2API = (*IdentitiesV2APIService)(&c.common)
	c.IdentitiesV3API = (*IdentitiesV3APIService)(&c.common)
	c.LedgerPublicAPI = (*LedgerPublicAPIService)(&c.common)
	c.PaymentsAPI = (*PaymentsAPIService)(&c.common)
	c.PaymentsV2API = (*PaymentsV2APIService)(&c.common)
