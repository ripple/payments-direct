...
// checks if the ThPromptpay type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ThPromptpay{}

// ThPromptpay Rails: PromptPay  Rail Definitions:  PromptPay (National ITMX):   - Availability: 24/7/365   - Limit: THB 500,000 per transaction   - Settlement: Real-time (within seconds)   - Cut-off time: None   - Banking holidays: Not applicable  Routing Evaluation Order: Not applicable 
type ThPromptpay struct {
	// The name of the identity's bank
	BankName string `json:"bankName" validate:"regexp=^(?![ .,'&\\/()-])(?!.*([ .,'&\\/()-])\\\\1)[\\\\p{L}\\\\p{N} .,'&\\/()-]+(?<![ .,'&\\/-])?$"`
	// Domestic bank code for the identity's bank in Thailand. See the Bank Codes resource in Ripple Docs for the authoritative list of supported values.
...
func (o ThPromptpay) MarshalJSON() ([]byte, error) {
...
func (o ThPromptpay) ToMap() (map[string]interface{}, error) {
...
func (o *ThPromptpay) UnmarshalJSON(data []byte) (err error) {
	...
	varThPromptpay := _ThPromptpay{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varThPromptpay)

	if err != nil {
		return err
	}

	*o = ThPromptpay(varThPromptpay)

	return err
}

type NullableThPromptpay struct {
	value *ThPromptpay
	isSet bool
}

func (v NullableThPromptpay) Get() *ThPromptpay {
	return v.value
}

func (v *NullableThPromptpay) Set(val *ThPromptpay) {
	v.value = val
	v.isSet = true
}

func (v NullableThPromptpay) IsSet() bool {
	return v.isSet
}

func (v *NullableThPromptpay) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThPromptpay(val *ThPromptpay) *NullableThPromptpay {
	return &NullableThPromptpay{value: val, isSet: true}
}

func (v NullableThPromptpay) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThPromptpay) UnmarshalJSON(src []byte) error {
	v.isSet = true
