...
**bankCode** | **string** | Ripple Bank Code (RBC) for the destination bank in South Africa. See the Bank Codes resource in Ripple Docs for the authoritative list of supported values. | [default to undefined]
...
```typescript
import { ZaBankPayout } from '@ripple/payments-direct-client';

const instance: ZaBankPayout = {
    bankName,
    bankCode,
    accountNumber,
};
