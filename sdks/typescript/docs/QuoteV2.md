...
**fees** | [**Array&lt;FeeSummaryV2&gt;**](FeeSummaryV2.md) | A summary of fees included in this quote. | [optional] [default to undefined]
...
```typescript
import { QuoteV2 } from '@ripple/payments-direct-client';

const instance: QuoteV2 = {
    quoteId,
    quoteStatus,
    quoteAmountType,
    sourceAmount,
