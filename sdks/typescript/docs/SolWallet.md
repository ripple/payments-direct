...
**network** | **string** | The default name of the blockchain network for this instrument | [optional] [readonly] [default to 'SOLANA']
...
```typescript
import { SolWallet } from '@ripple/payments-direct-client';

const instance: SolWallet = {
    walletAddress,
