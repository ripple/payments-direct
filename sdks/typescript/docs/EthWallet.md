...
**network** | **string** | The default name of the blockchain network for this instrument | [optional] [readonly] [default to 'ETHEREUM']
...
```typescript
import { EthWallet } from '@ripple/payments-direct-client';

const instance: EthWallet = {
    walletAddress,
