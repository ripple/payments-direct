...
------------ | ------------- | ------------- | -------------
**beneficiaryFinancialInstrumentId** | **string** | The financial instrument ID, the identity ID of the payment beneficiary is related to. | [optional] [default to undefined]
...
**beneficiaryIdentityNickName** | **string** | The beneficiary\&#39;s nickname at the identity version this payment references. Editing the nickname later does not change the value returned for this payment. | [optional] [default to undefined]
...
```typescript
import { DestinationV2 } from '@ripple/payments-direct-client';

const instance: DestinationV2 = {
