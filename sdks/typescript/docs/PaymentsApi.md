...
Create a payment  **Tutorials**  * Learn how to [Create a payment](../tutorials/create-a-v2-payment.md). * Learn how to [Create a third-party payment](../tutorials/create-a-v2-third-party-payment.md). 
