...
**bankCode** | **string** | Ripple Bank Code (RBC) for the destination bank in Uganda. See the Bank Codes resource in Ripple Docs for the authoritative list of supported values. | [default to undefined]
...
```typescript
import { UgBankPayout } from '@ripple/payments-direct-client';

const instance: UgBankPayout = {
    bankName,
    bankCode,
    accountNumber,
};
