...
// @ts-ignore
import type { IndividualIdentityLocalizedHanzi } from './individual-identity-localized-hanzi';
 ...
 * @export
 * @interface IndividualIdentityLocalized
 */
export interface IndividualIdentityLocalized {
    /**
     * 
     * @type {IndividualIdentityLocalizedHanzi}
     * @memberof IndividualIdentityLocalized
     */
    'hanzi'?: IndividualIdentityLocalizedHanzi;
}
