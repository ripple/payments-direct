 ...
 * @export
 * @interface GetBalances200ResponseBalancesInner
 */
export interface GetBalances200ResponseBalancesInner {
    /**
     * The funding method associated with your account.
     * @type {string}
     * @memberof GetBalances200ResponseBalancesInner
     */
    'fundingType': GetBalances200ResponseBalancesInnerFundingTypeEnum;
    /**
     * Currency code.
     * @type {string}
     * @memberof GetBalances200ResponseBalancesInner
...
export type GetBalances200ResponseBalancesInnerFundingTypeEnum = typeof GetBalances200ResponseBalancesInnerFundingTypeEnum[keyof typeof GetBalances200ResponseBalancesInnerFundingTypeEnum];
