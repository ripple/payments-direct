...
export interface EthWallet {
     ...
     * @memberof EthWallet
     */
    'supportedCorridors'?: Array<EthWalletSupportedCorridorsEnum>;
}

export const EthWalletSupportedCorridorsEnum = {
    ETH_USDT: 'ETH_USDT',
    ETH_USDC: 'ETH_USDC',
    ETH_RLUSD: 'ETH_RLUSD'
} as const;

export type EthWalletSupportedCorridorsEnum = typeof EthWalletSupportedCorridorsEnum[keyof typeof EthWalletSupportedCorridorsEnum];
