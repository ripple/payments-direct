 ...
 * 
 * @export
 * @interface GetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner
 */
export interface GetStatementsTransactionsForCustomer200ResponseStatementTransactionsInner {
    /**
