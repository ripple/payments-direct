...
export interface SolWallet {
     ...
     * @memberof SolWallet
     */
    'supportedCorridors'?: Array<SolWalletSupportedCorridorsEnum>;
}

export const SolWalletSupportedCorridorsEnum = {
    SOLANA_USDC: 'SOLANA_USDC'
} as const;

export type SolWalletSupportedCorridorsEnum = typeof SolWalletSupportedCorridorsEnum[keyof typeof SolWalletSupportedCorridorsEnum];
