...
// @ts-ignore
import type { IdentityResponseV3 } from './identity-response-v3';

/**
 * 
 * @export
 * @interface ListIdentitiesResponseV3
 */
export interface ListIdentitiesResponseV3 {
    /**
     * The list of the identities that match the query parameters
     * @type {Array<IdentityResponseV3>}
     * @memberof ListIdentitiesResponseV3
     */
    'data'?: Array<IdentityResponseV3>;
    /**
