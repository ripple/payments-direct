...
// May contain unused imports in some cases
// @ts-ignore
import type { PaymentFilterV2 } from './payment-filter-v2';
// May contain unused imports in some cases
// @ts-ignore
import type { PaymentV2 } from './payment-v2';
// May contain unused imports in some cases
// @ts-ignore
import type { SortV2 } from './sort-v2';

/**
 * 
 * @export
 * @interface PaymentsResponseV2
 */
export interface PaymentsResponseV2 {
    /**
     * Array of Payment objects
     * @type {Array<PaymentV2>}
     * @memberof PaymentsResponseV2
     */
    'data'?: Array<PaymentV2>;
    /**
     * 
     * @type {PaymentFilterV2}
     * @memberof PaymentsResponseV2
     */
    'filter'?: PaymentFilterV2;
    /**
     * 
     * @type {SortV2}
     * @memberof PaymentsResponseV2
