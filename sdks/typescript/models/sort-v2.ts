...
export interface SortV2 {
     ...
     * @memberof SortV2
     */
    'sortDirection'?: SortV2SortDirectionEnum;
}

export const SortV2SortDirectionEnum = {
    ASC: 'ASC',
    DESC: 'DESC'
} as const;

export type SortV2SortDirectionEnum = typeof SortV2SortDirectionEnum[keyof typeof SortV2SortDirectionEnum];
