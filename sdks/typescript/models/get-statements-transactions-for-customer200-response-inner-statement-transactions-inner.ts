 ...
 * 
 * @export
 * @interface GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner
 */
export interface GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner {
    /**
     * Identifier of the tenant that owns this ledger transaction.
     * @type {string}
     * @memberof GetStatementsTransactionsForCustomer200ResponseInnerStatementTransactionsInner
     */
    'tenant'?: string;
    /**
