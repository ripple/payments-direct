...
// @ts-ignore
import type { IndividualIdentityAddress } from './individual-identity-address';
// May contain unused imports in some cases
// @ts-ignore
...
export interface IndividualIdentity {
    ...
    /**
     * 
     * @type {IndividualIdentityAddress}
     * @memberof IndividualIdentity
     */
     ...
     * @memberof IndividualIdentity
     */
    'identityDocuments'?: Array<IndividualIdentityIdentityDocumentsInner>;
    /**
     * Date of Birth.
     * @type {string}
     * @memberof IndividualIdentity
