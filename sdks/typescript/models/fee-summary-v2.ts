...
// @ts-ignore
import type { TotalFeeBreakdownV2 } from './total-fee-breakdown-v2';

/**
 * A summary of fees included in this quote.
 * @export
 * @interface FeeSummaryV2
 */
export interface FeeSummaryV2 {
    /**
     * The value of the total fee included in this quote.
     * @type {number}
     * @memberof FeeSummaryV2
     */
    'totalFee'?: number;
    /**
     ...
     * @type {Array<TotalFeeBreakdownV2>}
     * @memberof FeeSummaryV2
     */
    'feeBreakdown'?: Array<TotalFeeBreakdownV2>;
}
