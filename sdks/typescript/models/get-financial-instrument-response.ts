...
// @ts-ignore
import type { GetIdentityResponseV3 } from './get-identity-response-v3';
// May contain unused imports in some cases
// @ts-ignore
 ...
 * @export
 * @interface GetFinancialInstrumentResponse
 */
export interface GetFinancialInstrumentResponse {
    /**
     * 
     * @type {RippleFinancialInstrumentEntry}
     * @memberof GetFinancialInstrumentResponse
     */
    'financialInstrument': RippleFinancialInstrumentEntry;
    /**
     * 
     * @type {GetIdentityResponseV3}
     * @memberof GetFinancialInstrumentResponse
     */
    'identity'?: GetIdentityResponseV3;
}
