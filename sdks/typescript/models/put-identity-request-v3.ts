...
// May contain unused imports in some cases
// @ts-ignore
import type { IndividualIdentity } from './individual-identity';
// May contain unused imports in some cases
// @ts-ignore
import type { PutRippleIdentity } from './put-ripple-identity';

/**
 * @type PutIdentityRequestV3
 * @export
 */
export type PutIdentityRequestV3 = PutRippleIdentity;
