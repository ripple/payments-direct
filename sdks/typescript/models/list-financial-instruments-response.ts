...
// @ts-ignore
import type { FinancialInstrumentMetadata } from './financial-instrument-metadata';

/**
 * 
 * @export
 * @interface ListFinancialInstrumentsResponse
 */
export interface ListFinancialInstrumentsResponse {
    /**
     * The list of the financial instruments that match the query parameters
     * @type {Array<FinancialInstrumentMetadata>}
     * @memberof ListFinancialInstrumentsResponse
     */
    'data'?: Array<FinancialInstrumentMetadata>;
    /**
