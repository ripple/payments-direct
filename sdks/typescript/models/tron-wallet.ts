...
export interface TronWallet {
     ...
     * @memberof TronWallet
     */
    'supportedCorridors'?: Array<TronWalletSupportedCorridorsEnum>;
}

export const TronWalletSupportedCorridorsEnum = {
    TRON_USDT: 'TRON_USDT'
} as const;

export type TronWalletSupportedCorridorsEnum = typeof TronWalletSupportedCorridorsEnum[keyof typeof TronWalletSupportedCorridorsEnum];
