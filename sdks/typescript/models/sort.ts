...
// @ts-ignore
import type { PaymentSortField } from './payment-sort-field';
...
export interface Sort {
     ...
     * @memberof Sort
     */
    'sortDirection'?: SortSortDirectionEnum;
}

export const SortSortDirectionEnum = {
    ASC: 'ASC',
    DESC: 'DESC'
} as const;

export type SortSortDirectionEnum = typeof SortSortDirectionEnum[keyof typeof SortSortDirectionEnum];
