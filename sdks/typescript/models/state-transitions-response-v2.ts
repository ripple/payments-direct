...
// @ts-ignore
import type { StateTransitionV2 } from './state-transition-v2';

/**
 * 
 * @export
 * @interface StateTransitionsResponseV2
 */
export interface StateTransitionsResponseV2 {
    /**
     * 
     * @type {Array<StateTransitionV2>}
     * @memberof StateTransitionsResponseV2
     */
    'stateTransitions': Array<StateTransitionV2>;
}
