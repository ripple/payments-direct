...
// @ts-ignore
import type { GetBalances400ResponseErrorsInner } from './get-balances400-response-errors-inner';

/**
 * 
 * @export
 * @interface GetBalances400Response
 */
export interface GetBalances400Response {
    /**
     * The HTTP status code representing the error response
     * @type {number}
     * @memberof GetBalances400Response
     */
    'status': number;
    /**
     * An array containing details about the errors encountered
     * @type {Array<GetBalances400ResponseErrorsInner>}
     * @memberof GetBalances400Response
     */
    'errors': Array<GetBalances400ResponseErrorsInner>;
}
