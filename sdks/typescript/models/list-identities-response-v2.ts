...
// @ts-ignore
import type { IdentityV2 } from './identity-v2';

/**
 * 
 * @export
 * @interface ListIdentitiesResponseV2
 */
export interface ListIdentitiesResponseV2 {
    /**
     * The list of the identities that match the query parameters
     * @type {Array<IdentityV2>}
     * @memberof ListIdentitiesResponseV2
     */
    'data'?: Array<IdentityV2>;
}
