...
// @ts-ignore
import type { BusinessIdentityLocalizedHanzi } from './business-identity-localized-hanzi';
 ...
 * @export
 * @interface BusinessIdentityLocalized
 */
export interface BusinessIdentityLocalized {
    /**
     * 
     * @type {BusinessIdentityLocalizedHanzi}
     * @memberof BusinessIdentityLocalized
     */
    'hanzi'?: BusinessIdentityLocalizedHanzi;
}
