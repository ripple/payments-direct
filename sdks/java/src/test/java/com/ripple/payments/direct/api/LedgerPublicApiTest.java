...
public class LedgerPublicApiTest {
    ...
    public void getStatementsTransactionsForCustomerTest() throws ApiException {
        ...
        List<GetStatementsTransactionsForCustomer200ResponseInnerDTO> response = api.getStatementsTransactionsForCustomer(currency, startDttm, endDttm, pageSize, status, txnReference, offset, sortKey, sortDirection);
