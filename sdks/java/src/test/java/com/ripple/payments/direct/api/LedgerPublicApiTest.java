...
/**
 * API tests for LedgerPublicApi
 */
@Disabled
public class LedgerPublicApiTest {

    private final LedgerPublicApi api = new LedgerPublicApi();
    ...
    public void getBalancesTest() throws ApiException {
        ...
        GetBalances200ResponseDTO response = api.getBalances(currency);
     ...
     */
    @Test
    public void getStatementsTransactionsForCustomerTest() throws ApiException {
        String currency = null;
        OffsetDateTime startDttm = null;
        OffsetDateTime endDttm = null;
        ...
        GetStatementsTransactionsForCustomer200ResponseDTO response = api.getStatementsTransactionsForCustomer(currency, startDttm, endDttm, pageSize, status, txnReference, offset, sortKey, sortDirection);
