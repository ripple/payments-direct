...
public class AuthenticationApiTest {
    ...
    public void authenticateTest() throws ApiException {
        ...
        AuthenticationResponseDTO response = api.authenticate(authenticationRequestDTO, authorization);
     ...
     */
    @Test
    public void testAuthTokenTest() throws ApiException {
        List<ValidateTokenResponseDTO> response = api.testAuthToken();
