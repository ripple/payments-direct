...
public class QuoteApiTest {
     ...
     */
    @Test
    public void createQuoteCollectionTest() throws ApiException {
        QuoteCollectionRequestDTO quoteCollectionRequestDTO = null;
        QuoteCollectionDTO response = api.createQuoteCollection(quoteCollectionRequestDTO);
    ...
    public void getQuoteTest() throws ApiException {
        UUID quoteId = null;
        QuoteDTO response = api.getQuote(quoteId);
    ...
    public void getQuoteCollectionTest() throws ApiException {
        ...
        QuoteCollectionDTO response = api.getQuoteCollection(quoteCollectionId);
