...
public class PaymentV2DTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentId, cryptoTransactionHash, initiatedAt, expiresAt, lastStateUpdatedAt, paymentState, originator, destination, adjustedExchangeRate, fees, taxes, sourceOfCash, purposeCode, transactionDetails, paymentLabels, receiverRelationship, paymentMemo);
  }
