...
import com.ripple.payments.direct.model.PageDTO;
import com.ripple.payments.direct.model.PaymentFilterV2DTO;
import com.ripple.payments.direct.model.PaymentV2DTO;
import com.ripple.payments.direct.model.SortV2DTO;
...
/**
 * PaymentsResponseV2DTO
 */
@JsonPropertyOrder({
  PaymentsResponseV2DTO.JSON_PROPERTY_DATA,
  PaymentsResponseV2DTO.JSON_PROPERTY_FILTER,
  PaymentsResponseV2DTO.JSON_PROPERTY_SORT,
  PaymentsResponseV2DTO.JSON_PROPERTY_PAGE
})
@JsonTypeName("PaymentsResponseV2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class PaymentsResponseV2DTO {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<PaymentV2DTO> data = new ArrayList<>();

  public static final String JSON_PROPERTY_FILTER = "filter";
  @javax.annotation.Nullable
  private PaymentFilterV2DTO filter;

  public static final String JSON_PROPERTY_SORT = "sort";
  @javax.annotation.Nullable
  private SortV2DTO sort;

  public static final String JSON_PROPERTY_PAGE = "page";
  @javax.annotation.Nullable
  private PageDTO page;

  public PaymentsResponseV2DTO() {
  }

  public PaymentsResponseV2DTO data(@javax.annotation.Nullable List<PaymentV2DTO> data) {
    
    this.data = data;
    return this;
  }

  public PaymentsResponseV2DTO addDataItem(PaymentV2DTO dataItem) {
    if (this.data == null) {
  ...
  public List<PaymentV2DTO> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<PaymentV2DTO> data) {
    this.data = data;
  }

  public PaymentsResponseV2DTO filter(@javax.annotation.Nullable PaymentFilterV2DTO filter) {
  ...
  public PaymentFilterV2DTO getFilter() {
    return filter;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FILTER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilter(@javax.annotation.Nullable PaymentFilterV2DTO filter) {
    this.filter = filter;
  }

  public PaymentsResponseV2DTO sort(@javax.annotation.Nullable SortV2DTO sort) {
  ...
  @JsonProperty(JSON_PROPERTY_SORT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSort(@javax.annotation.Nullable SortV2DTO sort) {
    this.sort = sort;
  }

  public PaymentsResponseV2DTO page(@javax.annotation.Nullable PageDTO page) {
  ...
  @JsonProperty(JSON_PROPERTY_PAGE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPage(@javax.annotation.Nullable PageDTO page) {
    this.page = page;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentsResponseV2DTO paymentsResponseV2 = (PaymentsResponseV2DTO) o;
    return Objects.equals(this.data, paymentsResponseV2.data) &&
        Objects.equals(this.filter, paymentsResponseV2.filter) &&
        Objects.equals(this.sort, paymentsResponseV2.sort) &&
        Objects.equals(this.page, paymentsResponseV2.page);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, filter, sort, page);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentsResponseV2DTO {\n");
