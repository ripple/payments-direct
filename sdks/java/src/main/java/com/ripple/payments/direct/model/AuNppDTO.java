 ...
 */
@JsonPropertyOrder({
  AuNppDTO.JSON_PROPERTY_BANK_NAME,
  AuNppDTO.JSON_PROPERTY_BSB_CODE,
  AuNppDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("au-npp")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class AuNppDTO {
  ...
  public AuNppDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public AuNppDTO bsbCode(@javax.annotation.Nonnull String bsbCode) {
  ...
  @JsonProperty(JSON_PROPERTY_BSB_CODE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBsbCode(@javax.annotation.Nonnull String bsbCode) {
    this.bsbCode = bsbCode;
  }

  public AuNppDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    AuNppDTO auNpp = (AuNppDTO) o;
    return Objects.equals(this.bankName, auNpp.bankName) &&
        Objects.equals(this.bsbCode, auNpp.bsbCode) &&
        Objects.equals(this.accountNumber, auNpp.accountNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, bsbCode, accountNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AuNppDTO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `bsbCode` to the URL query string
    if (getBsbCode() != null) {
      try {
        joiner.add(String.format("%sbsbCode%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBsbCode()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
