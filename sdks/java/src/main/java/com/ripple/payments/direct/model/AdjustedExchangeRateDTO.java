 ...
 */
@JsonPropertyOrder({
  AdjustedExchangeRateDTO.JSON_PROPERTY_ADJUSTED_RATE
})
@JsonTypeName("AdjustedExchangeRate")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class AdjustedExchangeRateDTO {
  public static final String JSON_PROPERTY_ADJUSTED_RATE = "adjustedRate";
  @javax.annotation.Nullable
  private Double adjustedRate;

  public AdjustedExchangeRateDTO() {
  }

  public AdjustedExchangeRateDTO adjustedRate(@javax.annotation.Nullable Double adjustedRate) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_ADJUSTED_RATE)
  ...
  @JsonProperty(JSON_PROPERTY_ADJUSTED_RATE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAdjustedRate(@javax.annotation.Nullable Double adjustedRate) {
    this.adjustedRate = adjustedRate;
  }
  ...
  public boolean equals(Object o) {
    ...
    AdjustedExchangeRateDTO adjustedExchangeRate = (AdjustedExchangeRateDTO) o;
    return Objects.equals(this.adjustedRate, adjustedExchangeRate.adjustedRate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(adjustedRate);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AdjustedExchangeRateDTO {\n");
    sb.append("    adjustedRate: ").append(toIndentedString(adjustedRate)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `adjustedRate` to the URL query string
    if (getAdjustedRate() != null) {
      try {
        joiner.add(String.format("%sadjustedRate%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getAdjustedRate()), "UTF-8").replaceAll("\\+", "%20")));
