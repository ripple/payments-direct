 ...
 */
public enum QuoteAmountTypeDTO {
  ...
  QuoteAmountTypeDTO(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static QuoteAmountTypeDTO fromValue(String value) {
    for (QuoteAmountTypeDTO b : QuoteAmountTypeDTO.values()) {
