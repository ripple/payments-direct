 ...
 */
@JsonPropertyOrder({
  JpZenginDTO.JSON_PROPERTY_BANK_NAME,
  JpZenginDTO.JSON_PROPERTY_ACCOUNT_HOLDER_NAME,
  JpZenginDTO.JSON_PROPERTY_BANK_CODE,
  JpZenginDTO.JSON_PROPERTY_BRANCH_CODE,
  JpZenginDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  JpZenginDTO.JSON_PROPERTY_ACCOUNT_TYPE
})
@JsonTypeName("jp-zengin")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class JpZenginDTO {
  ...
  public JpZenginDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public JpZenginDTO accountHolderName(@javax.annotation.Nonnull String accountHolderName) {
  ...
  public JpZenginDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public JpZenginDTO branchCode(@javax.annotation.Nonnull String branchCode) {
  ...
  @JsonProperty(JSON_PROPERTY_BRANCH_CODE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setBranchCode(@javax.annotation.Nonnull String branchCode) {
    this.branchCode = branchCode;
  }

  public JpZenginDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public JpZenginDTO accountType(@javax.annotation.Nonnull String accountType) {
  ...
  public boolean equals(Object o) {
    ...
    JpZenginDTO jpZengin = (JpZenginDTO) o;
    return Objects.equals(this.bankName, jpZengin.bankName) &&
        Objects.equals(this.accountHolderName, jpZengin.accountHolderName) &&
        Objects.equals(this.bankCode, jpZengin.bankCode) &&
        Objects.equals(this.branchCode, jpZengin.branchCode) &&
        Objects.equals(this.accountNumber, jpZengin.accountNumber) &&
        Objects.equals(this.accountType, jpZengin.accountType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, accountHolderName, bankCode, branchCode, accountNumber, accountType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class JpZenginDTO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getBranchCode() != null) {
      try {
        joiner.add(String.format("%sbranchCode%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getBranchCode()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
