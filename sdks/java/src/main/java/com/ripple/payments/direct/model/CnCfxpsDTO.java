 ...
 */
@JsonPropertyOrder({
  CnCfxpsDTO.JSON_PROPERTY_BANK_NAME,
  CnCfxpsDTO.JSON_PROPERTY_SWIFT_CODE,
  CnCfxpsDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  CnCfxpsDTO.JSON_PROPERTY_ACCOUNT_HOLDER_NAME
})
@JsonTypeName("cn-cfxps")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class CnCfxpsDTO {
  ...
  public CnCfxpsDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public CnCfxpsDTO swiftCode(@javax.annotation.Nonnull String swiftCode) {
  ...
  /**
   * Beneficiary Bank SWIFT/BIC Code. See the China entry in the bank code lookup in the integration resources for the supported list.
   * @return swiftCode
   */
  @javax.annotation.Nonnull
  ...
  public CnCfxpsDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public CnCfxpsDTO accountHolderName(@javax.annotation.Nonnull String accountHolderName) {
  ...
  public boolean equals(Object o) {
    ...
    CnCfxpsDTO cnCfxps = (CnCfxpsDTO) o;
    return Objects.equals(this.bankName, cnCfxps.bankName) &&
        Objects.equals(this.swiftCode, cnCfxps.swiftCode) &&
        Objects.equals(this.accountNumber, cnCfxps.accountNumber) &&
        Objects.equals(this.accountHolderName, cnCfxps.accountHolderName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, swiftCode, accountNumber, accountHolderName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CnCfxpsDTO {\n");
