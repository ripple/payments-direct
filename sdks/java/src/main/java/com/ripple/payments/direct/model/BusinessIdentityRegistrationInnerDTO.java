...
/**
 * BusinessIdentityRegistrationInnerDTO
 */
@JsonPropertyOrder({
  BusinessIdentityRegistrationInnerDTO.JSON_PROPERTY_NUMBER,
  BusinessIdentityRegistrationInnerDTO.JSON_PROPERTY_TYPE
})
@JsonTypeName("business_identity_registration_inner")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BusinessIdentityRegistrationInnerDTO {
  ...
  public BusinessIdentityRegistrationInnerDTO() {
  }

  public BusinessIdentityRegistrationInnerDTO number(@javax.annotation.Nonnull String number) {
  ...
  public BusinessIdentityRegistrationInnerDTO type(@javax.annotation.Nonnull String type) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessIdentityRegistrationInnerDTO businessIdentityRegistrationInner = (BusinessIdentityRegistrationInnerDTO) o;
    return Objects.equals(this.number, businessIdentityRegistrationInner.number) &&
        Objects.equals(this.type, businessIdentityRegistrationInner.type);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessIdentityRegistrationInnerDTO {\n");
