 ...
 */
@JsonPropertyOrder({
  MxSpeiDTO.JSON_PROPERTY_BANK_NAME,
  MxSpeiDTO.JSON_PROPERTY_CLABE
})
@JsonTypeName("mx-spei")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class MxSpeiDTO {
  ...
  public MxSpeiDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public MxSpeiDTO clabe(@javax.annotation.Nonnull String clabe) {
  ...
  @JsonProperty(JSON_PROPERTY_CLABE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setClabe(@javax.annotation.Nonnull String clabe) {
    this.clabe = clabe;
  }
  ...
  public boolean equals(Object o) {
    ...
    MxSpeiDTO mxSpei = (MxSpeiDTO) o;
    return Objects.equals(this.bankName, mxSpei.bankName) &&
        Objects.equals(this.clabe, mxSpei.clabe);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, clabe);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class MxSpeiDTO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getClabe() != null) {
      try {
        joiner.add(String.format("%sclabe%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getClabe()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
