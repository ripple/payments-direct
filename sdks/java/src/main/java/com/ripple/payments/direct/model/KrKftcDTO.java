 ...
 */
@JsonPropertyOrder({
  KrKftcDTO.JSON_PROPERTY_BANK_NAME,
  KrKftcDTO.JSON_PROPERTY_BANK_CODE,
  KrKftcDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("kr-kftc")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class KrKftcDTO {
  ...
  public KrKftcDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public KrKftcDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public KrKftcDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    KrKftcDTO krKftc = (KrKftcDTO) o;
    return Objects.equals(this.bankName, krKftc.bankName) &&
        Objects.equals(this.bankCode, krKftc.bankCode) &&
        Objects.equals(this.accountNumber, krKftc.accountNumber);
  }
