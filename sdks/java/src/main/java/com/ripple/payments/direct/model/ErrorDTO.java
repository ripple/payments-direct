...
@JsonPropertyOrder({
  ...
  ErrorDTO.JSON_PROPERTY_TITLE,
  ErrorDTO.JSON_PROPERTY_TYPE,
  ErrorDTO.JSON_PROPERTY_DESCRIPTION,
  ErrorDTO.JSON_PROPERTY_TIMESTAMP
})
@JsonTypeName("error")
...
public class ErrorDTO {
  ...
  public ErrorDTO code(@javax.annotation.Nonnull String code) {
  ...
  public ErrorDTO title(@javax.annotation.Nonnull String title) {
  ...
  public ErrorDTO type(@javax.annotation.Nonnull String type) {
  ...
  public ErrorDTO description(@javax.annotation.Nonnull String description) {
  ...
  public ErrorDTO timestamp(@javax.annotation.Nonnull OffsetDateTime timestamp) {
