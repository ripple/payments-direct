 ...
 */
@JsonPropertyOrder({
  CnIndividualDTO.JSON_PROPERTY_BANK_NAME,
  CnIndividualDTO.JSON_PROPERTY_BANK_CODE,
  CnIndividualDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("cn-individual")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class CnIndividualDTO {
  ...
  public CnIndividualDTO() {
  }

  public CnIndividualDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public CnIndividualDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public CnIndividualDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    CnIndividualDTO cnIndividual = (CnIndividualDTO) o;
    return Objects.equals(this.bankName, cnIndividual.bankName) &&
        Objects.equals(this.bankCode, cnIndividual.bankCode) &&
        Objects.equals(this.accountNumber, cnIndividual.accountNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class CnIndividualDTO {\n");
