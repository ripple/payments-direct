 ...
 */
@JsonPropertyOrder({
  UsFedwireDTO.JSON_PROPERTY_BANK_NAME,
  UsFedwireDTO.JSON_PROPERTY_BANK_ROUTING_NUMBER,
  UsFedwireDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("us-fedwire")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class UsFedwireDTO {
  ...
  public UsFedwireDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public UsFedwireDTO bankRoutingNumber(@javax.annotation.Nonnull String bankRoutingNumber) {
  ...
  public UsFedwireDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    UsFedwireDTO usFedwire = (UsFedwireDTO) o;
    return Objects.equals(this.bankName, usFedwire.bankName) &&
        Objects.equals(this.bankRoutingNumber, usFedwire.bankRoutingNumber) &&
        Objects.equals(this.accountNumber, usFedwire.accountNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, bankRoutingNumber, accountNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class UsFedwireDTO {\n");
