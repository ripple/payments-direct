 ...
 */
@JsonPropertyOrder({
  CoPseDTO.JSON_PROPERTY_BANK_NAME,
  CoPseDTO.JSON_PROPERTY_BANK_CODE,
  CoPseDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  CoPseDTO.JSON_PROPERTY_ACCOUNT_TYPE
})
@JsonTypeName("co-pse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class CoPseDTO {
  ...
  public CoPseDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public CoPseDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public CoPseDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public CoPseDTO accountType(@javax.annotation.Nonnull String accountType) {
  ...
  public boolean equals(Object o) {
    ...
    CoPseDTO coPse = (CoPseDTO) o;
    return Objects.equals(this.bankName, coPse.bankName) &&
        Objects.equals(this.bankCode, coPse.bankCode) &&
        Objects.equals(this.accountNumber, coPse.accountNumber) &&
        Objects.equals(this.accountType, coPse.accountType);
  }
