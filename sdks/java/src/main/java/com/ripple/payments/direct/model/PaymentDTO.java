...
@JsonPropertyOrder({
  ...
  PaymentDTO.JSON_PROPERTY_JIT_FUNDING_EXPIRES_AT,
  ...
  PaymentDTO.JSON_PROPERTY_TAXES,
  ...
  PaymentDTO.JSON_PROPERTY_PAYMENT_MEMO
})
...
public class PaymentDTO {
  ...
  public PaymentDTO jitFundingExpiresAt(@javax.annotation.Nullable OffsetDateTime jitFundingExpiresAt) {
  ...
  public PaymentDTO taxes(@javax.annotation.Nullable List<TaxSummaryDTO> taxes) {
    
    this.taxes = taxes;
    return this;
  }

  public PaymentDTO addTaxesItem(TaxSummaryDTO taxesItem) {
    if (this.taxes == null) {
  ...
  public PaymentDTO paymentMemo(@javax.annotation.Nullable String paymentMemo) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.paymentId, payment.paymentId) &&
        ...
        Objects.equals(this.jitFundingExpiresAt, payment.jitFundingExpiresAt) &&
        ...
        Objects.equals(this.taxes, payment.taxes) &&
        ...
        Objects.equals(this.paymentMemo, payment.paymentMemo);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentId, cryptoTransactionHash, initiatedAt, expiresAt, jitFundingExpiresAt, lastStateUpdatedAt, paymentState, originator, destination, adjustedExchangeRate, fees, taxes, sourceOfCash, purposeCode, transactionDetails, paymentLabels, paymentMemo);
  }
