 ...
 */
@JsonPropertyOrder({
  CreateFinancialInstrumentResponseDTO.JSON_PROPERTY_FINANCIAL_INSTRUMENT_ID
})
@JsonTypeName("create-financial-instrument-response")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class CreateFinancialInstrumentResponseDTO {
  ...
  public CreateFinancialInstrumentResponseDTO() {
  }

  public CreateFinancialInstrumentResponseDTO financialInstrumentId(@javax.annotation.Nonnull String financialInstrumentId) {
  ...
  public boolean equals(Object o) {
    ...
    CreateFinancialInstrumentResponseDTO createFinancialInstrumentResponse = (CreateFinancialInstrumentResponseDTO) o;
    return Objects.equals(this.financialInstrumentId, createFinancialInstrumentResponse.financialInstrumentId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(financialInstrumentId);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CreateFinancialInstrumentResponseDTO {\n");
