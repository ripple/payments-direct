...
import com.ripple.payments.direct.model.FinancialInstrumentMetadataDTO;
...
/**
 * ListFinancialInstrumentsResponseDTO
 */
@JsonPropertyOrder({
  ListFinancialInstrumentsResponseDTO.JSON_PROPERTY_DATA,
  ListFinancialInstrumentsResponseDTO.JSON_PROPERTY_NEXT_TOKEN
})
@JsonTypeName("list-financial-instruments-response")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class ListFinancialInstrumentsResponseDTO {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<FinancialInstrumentMetadataDTO> data = new ArrayList<>();

  public static final String JSON_PROPERTY_NEXT_TOKEN = "nextToken";
  @javax.annotation.Nullable
  private String nextToken;

  public ListFinancialInstrumentsResponseDTO() {
  }

  public ListFinancialInstrumentsResponseDTO data(@javax.annotation.Nullable List<FinancialInstrumentMetadataDTO> data) {
    
    this.data = data;
    return this;
  }

  public ListFinancialInstrumentsResponseDTO addDataItem(FinancialInstrumentMetadataDTO dataItem) {
    if (this.data == null) {
  ...
  public List<FinancialInstrumentMetadataDTO> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<FinancialInstrumentMetadataDTO> data) {
    this.data = data;
  }

  public ListFinancialInstrumentsResponseDTO nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListFinancialInstrumentsResponseDTO listFinancialInstrumentsResponse = (ListFinancialInstrumentsResponseDTO) o;
    return Objects.equals(this.data, listFinancialInstrumentsResponse.data) &&
        Objects.equals(this.nextToken, listFinancialInstrumentsResponse.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListFinancialInstrumentsResponseDTO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getNextToken() != null) {
      try {
        joiner.add(String.format("%snextToken%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getNextToken()), "UTF-8").replaceAll("\\+", "%20")));
