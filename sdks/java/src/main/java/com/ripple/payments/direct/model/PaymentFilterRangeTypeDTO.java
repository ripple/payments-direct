 ...
 */
public enum PaymentFilterRangeTypeDTO {
  
  PAYMENT_CREATION("PAYMENT_CREATION"),
  
  PAYMENT_EXPIRY("PAYMENT_EXPIRY"),
  
  PAYMENT_STATUS_LAST_UPDATED("PAYMENT_STATUS_LAST_UPDATED");

  private String value;

  PaymentFilterRangeTypeDTO(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PaymentFilterRangeTypeDTO fromValue(String value) {
    for (PaymentFilterRangeTypeDTO b : PaymentFilterRangeTypeDTO.values()) {
