...
import com.ripple.payments.direct.model.IdentityResponseV3DTO;
...
/**
 * ListIdentitiesResponseV3DTO
 */
@JsonPropertyOrder({
  ListIdentitiesResponseV3DTO.JSON_PROPERTY_DATA,
  ListIdentitiesResponseV3DTO.JSON_PROPERTY_NEXT_TOKEN
})
@JsonTypeName("list-identities-response-v3")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class ListIdentitiesResponseV3DTO {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<IdentityResponseV3DTO> data = new ArrayList<>();

  public static final String JSON_PROPERTY_NEXT_TOKEN = "nextToken";
  @javax.annotation.Nullable
  private String nextToken;

  public ListIdentitiesResponseV3DTO() {
  }

  public ListIdentitiesResponseV3DTO data(@javax.annotation.Nullable List<IdentityResponseV3DTO> data) {
    
    this.data = data;
    return this;
  }

  public ListIdentitiesResponseV3DTO addDataItem(IdentityResponseV3DTO dataItem) {
    if (this.data == null) {
  ...
  public List<IdentityResponseV3DTO> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<IdentityResponseV3DTO> data) {
    this.data = data;
  }

  public ListIdentitiesResponseV3DTO nextToken(@javax.annotation.Nullable String nextToken) {
  ...
  public boolean equals(Object o) {
    ...
    ListIdentitiesResponseV3DTO listIdentitiesResponseV3 = (ListIdentitiesResponseV3DTO) o;
    return Objects.equals(this.data, listIdentitiesResponseV3.data) &&
        Objects.equals(this.nextToken, listIdentitiesResponseV3.nextToken);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListIdentitiesResponseV3DTO {\n");
