...
import com.ripple.payments.direct.model.TotalFeeBreakdownV2DTO;
 ...
 */
@JsonPropertyOrder({
  FeeSummaryV2DTO.JSON_PROPERTY_TOTAL_FEE,
  FeeSummaryV2DTO.JSON_PROPERTY_FEE_CURRENCY,
  FeeSummaryV2DTO.JSON_PROPERTY_FEE_BREAKDOWN
})
@JsonTypeName("FeeSummaryV2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class FeeSummaryV2DTO {
  ...
  @javax.annotation.Nullable
  private List<TotalFeeBreakdownV2DTO> feeBreakdown = new ArrayList<>();

  public FeeSummaryV2DTO() {
  }

  public FeeSummaryV2DTO totalFee(@javax.annotation.Nullable Double totalFee) {
  ...
  public FeeSummaryV2DTO feeCurrency(@javax.annotation.Nullable String feeCurrency) {
  ...
  public FeeSummaryV2DTO feeBreakdown(@javax.annotation.Nullable List<TotalFeeBreakdownV2DTO> feeBreakdown) {
    
    this.feeBreakdown = feeBreakdown;
    return this;
  }

  public FeeSummaryV2DTO addFeeBreakdownItem(TotalFeeBreakdownV2DTO feeBreakdownItem) {
  ...
  public List<TotalFeeBreakdownV2DTO> getFeeBreakdown() {
    return feeBreakdown;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FEE_BREAKDOWN)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFeeBreakdown(@javax.annotation.Nullable List<TotalFeeBreakdownV2DTO> feeBreakdown) {
    this.feeBreakdown = feeBreakdown;
  }
  ...
  public boolean equals(Object o) {
    ...
    FeeSummaryV2DTO feeSummaryV2 = (FeeSummaryV2DTO) o;
    return Objects.equals(this.totalFee, feeSummaryV2.totalFee) &&
        Objects.equals(this.feeCurrency, feeSummaryV2.feeCurrency) &&
        Objects.equals(this.feeBreakdown, feeSummaryV2.feeBreakdown);
  }
  ...
  public String toString() {
    ...
    sb.append("class FeeSummaryV2DTO {\n");
