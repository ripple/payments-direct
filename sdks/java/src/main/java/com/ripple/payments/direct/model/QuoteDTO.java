...
public class QuoteDTO {
  ...
  /**
   * Amount to be sent by the originator. The value is rounded to the number of decimal places defined by the ISO 4217 standard for the source currency (for example, 2 for USD/EUR, 0 for JPY/KRW, 3 for BHD/KWD), using HALF_UP rounding mode. 
   * minimum: 1
   * @return sourceAmount
   */
  @javax.annotation.Nullable
  ...
  /**
   * Amount to be received by the beneficiary. The value is rounded to the number of decimal places defined by the ISO 4217 standard for the destination currency (for example, 2 for USD/EUR, 0 for JPY/KRW, 3 for BHD/KWD), using HALF_UP rounding mode. 
   * minimum: 1
  ...
  public QuoteDTO taxes(@javax.annotation.Nullable List<TaxSummaryDTO> taxes) {
    
    this.taxes = taxes;
    return this;
  }

  public QuoteDTO addTaxesItem(TaxSummaryDTO taxesItem) {
    if (this.taxes == null) {
  ...
  public QuoteDTO paymentRail(@javax.annotation.Nullable String paymentRail) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.quoteId, quote.quoteId) &&
        ...
        Objects.equals(this.taxes, quote.taxes) &&
        ...
        Objects.equals(this.paymentRail, quote.paymentRail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(quoteId, quoteStatus, quoteAmountType, sourceAmount, destinationAmount, sourceCurrency, destinationCurrency, sourceCountry, destinationCountry, payoutCategory, payinCategory, adjustedExchangeRate, fees, taxes, createdAt, expiresAt, destinationBlockchainNetwork, paymentRail);
  }
