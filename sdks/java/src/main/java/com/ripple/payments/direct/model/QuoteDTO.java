...
public class QuoteDTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(quoteId, quoteStatus, quoteAmountType, sourceAmount, destinationAmount, sourceCurrency, destinationCurrency, sourceCountry, destinationCountry, payoutCategory, payinCategory, adjustedExchangeRate, fees, taxes, createdAt, expiresAt, destinationBlockchainNetwork);
  }
