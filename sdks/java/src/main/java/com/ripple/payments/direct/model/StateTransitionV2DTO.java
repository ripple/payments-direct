 ...
 */
@JsonPropertyOrder({
  StateTransitionV2DTO.JSON_PROPERTY_UPDATED_FROM,
  StateTransitionV2DTO.JSON_PROPERTY_UPDATED_TO,
  StateTransitionV2DTO.JSON_PROPERTY_UPDATED_AT
})
@JsonTypeName("StateTransitionV2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class StateTransitionV2DTO {
  public static final String JSON_PROPERTY_UPDATED_FROM = "updatedFrom";
  @javax.annotation.Nonnull
  private String updatedFrom;

  public static final String JSON_PROPERTY_UPDATED_TO = "updatedTo";
  @javax.annotation.Nonnull
  ...
  public StateTransitionV2DTO() {
  }

  public StateTransitionV2DTO updatedFrom(@javax.annotation.Nonnull String updatedFrom) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_UPDATED_FROM)
  ...
  @JsonProperty(JSON_PROPERTY_UPDATED_FROM)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setUpdatedFrom(@javax.annotation.Nonnull String updatedFrom) {
    this.updatedFrom = updatedFrom;
  }

  public StateTransitionV2DTO updatedTo(@javax.annotation.Nonnull String updatedTo) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_UPDATED_TO)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(JSON_PROPERTY_UPDATED_TO)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setUpdatedTo(@javax.annotation.Nonnull String updatedTo) {
    this.updatedTo = updatedTo;
  }

  public StateTransitionV2DTO updatedAt(@javax.annotation.Nonnull OffsetDateTime updatedAt) {
  ...
  public boolean equals(Object o) {
    ...
    StateTransitionV2DTO stateTransitionV2 = (StateTransitionV2DTO) o;
    return Objects.equals(this.updatedFrom, stateTransitionV2.updatedFrom) &&
        Objects.equals(this.updatedTo, stateTransitionV2.updatedTo) &&
        Objects.equals(this.updatedAt, stateTransitionV2.updatedAt);
  }

  @Override
  public int hashCode() {
    return Objects.hash(updatedFrom, updatedTo, updatedAt);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class StateTransitionV2DTO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `updatedFrom` to the URL query string
    if (getUpdatedFrom() != null) {
      try {
        joiner.add(String.format("%supdatedFrom%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUpdatedFrom()), "UTF-8").replaceAll("\\+", "%20")));
    ...
    // add `updatedTo` to the URL query string
    if (getUpdatedTo() != null) {
      try {
        joiner.add(String.format("%supdatedTo%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getUpdatedTo()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
