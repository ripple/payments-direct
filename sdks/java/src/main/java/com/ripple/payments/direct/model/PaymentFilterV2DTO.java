 ...
 */
@JsonPropertyOrder({
  PaymentFilterV2DTO.JSON_PROPERTY_PAYMENT_IDS,
  PaymentFilterV2DTO.JSON_PROPERTY_PAYMENT_STATES,
  PaymentFilterV2DTO.JSON_PROPERTY_FILTER_RANGE_TYPE,
  PaymentFilterV2DTO.JSON_PROPERTY_BEFORE_TIMESTAMP,
  PaymentFilterV2DTO.JSON_PROPERTY_AFTER_TIMESTAMP,
  PaymentFilterV2DTO.JSON_PROPERTY_BENEFICIARY_IDENTITY_IDS,
  PaymentFilterV2DTO.JSON_PROPERTY_INTERNAL_ID,
  PaymentFilterV2DTO.JSON_PROPERTY_BENEFICIARY_IDENTITY_NICKNAME,
  PaymentFilterV2DTO.JSON_PROPERTY_DESTINATION_CURRENCIES,
  PaymentFilterV2DTO.JSON_PROPERTY_PAYMENT_LABELS
})
@JsonTypeName("PaymentFilterV2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class PaymentFilterV2DTO {
  ...
  @javax.annotation.Nullable
  private List<String> paymentStates = new ArrayList<>();

  public static final String JSON_PROPERTY_FILTER_RANGE_TYPE = "filterRangeType";
  @javax.annotation.Nullable
  private String filterRangeType;
  ...
  @javax.annotation.Nullable
  private List<String> beneficiaryIdentityIds = new ArrayList<>();
  ...
  public PaymentFilterV2DTO() {
  }

  public PaymentFilterV2DTO paymentIds(@javax.annotation.Nullable List<UUID> paymentIds) {
    
    this.paymentIds = paymentIds;
    return this;
  }

  public PaymentFilterV2DTO addPaymentIdsItem(UUID paymentIdsItem) {
  ...
  public PaymentFilterV2DTO paymentStates(@javax.annotation.Nullable List<String> paymentStates) {
    
    this.paymentStates = paymentStates;
    return this;
  }

  public PaymentFilterV2DTO addPaymentStatesItem(String paymentStatesItem) {
  ...
  public List<String> getPaymentStates() {
    return paymentStates;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYMENT_STATES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPaymentStates(@javax.annotation.Nullable List<String> paymentStates) {
    this.paymentStates = paymentStates;
  }

  public PaymentFilterV2DTO filterRangeType(@javax.annotation.Nullable String filterRangeType) {
  ...
  public String getFilterRangeType() {
    return filterRangeType;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FILTER_RANGE_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilterRangeType(@javax.annotation.Nullable String filterRangeType) {
    this.filterRangeType = filterRangeType;
  }

  public PaymentFilterV2DTO beforeTimestamp(@javax.annotation.Nullable OffsetDateTime beforeTimestamp) {
  ...
  public PaymentFilterV2DTO afterTimestamp(@javax.annotation.Nullable OffsetDateTime afterTimestamp) {
  ...
  public PaymentFilterV2DTO beneficiaryIdentityIds(@javax.annotation.Nullable List<String> beneficiaryIdentityIds) {
    
    this.beneficiaryIdentityIds = beneficiaryIdentityIds;
    return this;
  }

  public PaymentFilterV2DTO addBeneficiaryIdentityIdsItem(String beneficiaryIdentityIdsItem) {
  ...
  public List<String> getBeneficiaryIdentityIds() {
    return beneficiaryIdentityIds;
  }
  ...
  @JsonProperty(JSON_PROPERTY_BENEFICIARY_IDENTITY_IDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBeneficiaryIdentityIds(@javax.annotation.Nullable List<String> beneficiaryIdentityIds) {
    this.beneficiaryIdentityIds = beneficiaryIdentityIds;
  }

  public PaymentFilterV2DTO internalId(@javax.annotation.Nullable String internalId) {
  ...
  public PaymentFilterV2DTO beneficiaryIdentityNickname(@javax.annotation.Nullable String beneficiaryIdentityNickname) {
  ...
  public PaymentFilterV2DTO destinationCurrencies(@javax.annotation.Nullable List<String> destinationCurrencies) {
    
    this.destinationCurrencies = destinationCurrencies;
    return this;
  }

  public PaymentFilterV2DTO addDestinationCurrenciesItem(String destinationCurrenciesItem) {
  ...
  public PaymentFilterV2DTO paymentLabels(@javax.annotation.Nullable List<String> paymentLabels) {
    
    this.paymentLabels = paymentLabels;
    return this;
  }

  public PaymentFilterV2DTO addPaymentLabelsItem(String paymentLabelsItem) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentFilterV2DTO paymentFilterV2 = (PaymentFilterV2DTO) o;
    return Objects.equals(this.paymentIds, paymentFilterV2.paymentIds) &&
        Objects.equals(this.paymentStates, paymentFilterV2.paymentStates) &&
        Objects.equals(this.filterRangeType, paymentFilterV2.filterRangeType) &&
        Objects.equals(this.beforeTimestamp, paymentFilterV2.beforeTimestamp) &&
        Objects.equals(this.afterTimestamp, paymentFilterV2.afterTimestamp) &&
        Objects.equals(this.beneficiaryIdentityIds, paymentFilterV2.beneficiaryIdentityIds) &&
        Objects.equals(this.internalId, paymentFilterV2.internalId) &&
        Objects.equals(this.beneficiaryIdentityNickname, paymentFilterV2.beneficiaryIdentityNickname) &&
        Objects.equals(this.destinationCurrencies, paymentFilterV2.destinationCurrencies) &&
        Objects.equals(this.paymentLabels, paymentFilterV2.paymentLabels);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentFilterV2DTO {\n");
