...
import com.ripple.payments.direct.model.PayoutExecutionDetailsDTO;
 ...
 */
@JsonPropertyOrder({
  PaymentWithDetailsV2DTO.JSON_PROPERTY_PAYMENT_ID,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_CRYPTO_TRANSACTION_HASH,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_INITIATED_AT,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_EXPIRES_AT,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_JIT_FUNDING_EXPIRES_AT,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_LAST_STATE_UPDATED_AT,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_PAYMENT_STATE,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_ORIGINATOR,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_DESTINATION,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_ADJUSTED_EXCHANGE_RATE,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_FEES,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_TAXES,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_SOURCE_OF_CASH,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_PURPOSE_CODE,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_TRANSACTION_DETAILS,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_ERRORS,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_PAYMENT_LABELS,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_RECEIVER_RELATIONSHIP,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_PAYMENT_MEMO,
  PaymentWithDetailsV2DTO.JSON_PROPERTY_PAYOUT_EXECUTION_DETAILS
})
@JsonTypeName("PaymentWithDetailsV2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class PaymentWithDetailsV2DTO {
  ...
  public static final String JSON_PROPERTY_PAYOUT_EXECUTION_DETAILS = "payoutExecutionDetails";
  @javax.annotation.Nullable
  private PayoutExecutionDetailsDTO payoutExecutionDetails;

  public PaymentWithDetailsV2DTO() {
  }

  public PaymentWithDetailsV2DTO paymentId(@javax.annotation.Nonnull UUID paymentId) {
  ...
  public PaymentWithDetailsV2DTO cryptoTransactionHash(@javax.annotation.Nullable String cryptoTransactionHash) {
  ...
  public PaymentWithDetailsV2DTO initiatedAt(@javax.annotation.Nullable OffsetDateTime initiatedAt) {
  ...
  public PaymentWithDetailsV2DTO expiresAt(@javax.annotation.Nullable OffsetDateTime expiresAt) {
  ...
  public PaymentWithDetailsV2DTO jitFundingExpiresAt(@javax.annotation.Nullable OffsetDateTime jitFundingExpiresAt) {
  ...
  public PaymentWithDetailsV2DTO lastStateUpdatedAt(@javax.annotation.Nullable OffsetDateTime lastStateUpdatedAt) {
  ...
  public PaymentWithDetailsV2DTO paymentState(@javax.annotation.Nonnull String paymentState) {
  ...
  public PaymentWithDetailsV2DTO originator(@javax.annotation.Nullable OriginatorV2DTO originator) {
  ...
  public PaymentWithDetailsV2DTO destination(@javax.annotation.Nullable DestinationV2DTO destination) {
  ...
  public PaymentWithDetailsV2DTO adjustedExchangeRate(@javax.annotation.Nullable AdjustedExchangeRateDTO adjustedExchangeRate) {
  ...
  public PaymentWithDetailsV2DTO fees(@javax.annotation.Nullable List<FeeSummaryDTO> fees) {
    
    this.fees = fees;
    return this;
  }

  public PaymentWithDetailsV2DTO addFeesItem(FeeSummaryDTO feesItem) {
    if (this.fees == null) {
  ...
  public PaymentWithDetailsV2DTO taxes(@javax.annotation.Nullable List<TaxSummaryDTO> taxes) {
    
    this.taxes = taxes;
    return this;
  }

  public PaymentWithDetailsV2DTO addTaxesItem(TaxSummaryDTO taxesItem) {
    if (this.taxes == null) {
  ...
  public PaymentWithDetailsV2DTO sourceOfCash(@javax.annotation.Nullable String sourceOfCash) {
  ...
  public PaymentWithDetailsV2DTO purposeCode(@javax.annotation.Nullable String purposeCode) {
  ...
  public PaymentWithDetailsV2DTO transactionDetails(@javax.annotation.Nullable TransactionDetailsV2DTO transactionDetails) {
  ...
  public PaymentWithDetailsV2DTO errors(@javax.annotation.Nullable List<PaymentErrorDTO> errors) {
    
    this.errors = errors;
    return this;
  }

  public PaymentWithDetailsV2DTO addErrorsItem(PaymentErrorDTO errorsItem) {
    if (this.errors == null) {
  ...
  public PaymentWithDetailsV2DTO paymentLabels(@javax.annotation.Nullable List<String> paymentLabels) {
    
    this.paymentLabels = paymentLabels;
    return this;
  }

  public PaymentWithDetailsV2DTO addPaymentLabelsItem(String paymentLabelsItem) {
  ...
  public PaymentWithDetailsV2DTO receiverRelationship(@javax.annotation.Nullable String receiverRelationship) {
  ...
  public PaymentWithDetailsV2DTO paymentMemo(@javax.annotation.Nullable String paymentMemo) {
  ...
  public PaymentWithDetailsV2DTO payoutExecutionDetails(@javax.annotation.Nullable PayoutExecutionDetailsDTO payoutExecutionDetails) {
    
    this.payoutExecutionDetails = payoutExecutionDetails;
    return this;
  }

  /**
   * Get payoutExecutionDetails
   * @return payoutExecutionDetails
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_PAYOUT_EXECUTION_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)

  public PayoutExecutionDetailsDTO getPayoutExecutionDetails() {
    return payoutExecutionDetails;
  }
  ...
  @JsonProperty(JSON_PROPERTY_PAYOUT_EXECUTION_DETAILS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPayoutExecutionDetails(@javax.annotation.Nullable PayoutExecutionDetailsDTO payoutExecutionDetails) {
    this.payoutExecutionDetails = payoutExecutionDetails;
  }
  ...
  public boolean equals(Object o) {
    ...
    PaymentWithDetailsV2DTO paymentWithDetailsV2 = (PaymentWithDetailsV2DTO) o;
    return Objects.equals(this.paymentId, paymentWithDetailsV2.paymentId) &&
        Objects.equals(this.cryptoTransactionHash, paymentWithDetailsV2.cryptoTransactionHash) &&
        Objects.equals(this.initiatedAt, paymentWithDetailsV2.initiatedAt) &&
        Objects.equals(this.expiresAt, paymentWithDetailsV2.expiresAt) &&
        Objects.equals(this.jitFundingExpiresAt, paymentWithDetailsV2.jitFundingExpiresAt) &&
        Objects.equals(this.lastStateUpdatedAt, paymentWithDetailsV2.lastStateUpdatedAt) &&
        Objects.equals(this.paymentState, paymentWithDetailsV2.paymentState) &&
        Objects.equals(this.originator, paymentWithDetailsV2.originator) &&
        Objects.equals(this.destination, paymentWithDetailsV2.destination) &&
        Objects.equals(this.adjustedExchangeRate, paymentWithDetailsV2.adjustedExchangeRate) &&
        Objects.equals(this.fees, paymentWithDetailsV2.fees) &&
        Objects.equals(this.taxes, paymentWithDetailsV2.taxes) &&
        Objects.equals(this.sourceOfCash, paymentWithDetailsV2.sourceOfCash) &&
        Objects.equals(this.purposeCode, paymentWithDetailsV2.purposeCode) &&
        Objects.equals(this.transactionDetails, paymentWithDetailsV2.transactionDetails) &&
        Objects.equals(this.errors, paymentWithDetailsV2.errors) &&
        Objects.equals(this.paymentLabels, paymentWithDetailsV2.paymentLabels) &&
        Objects.equals(this.receiverRelationship, paymentWithDetailsV2.receiverRelationship) &&
        Objects.equals(this.paymentMemo, paymentWithDetailsV2.paymentMemo) &&
        Objects.equals(this.payoutExecutionDetails, paymentWithDetailsV2.payoutExecutionDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentId, cryptoTransactionHash, initiatedAt, expiresAt, jitFundingExpiresAt, lastStateUpdatedAt, paymentState, originator, destination, adjustedExchangeRate, fees, taxes, sourceOfCash, purposeCode, transactionDetails, errors, paymentLabels, receiverRelationship, paymentMemo, payoutExecutionDetails);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PaymentWithDetailsV2DTO {\n");
    ...
    sb.append("    payoutExecutionDetails: ").append(toIndentedString(payoutExecutionDetails)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `payoutExecutionDetails` to the URL query string
    if (getPayoutExecutionDetails() != null) {
      joiner.add(getPayoutExecutionDetails().toUrlQueryString(prefix + "payoutExecutionDetails" + suffix));
    }
