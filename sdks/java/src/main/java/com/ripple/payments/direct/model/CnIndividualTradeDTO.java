 ...
 */
@JsonPropertyOrder({
  CnIndividualTradeDTO.JSON_PROPERTY_BANK_NAME,
  CnIndividualTradeDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  CnIndividualTradeDTO.JSON_PROPERTY_ACCOUNT_HOLDER_NAME
})
@JsonTypeName("cn-individual-trade")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class CnIndividualTradeDTO {
  ...
  public CnIndividualTradeDTO() {
  }

  public CnIndividualTradeDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public CnIndividualTradeDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public CnIndividualTradeDTO accountHolderName(@javax.annotation.Nonnull String accountHolderName) {
  ...
  public boolean equals(Object o) {
    ...
    CnIndividualTradeDTO cnIndividualTrade = (CnIndividualTradeDTO) o;
    return Objects.equals(this.bankName, cnIndividualTrade.bankName) &&
        Objects.equals(this.accountNumber, cnIndividualTrade.accountNumber) &&
        Objects.equals(this.accountHolderName, cnIndividualTrade.accountHolderName);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, accountNumber, accountHolderName);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CnIndividualTradeDTO {\n");
