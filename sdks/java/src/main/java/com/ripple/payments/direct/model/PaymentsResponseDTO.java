...
import com.ripple.payments.direct.model.PaymentFilterDTO;
import com.ripple.payments.direct.model.SortDTO;
 ...
 */
@JsonPropertyOrder({
  PaymentsResponseDTO.JSON_PROPERTY_DATA,
  PaymentsResponseDTO.JSON_PROPERTY_FILTER,
  PaymentsResponseDTO.JSON_PROPERTY_SORT,
  PaymentsResponseDTO.JSON_PROPERTY_PAGE
})
@JsonTypeName("PaymentsResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class PaymentsResponseDTO {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<PaymentDTO> data = new ArrayList<>();

  public static final String JSON_PROPERTY_FILTER = "filter";
  @javax.annotation.Nullable
  private PaymentFilterDTO filter;
  ...
  public PaymentsResponseDTO data(@javax.annotation.Nullable List<PaymentDTO> data) {
    
    this.data = data;
    return this;
  }

  public PaymentsResponseDTO addDataItem(PaymentDTO dataItem) {
    if (this.data == null) {
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<PaymentDTO> data) {
    this.data = data;
  }

  public PaymentsResponseDTO filter(@javax.annotation.Nullable PaymentFilterDTO filter) {
  ...
  public PaymentFilterDTO getFilter() {
    return filter;
  }
  ...
  @JsonProperty(JSON_PROPERTY_FILTER)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFilter(@javax.annotation.Nullable PaymentFilterDTO filter) {
    this.filter = filter;
  }

  public PaymentsResponseDTO sort(@javax.annotation.Nullable SortDTO sort) {
  ...
  @JsonProperty(JSON_PROPERTY_SORT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSort(@javax.annotation.Nullable SortDTO sort) {
    this.sort = sort;
  }

  public PaymentsResponseDTO page(@javax.annotation.Nullable PageDTO page) {
  ...
  public boolean equals(Object o) {
    ...
    PaymentsResponseDTO paymentsResponse = (PaymentsResponseDTO) o;
    return Objects.equals(this.data, paymentsResponse.data) &&
        Objects.equals(this.filter, paymentsResponse.filter) &&
        Objects.equals(this.sort, paymentsResponse.sort) &&
        Objects.equals(this.page, paymentsResponse.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentsResponseDTO {\n");
