 ...
 */
@JsonPropertyOrder({
  AfricaBankPayoutDTO.JSON_PROPERTY_BANK_NAME,
  AfricaBankPayoutDTO.JSON_PROPERTY_BANK_CODE,
  AfricaBankPayoutDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  AfricaBankPayoutDTO.JSON_PROPERTY_COUNTRY
})
@JsonTypeName("africa-bank-payout")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class AfricaBankPayoutDTO {
  ...
  public AfricaBankPayoutDTO() {
  }

  public AfricaBankPayoutDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public AfricaBankPayoutDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public AfricaBankPayoutDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public AfricaBankPayoutDTO country(@javax.annotation.Nonnull String country) {
  ...
  public boolean equals(Object o) {
    ...
    AfricaBankPayoutDTO africaBankPayout = (AfricaBankPayoutDTO) o;
    return Objects.equals(this.bankName, africaBankPayout.bankName) &&
        Objects.equals(this.bankCode, africaBankPayout.bankCode) &&
        Objects.equals(this.accountNumber, africaBankPayout.accountNumber) &&
        Objects.equals(this.country, africaBankPayout.country);
  }
  ...
  public String toString() {
    ...
    sb.append("class AfricaBankPayoutDTO {\n");
