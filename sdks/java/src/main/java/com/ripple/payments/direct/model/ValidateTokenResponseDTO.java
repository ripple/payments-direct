 ...
 */
@JsonPropertyOrder({
  ValidateTokenResponseDTO.JSON_PROPERTY_MESSAGE,
  ValidateTokenResponseDTO.JSON_PROPERTY_SECONDS_TO_EXPIRY
})
...
public class ValidateTokenResponseDTO {
  ...
  public static final String JSON_PROPERTY_SECONDS_TO_EXPIRY = "seconds_to_expiry";
  @javax.annotation.Nullable
  ...
  public ValidateTokenResponseDTO message(@javax.annotation.Nullable String message) {
  ...
  public ValidateTokenResponseDTO secondsToExpiry(@javax.annotation.Nullable Long secondsToExpiry) {
   ...
   */
  @javax.annotation.Nullable
  @JsonProperty(JSON_PROPERTY_SECONDS_TO_EXPIRY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  ...
  @JsonProperty(JSON_PROPERTY_SECONDS_TO_EXPIRY)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSecondsToExpiry(@javax.annotation.Nullable Long secondsToExpiry) {
    this.secondsToExpiry = secondsToExpiry;
  }
  ...
  public boolean equals(Object o) {
    ...
    ValidateTokenResponseDTO validateTokenResponse = (ValidateTokenResponseDTO) o;
    return Objects.equals(this.message, validateTokenResponse.message) &&
        Objects.equals(this.secondsToExpiry, validateTokenResponse.secondsToExpiry);
  }

  @Override
  public int hashCode() {
    return Objects.hash(message, secondsToExpiry);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ValidateTokenResponseDTO {\n");
    sb.append("    message: ").append(toIndentedString(message)).append("\n");
    sb.append("    secondsToExpiry: ").append(toIndentedString(secondsToExpiry)).append("\n");
    sb.append("}");
    return sb.toString();
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `seconds_to_expiry` to the URL query string
    if (getSecondsToExpiry() != null) {
      try {
        joiner.add(String.format("%sseconds_to_expiry%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getSecondsToExpiry()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
