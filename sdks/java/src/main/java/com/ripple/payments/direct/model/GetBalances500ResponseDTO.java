 ...
 */
@JsonPropertyOrder({
  GetBalances500ResponseDTO.JSON_PROPERTY_STATUS,
  GetBalances500ResponseDTO.JSON_PROPERTY_ERRORS
})
@JsonTypeName("getBalances_500_response")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class GetBalances500ResponseDTO {
  ...
  public GetBalances500ResponseDTO() {
  }

  public GetBalances500ResponseDTO status(@javax.annotation.Nonnull Integer status) {
  ...
  public GetBalances500ResponseDTO errors(@javax.annotation.Nonnull List<GetBalances400ResponseErrorsInnerDTO> errors) {
    
    this.errors = errors;
    return this;
  }

  public GetBalances500ResponseDTO addErrorsItem(GetBalances400ResponseErrorsInnerDTO errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetBalances500ResponseDTO getBalances500Response = (GetBalances500ResponseDTO) o;
    return Objects.equals(this.status, getBalances500Response.status) &&
        Objects.equals(this.errors, getBalances500Response.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBalances500ResponseDTO {\n");
