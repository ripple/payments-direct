 ...
 */
@JsonPropertyOrder({
  IdentityV2DTO.JSON_PROPERTY_IDENTITY_ID,
  IdentityV2DTO.JSON_PROPERTY_NICK_NAME,
  IdentityV2DTO.JSON_PROPERTY_CREATED_AT,
  IdentityV2DTO.JSON_PROPERTY_IDENTITY_TYPE,
  IdentityV2DTO.JSON_PROPERTY_USE_CASE_TYPE
})
@JsonTypeName("identity-v2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class IdentityV2DTO {
  ...
  public IdentityV2DTO() {
  }

  public IdentityV2DTO identityId(@javax.annotation.Nonnull String identityId) {
  ...
  public IdentityV2DTO nickName(@javax.annotation.Nonnull String nickName) {
  ...
  public IdentityV2DTO createdAt(@javax.annotation.Nonnull OffsetDateTime createdAt) {
  ...
  public IdentityV2DTO identityType(@javax.annotation.Nonnull IdentityTypeV2DTO identityType) {
  ...
  public IdentityV2DTO useCaseType(@javax.annotation.Nonnull UseCaseTypeDTO useCaseType) {
  ...
  public boolean equals(Object o) {
    ...
    IdentityV2DTO identityV2 = (IdentityV2DTO) o;
    return Objects.equals(this.identityId, identityV2.identityId) &&
        Objects.equals(this.nickName, identityV2.nickName) &&
        Objects.equals(this.createdAt, identityV2.createdAt) &&
        Objects.equals(this.identityType, identityV2.identityType) &&
        Objects.equals(this.useCaseType, identityV2.useCaseType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(identityId, nickName, createdAt, identityType, useCaseType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class IdentityV2DTO {\n");
