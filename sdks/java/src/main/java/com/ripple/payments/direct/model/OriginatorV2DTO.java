 ...
 */
@JsonPropertyOrder({
  OriginatorV2DTO.JSON_PROPERTY_ORIGINATOR_IDENTITY_ID,
  OriginatorV2DTO.JSON_PROPERTY_ORIGINATOR_IDENTITY_ID_VERSION,
  OriginatorV2DTO.JSON_PROPERTY_ORIGINATOR_IDENTITY_NICK_NAME,
  OriginatorV2DTO.JSON_PROPERTY_INTERNAL_ID,
  OriginatorV2DTO.JSON_PROPERTY_SOURCE_CURRENCY,
  OriginatorV2DTO.JSON_PROPERTY_SOURCE_AMOUNT,
  OriginatorV2DTO.JSON_PROPERTY_PAYIN
})
@JsonTypeName("OriginatorV2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class OriginatorV2DTO {
  ...
  public OriginatorV2DTO() {
  }

  public OriginatorV2DTO originatorIdentityId(@javax.annotation.Nullable String originatorIdentityId) {
  ...
  public OriginatorV2DTO originatorIdentityIdVersion(@javax.annotation.Nullable Integer originatorIdentityIdVersion) {
  ...
  public OriginatorV2DTO originatorIdentityNickName(@javax.annotation.Nullable String originatorIdentityNickName) {
  ...
  public OriginatorV2DTO internalId(@javax.annotation.Nullable String internalId) {
  ...
  public OriginatorV2DTO sourceCurrency(@javax.annotation.Nullable String sourceCurrency) {
  ...
  public OriginatorV2DTO sourceAmount(@javax.annotation.Nullable Double sourceAmount) {
  ...
  public OriginatorV2DTO payin(@javax.annotation.Nullable String payin) {
  ...
  public boolean equals(Object o) {
    ...
    OriginatorV2DTO originatorV2 = (OriginatorV2DTO) o;
    return Objects.equals(this.originatorIdentityId, originatorV2.originatorIdentityId) &&
        Objects.equals(this.originatorIdentityIdVersion, originatorV2.originatorIdentityIdVersion) &&
        Objects.equals(this.originatorIdentityNickName, originatorV2.originatorIdentityNickName) &&
        Objects.equals(this.internalId, originatorV2.internalId) &&
        Objects.equals(this.sourceCurrency, originatorV2.sourceCurrency) &&
        Objects.equals(this.sourceAmount, originatorV2.sourceAmount) &&
        Objects.equals(this.payin, originatorV2.payin);
  }
  ...
  public String toString() {
    ...
    sb.append("class OriginatorV2DTO {\n");
