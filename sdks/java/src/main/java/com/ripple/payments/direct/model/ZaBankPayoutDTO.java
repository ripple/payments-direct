 ...
 */
@JsonPropertyOrder({
  ZaBankPayoutDTO.JSON_PROPERTY_BANK_NAME,
  ZaBankPayoutDTO.JSON_PROPERTY_BANK_CODE,
  ZaBankPayoutDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("za-bank-payout")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class ZaBankPayoutDTO {
  ...
  public ZaBankPayoutDTO() {
  }

  public ZaBankPayoutDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public ZaBankPayoutDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public ZaBankPayoutDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    ZaBankPayoutDTO zaBankPayout = (ZaBankPayoutDTO) o;
    return Objects.equals(this.bankName, zaBankPayout.bankName) &&
        Objects.equals(this.bankCode, zaBankPayout.bankCode) &&
        Objects.equals(this.accountNumber, zaBankPayout.accountNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class ZaBankPayoutDTO {\n");
