 ...
 */
@JsonPropertyOrder({
  ThPromptpayDTO.JSON_PROPERTY_BANK_NAME,
  ThPromptpayDTO.JSON_PROPERTY_BANK_CODE,
  ThPromptpayDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("th-promptpay")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class ThPromptpayDTO {
  ...
  public ThPromptpayDTO() {
  }

  public ThPromptpayDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public ThPromptpayDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public ThPromptpayDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    ThPromptpayDTO thPromptpay = (ThPromptpayDTO) o;
    return Objects.equals(this.bankName, thPromptpay.bankName) &&
        Objects.equals(this.bankCode, thPromptpay.bankCode) &&
        Objects.equals(this.accountNumber, thPromptpay.accountNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, bankCode, accountNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ThPromptpayDTO {\n");
