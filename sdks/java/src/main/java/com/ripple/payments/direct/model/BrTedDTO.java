 ...
 */
@JsonPropertyOrder({
  BrTedDTO.JSON_PROPERTY_BANK_NAME,
  BrTedDTO.JSON_PROPERTY_BANK_CODE,
  BrTedDTO.JSON_PROPERTY_BRANCH_NUMBER,
  BrTedDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  BrTedDTO.JSON_PROPERTY_ACCOUNT_TYPE
})
@JsonTypeName("br-ted")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BrTedDTO {
  ...
  public BrTedDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public BrTedDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public BrTedDTO branchNumber(@javax.annotation.Nonnull String branchNumber) {
  ...
  public BrTedDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public BrTedDTO accountType(@javax.annotation.Nonnull String accountType) {
  ...
  /**
   * The identity&#39;s account type (Savings, Checking etc.):     * CHECKING: Checking account     * SAVINGS: Savings account 
   * @return accountType
   */
  @javax.annotation.Nonnull
  ...
  public boolean equals(Object o) {
    ...
    BrTedDTO brTed = (BrTedDTO) o;
    return Objects.equals(this.bankName, brTed.bankName) &&
        Objects.equals(this.bankCode, brTed.bankCode) &&
        Objects.equals(this.branchNumber, brTed.branchNumber) &&
        Objects.equals(this.accountNumber, brTed.accountNumber) &&
        Objects.equals(this.accountType, brTed.accountType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, bankCode, branchNumber, accountNumber, accountType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BrTedDTO {\n");
