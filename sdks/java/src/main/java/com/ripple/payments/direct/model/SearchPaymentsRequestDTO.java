 ...
 */
@JsonPropertyOrder({
  SearchPaymentsRequestDTO.JSON_PROPERTY_FILTER,
  SearchPaymentsRequestDTO.JSON_PROPERTY_SORT,
  SearchPaymentsRequestDTO.JSON_PROPERTY_PAGE
})
@JsonTypeName("SearchPaymentsRequest")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class SearchPaymentsRequestDTO {
  ...
  public SearchPaymentsRequestDTO() {
  }

  public SearchPaymentsRequestDTO filter(@javax.annotation.Nullable PaymentFilterDTO filter) {
  ...
  public SearchPaymentsRequestDTO sort(@javax.annotation.Nullable SortDTO sort) {
  ...
  public SearchPaymentsRequestDTO page(@javax.annotation.Nullable PageDTO page) {
  ...
  public boolean equals(Object o) {
    ...
    SearchPaymentsRequestDTO searchPaymentsRequest = (SearchPaymentsRequestDTO) o;
    return Objects.equals(this.filter, searchPaymentsRequest.filter) &&
        Objects.equals(this.sort, searchPaymentsRequest.sort) &&
        Objects.equals(this.page, searchPaymentsRequest.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchPaymentsRequestDTO {\n");
