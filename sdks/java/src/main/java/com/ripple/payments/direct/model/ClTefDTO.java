 ...
 */
@JsonPropertyOrder({
  ClTefDTO.JSON_PROPERTY_BANK_NAME,
  ClTefDTO.JSON_PROPERTY_SWIFT_CODE,
  ClTefDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  ClTefDTO.JSON_PROPERTY_ACCOUNT_TYPE
})
@JsonTypeName("cl-tef")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class ClTefDTO {
  ...
  public ClTefDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public ClTefDTO swiftCode(@javax.annotation.Nonnull String swiftCode) {
  ...
  public ClTefDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public ClTefDTO accountType(@javax.annotation.Nonnull String accountType) {
  ...
  public boolean equals(Object o) {
    ...
    ClTefDTO clTef = (ClTefDTO) o;
    return Objects.equals(this.bankName, clTef.bankName) &&
        Objects.equals(this.swiftCode, clTef.swiftCode) &&
        Objects.equals(this.accountNumber, clTef.accountNumber) &&
        Objects.equals(this.accountType, clTef.accountType);
  }
