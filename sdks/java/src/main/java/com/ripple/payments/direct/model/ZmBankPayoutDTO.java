 ...
 */
@JsonPropertyOrder({
  ZmBankPayoutDTO.JSON_PROPERTY_BANK_NAME,
  ZmBankPayoutDTO.JSON_PROPERTY_BANK_CODE,
  ZmBankPayoutDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("zm-bank-payout")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class ZmBankPayoutDTO {
  ...
  public ZmBankPayoutDTO() {
  }

  public ZmBankPayoutDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public ZmBankPayoutDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public ZmBankPayoutDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    ZmBankPayoutDTO zmBankPayout = (ZmBankPayoutDTO) o;
    return Objects.equals(this.bankName, zmBankPayout.bankName) &&
        Objects.equals(this.bankCode, zmBankPayout.bankCode) &&
        Objects.equals(this.accountNumber, zmBankPayout.accountNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class ZmBankPayoutDTO {\n");
