 ...
 */
@JsonPropertyOrder({
  GetBalances401ResponseDTO.JSON_PROPERTY_STATUS,
  GetBalances401ResponseDTO.JSON_PROPERTY_ERRORS
})
@JsonTypeName("getBalances_401_response")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class GetBalances401ResponseDTO {
  ...
  public GetBalances401ResponseDTO() {
  }

  public GetBalances401ResponseDTO status(@javax.annotation.Nonnull Integer status) {
  ...
  public GetBalances401ResponseDTO errors(@javax.annotation.Nonnull List<GetBalances400ResponseErrorsInnerDTO> errors) {
    
    this.errors = errors;
    return this;
  }

  public GetBalances401ResponseDTO addErrorsItem(GetBalances400ResponseErrorsInnerDTO errorsItem) {
    if (this.errors == null) {
  ...
  public boolean equals(Object o) {
    ...
    GetBalances401ResponseDTO getBalances401Response = (GetBalances401ResponseDTO) o;
    return Objects.equals(this.status, getBalances401Response.status) &&
        Objects.equals(this.errors, getBalances401Response.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetBalances401ResponseDTO {\n");
