 ...
 */
@JsonPropertyOrder({
  UgBankPayoutDTO.JSON_PROPERTY_BANK_NAME,
  UgBankPayoutDTO.JSON_PROPERTY_BANK_CODE,
  UgBankPayoutDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("ug-bank-payout")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class UgBankPayoutDTO {
  ...
  public UgBankPayoutDTO() {
  }

  public UgBankPayoutDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public UgBankPayoutDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public UgBankPayoutDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    UgBankPayoutDTO ugBankPayout = (UgBankPayoutDTO) o;
    return Objects.equals(this.bankName, ugBankPayout.bankName) &&
        Objects.equals(this.bankCode, ugBankPayout.bankCode) &&
        Objects.equals(this.accountNumber, ugBankPayout.accountNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class UgBankPayoutDTO {\n");
