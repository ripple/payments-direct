...
public class RippleFinancialInstrumentDTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(usAch, usFedwire, mxSpei, euSepa, gbFps, ngBankPayout, ghBankPayout, rwBankPayout, zaBankPayout, ugBankPayout, zmBankPayout, ethWallet, tronWallet, solWallet, brPix, coPse, brTed, caEft, hkBankPayout, cnTrade, cnIndividual, cnIndividualTrade, cnCfxps, currency, label, financialInstrumentType);
  }
