 ...
 */
@JsonPropertyOrder({
  RippleFinancialInstrumentDTO.JSON_PROPERTY_US_ACH,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_US_FEDWIRE,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_MX_SPEI,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_EU_SEPA,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_GB_FPS,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_NG_BANK_PAYOUT,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_GH_BANK_PAYOUT,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_RW_BANK_PAYOUT,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_ZA_BANK_PAYOUT,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_UG_BANK_PAYOUT,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_ZM_BANK_PAYOUT,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_ETH_WALLET,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_TRON_WALLET,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_SOL_WALLET,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_BR_PIX,
  ...
  RippleFinancialInstrumentDTO.JSON_PROPERTY_CN_TRADE,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_CN_INDIVIDUAL,
  RippleFinancialInstrumentDTO.JSON_PROPERTY_CN_INDIVIDUAL_TRADE,
  ...
  RippleFinancialInstrumentDTO.JSON_PROPERTY_FINANCIAL_INSTRUMENT_TYPE
})
@JsonTypeName("ripple-financial-instrument")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class RippleFinancialInstrumentDTO {
  ...
  public RippleFinancialInstrumentDTO() {
  }

  public RippleFinancialInstrumentDTO usAch(@javax.annotation.Nullable UsAchDTO usAch) {
  ...
  public RippleFinancialInstrumentDTO usFedwire(@javax.annotation.Nullable UsFedwireDTO usFedwire) {
  ...
  public RippleFinancialInstrumentDTO mxSpei(@javax.annotation.Nullable MxSpeiDTO mxSpei) {
  ...
  public RippleFinancialInstrumentDTO euSepa(@javax.annotation.Nullable EuSepaDTO euSepa) {
  ...
  public RippleFinancialInstrumentDTO gbFps(@javax.annotation.Nullable GbFpsDTO gbFps) {
  ...
  public RippleFinancialInstrumentDTO ngBankPayout(@javax.annotation.Nullable NgBankPayoutDTO ngBankPayout) {
  ...
  public RippleFinancialInstrumentDTO ghBankPayout(@javax.annotation.Nullable GhBankPayoutDTO ghBankPayout) {
  ...
  public RippleFinancialInstrumentDTO rwBankPayout(@javax.annotation.Nullable RwBankPayoutDTO rwBankPayout) {
  ...
  public RippleFinancialInstrumentDTO zaBankPayout(@javax.annotation.Nullable ZaBankPayoutDTO zaBankPayout) {
  ...
  public RippleFinancialInstrumentDTO ugBankPayout(@javax.annotation.Nullable UgBankPayoutDTO ugBankPayout) {
  ...
  public RippleFinancialInstrumentDTO zmBankPayout(@javax.annotation.Nullable ZmBankPayoutDTO zmBankPayout) {
  ...
  public RippleFinancialInstrumentDTO ethWallet(@javax.annotation.Nullable EthWalletDTO ethWallet) {
  ...
  public RippleFinancialInstrumentDTO tronWallet(@javax.annotation.Nullable TronWalletDTO tronWallet) {
  ...
  public RippleFinancialInstrumentDTO solWallet(@javax.annotation.Nullable SolWalletDTO solWallet) {
  ...
  public RippleFinancialInstrumentDTO brPix(@javax.annotation.Nullable BrPixDTO brPix) {
  ...
  public RippleFinancialInstrumentDTO coPse(@javax.annotation.Nullable CoPseDTO coPse) {
  ...
  public RippleFinancialInstrumentDTO brTed(@javax.annotation.Nullable BrTedDTO brTed) {
  ...
  public RippleFinancialInstrumentDTO caEft(@javax.annotation.Nullable CaEftDTO caEft) {
  ...
  public RippleFinancialInstrumentDTO inNeft(@javax.annotation.Nullable InNeftDTO inNeft) {
  ...
  public RippleFinancialInstrumentDTO peLbtr(@javax.annotation.Nullable PeLbtrDTO peLbtr) {
  ...
  public RippleFinancialInstrumentDTO auNpp(@javax.annotation.Nullable AuNppDTO auNpp) {
  ...
  public RippleFinancialInstrumentDTO cnTrade(@javax.annotation.Nullable CnTradeDTO cnTrade) {
  ...
  public RippleFinancialInstrumentDTO cnIndividual(@javax.annotation.Nullable CnIndividualDTO cnIndividual) {
  ...
  public RippleFinancialInstrumentDTO cnIndividualTrade(@javax.annotation.Nullable CnIndividualTradeDTO cnIndividualTrade) {
  ...
  public RippleFinancialInstrumentDTO aeIpi(@javax.annotation.Nullable AeIpiDTO aeIpi) {
  ...
  public RippleFinancialInstrumentDTO currency(@javax.annotation.Nonnull String currency) {
  ...
  public RippleFinancialInstrumentDTO label(@javax.annotation.Nullable String label) {
  ...
  public RippleFinancialInstrumentDTO financialInstrumentType(@javax.annotation.Nonnull String financialInstrumentType) {
  ...
  public boolean equals(Object o) {
    ...
    RippleFinancialInstrumentDTO rippleFinancialInstrument = (RippleFinancialInstrumentDTO) o;
    return Objects.equals(this.usAch, rippleFinancialInstrument.usAch) &&
        Objects.equals(this.usFedwire, rippleFinancialInstrument.usFedwire) &&
        Objects.equals(this.mxSpei, rippleFinancialInstrument.mxSpei) &&
        Objects.equals(this.euSepa, rippleFinancialInstrument.euSepa) &&
        Objects.equals(this.gbFps, rippleFinancialInstrument.gbFps) &&
        Objects.equals(this.ngBankPayout, rippleFinancialInstrument.ngBankPayout) &&
        Objects.equals(this.ghBankPayout, rippleFinancialInstrument.ghBankPayout) &&
        Objects.equals(this.rwBankPayout, rippleFinancialInstrument.rwBankPayout) &&
        Objects.equals(this.zaBankPayout, rippleFinancialInstrument.zaBankPayout) &&
        Objects.equals(this.ugBankPayout, rippleFinancialInstrument.ugBankPayout) &&
        Objects.equals(this.zmBankPayout, rippleFinancialInstrument.zmBankPayout) &&
        Objects.equals(this.ethWallet, rippleFinancialInstrument.ethWallet) &&
        Objects.equals(this.tronWallet, rippleFinancialInstrument.tronWallet) &&
        Objects.equals(this.solWallet, rippleFinancialInstrument.solWallet) &&
        Objects.equals(this.brPix, rippleFinancialInstrument.brPix) &&
        ...
        Objects.equals(this.cnTrade, rippleFinancialInstrument.cnTrade) &&
        Objects.equals(this.cnIndividual, rippleFinancialInstrument.cnIndividual) &&
        Objects.equals(this.cnIndividualTrade, rippleFinancialInstrument.cnIndividualTrade) &&
        ...
        Objects.equals(this.financialInstrumentType, rippleFinancialInstrument.financialInstrumentType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(usAch, usFedwire, mxSpei, euSepa, gbFps, ngBankPayout, ghBankPayout, rwBankPayout, zaBankPayout, ugBankPayout, zmBankPayout, ethWallet, tronWallet, solWallet, brPix, coPse, brTed, caEft, hkBankPayout, idBifast, krKftc, inNeft, peLbtr, auNpp, jpZengin, cnTrade, cnIndividual, cnIndividualTrade, cnCfxps, clTef, aeIpi, trFast, phNrps, thPromptpay, arInterbanking, currency, label, financialInstrumentType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RippleFinancialInstrumentDTO {\n");
