 ...
 */
@JsonPropertyOrder({
  CaEftDTO.JSON_PROPERTY_BANK_NAME,
  CaEftDTO.JSON_PROPERTY_INSTITUTION_NUMBER,
  CaEftDTO.JSON_PROPERTY_TRANSIT_NUMBER,
  CaEftDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  CaEftDTO.JSON_PROPERTY_ACCOUNT_TYPE
})
@JsonTypeName("ca-eft")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class CaEftDTO {
  ...
  public CaEftDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public CaEftDTO institutionNumber(@javax.annotation.Nonnull String institutionNumber) {
  ...
  @JsonProperty(JSON_PROPERTY_INSTITUTION_NUMBER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setInstitutionNumber(@javax.annotation.Nonnull String institutionNumber) {
    this.institutionNumber = institutionNumber;
  }

  public CaEftDTO transitNumber(@javax.annotation.Nonnull String transitNumber) {
  ...
  @JsonProperty(JSON_PROPERTY_TRANSIT_NUMBER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTransitNumber(@javax.annotation.Nonnull String transitNumber) {
    this.transitNumber = transitNumber;
  }

  public CaEftDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public CaEftDTO accountType(@javax.annotation.Nonnull String accountType) {
  ...
  public boolean equals(Object o) {
    ...
    CaEftDTO caEft = (CaEftDTO) o;
    return Objects.equals(this.bankName, caEft.bankName) &&
        Objects.equals(this.institutionNumber, caEft.institutionNumber) &&
        Objects.equals(this.transitNumber, caEft.transitNumber) &&
        Objects.equals(this.accountNumber, caEft.accountNumber) &&
        Objects.equals(this.accountType, caEft.accountType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, institutionNumber, transitNumber, accountNumber, accountType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CaEftDTO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `institutionNumber` to the URL query string
    if (getInstitutionNumber() != null) {
      try {
        joiner.add(String.format("%sinstitutionNumber%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getInstitutionNumber()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
    ...
    // add `transitNumber` to the URL query string
    if (getTransitNumber() != null) {
      try {
        joiner.add(String.format("%stransitNumber%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getTransitNumber()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
