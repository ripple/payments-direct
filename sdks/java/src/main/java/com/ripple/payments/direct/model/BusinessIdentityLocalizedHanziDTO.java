 ...
 */
@JsonPropertyOrder({
  BusinessIdentityLocalizedHanziDTO.JSON_PROPERTY_BUSINESS_NAME
})
@JsonTypeName("business_identity_localized_hanzi")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BusinessIdentityLocalizedHanziDTO {
  public static final String JSON_PROPERTY_BUSINESS_NAME = "businessName";
  @javax.annotation.Nullable
  private String businessName;

  public BusinessIdentityLocalizedHanziDTO() {
  }

  public BusinessIdentityLocalizedHanziDTO businessName(@javax.annotation.Nullable String businessName) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessIdentityLocalizedHanziDTO businessIdentityLocalizedHanzi = (BusinessIdentityLocalizedHanziDTO) o;
    return Objects.equals(this.businessName, businessIdentityLocalizedHanzi.businessName);
  }
  ...
  public String toString() {
    ...
    sb.append("class BusinessIdentityLocalizedHanziDTO {\n");
