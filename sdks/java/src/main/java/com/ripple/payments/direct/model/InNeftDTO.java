 ...
 */
@JsonPropertyOrder({
  InNeftDTO.JSON_PROPERTY_BANK_NAME,
  InNeftDTO.JSON_PROPERTY_IFSC_CODE,
  InNeftDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("in-neft")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class InNeftDTO {
  public static final String JSON_PROPERTY_BANK_NAME = "bankName";
  @javax.annotation.Nonnull
  private String bankName;

  public static final String JSON_PROPERTY_IFSC_CODE = "ifscCode";
  @javax.annotation.Nonnull
  ...
  public InNeftDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public InNeftDTO ifscCode(@javax.annotation.Nonnull String ifscCode) {
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_IFSC_CODE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  ...
  @JsonProperty(JSON_PROPERTY_IFSC_CODE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setIfscCode(@javax.annotation.Nonnull String ifscCode) {
    this.ifscCode = ifscCode;
  }

  public InNeftDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    InNeftDTO inNeft = (InNeftDTO) o;
    return Objects.equals(this.bankName, inNeft.bankName) &&
        Objects.equals(this.ifscCode, inNeft.ifscCode) &&
        Objects.equals(this.accountNumber, inNeft.accountNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, ifscCode, accountNumber);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class InNeftDTO {\n");
  ...
  public String toUrlQueryString(String prefix) {
    ...
    // add `ifscCode` to the URL query string
    if (getIfscCode() != null) {
      try {
        joiner.add(String.format("%sifscCode%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getIfscCode()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
