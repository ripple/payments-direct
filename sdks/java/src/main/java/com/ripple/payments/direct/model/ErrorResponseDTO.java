...
import com.ripple.payments.direct.model.ErrorDTO;
 ...
 */
@JsonPropertyOrder({
  ErrorResponseDTO.JSON_PROPERTY_STATUS,
  ErrorResponseDTO.JSON_PROPERTY_ERRORS,
  ErrorResponseDTO.JSON_PROPERTY_TIMESTAMP
})
...
public class ErrorResponseDTO {
  ...
  public ErrorResponseDTO status(@javax.annotation.Nonnull Integer status) {
  ...
  public ErrorResponseDTO errors(@javax.annotation.Nonnull List<ErrorDTO> errors) {
  ...
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setErrors(@javax.annotation.Nonnull List<ErrorDTO> errors) {
    this.errors = errors;
  }

  public ErrorResponseDTO timestamp(@javax.annotation.Nullable String timestamp) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, errors, timestamp);
  }
