 ...
 */
@JsonPropertyOrder({
  IdBifastDTO.JSON_PROPERTY_BANK_NAME,
  IdBifastDTO.JSON_PROPERTY_BANK_CODE,
  IdBifastDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("id-bifast")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class IdBifastDTO {
  ...
  public IdBifastDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public IdBifastDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public IdBifastDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    IdBifastDTO idBifast = (IdBifastDTO) o;
    return Objects.equals(this.bankName, idBifast.bankName) &&
        Objects.equals(this.bankCode, idBifast.bankCode) &&
        Objects.equals(this.accountNumber, idBifast.accountNumber);
  }
