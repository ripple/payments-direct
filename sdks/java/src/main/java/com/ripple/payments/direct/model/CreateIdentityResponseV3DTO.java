...
/**
 * CreateIdentityResponseV3DTO
 */
@JsonPropertyOrder({
  CreateIdentityResponseV3DTO.JSON_PROPERTY_IDENTITY_ID,
  CreateIdentityResponseV3DTO.JSON_PROPERTY_VERSION
})
@JsonTypeName("create-identity-response-v3")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class CreateIdentityResponseV3DTO {
  ...
  public CreateIdentityResponseV3DTO() {
  }

  public CreateIdentityResponseV3DTO identityId(@javax.annotation.Nonnull String identityId) {
  ...
  public CreateIdentityResponseV3DTO version(@javax.annotation.Nonnull String version) {
  ...
  public boolean equals(Object o) {
    ...
    CreateIdentityResponseV3DTO createIdentityResponseV3 = (CreateIdentityResponseV3DTO) o;
    return Objects.equals(this.identityId, createIdentityResponseV3.identityId) &&
        Objects.equals(this.version, createIdentityResponseV3.version);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateIdentityResponseV3DTO {\n");
