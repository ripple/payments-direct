...
import com.ripple.payments.direct.model.QuoteErrorDTO;
 ...
 */
@JsonPropertyOrder({
  QuoteErrorResponseDTO.JSON_PROPERTY_ERRORS,
  QuoteErrorResponseDTO.JSON_PROPERTY_STATUS
})
@JsonTypeName("QuoteErrorResponse")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.14.0")
public class QuoteErrorResponseDTO {
  public static final String JSON_PROPERTY_ERRORS = "errors";
  @javax.annotation.Nonnull
  private List<QuoteErrorDTO> errors = new ArrayList<>();
  ...
  public QuoteErrorResponseDTO errors(@javax.annotation.Nonnull List<QuoteErrorDTO> errors) {
    
    this.errors = errors;
    return this;
  }

  public QuoteErrorResponseDTO addErrorsItem(QuoteErrorDTO errorsItem) {
    if (this.errors == null) {
  ...
  public List<QuoteErrorDTO> getErrors() {
    return errors;
  }
  ...
  @JsonProperty(JSON_PROPERTY_ERRORS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setErrors(@javax.annotation.Nonnull List<QuoteErrorDTO> errors) {
    this.errors = errors;
  }

  public QuoteErrorResponseDTO status(@javax.annotation.Nonnull Integer status) {
  ...
  public boolean equals(Object o) {
    ...
    QuoteErrorResponseDTO quoteErrorResponse = (QuoteErrorResponseDTO) o;
    return Objects.equals(this.errors, quoteErrorResponse.errors) &&
        Objects.equals(this.status, quoteErrorResponse.status);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuoteErrorResponseDTO {\n");
