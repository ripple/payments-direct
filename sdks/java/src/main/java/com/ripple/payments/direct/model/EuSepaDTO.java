 ...
 */
@JsonPropertyOrder({
  EuSepaDTO.JSON_PROPERTY_BANK_NAME,
  EuSepaDTO.JSON_PROPERTY_IBAN
})
@JsonTypeName("eu-sepa")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class EuSepaDTO {
  ...
  public EuSepaDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public EuSepaDTO iban(@javax.annotation.Nonnull String iban) {
  ...
  public boolean equals(Object o) {
    ...
    EuSepaDTO euSepa = (EuSepaDTO) o;
    return Objects.equals(this.bankName, euSepa.bankName) &&
        Objects.equals(this.iban, euSepa.iban);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, iban);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EuSepaDTO {\n");
