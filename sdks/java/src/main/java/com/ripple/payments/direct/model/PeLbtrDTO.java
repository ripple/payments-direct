 ...
 */
@JsonPropertyOrder({
  PeLbtrDTO.JSON_PROPERTY_BANK_NAME,
  PeLbtrDTO.JSON_PROPERTY_SWIFT_CODE,
  PeLbtrDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  PeLbtrDTO.JSON_PROPERTY_ACCOUNT_TYPE
})
@JsonTypeName("pe-lbtr")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class PeLbtrDTO {
  ...
  public PeLbtrDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public PeLbtrDTO swiftCode(@javax.annotation.Nonnull String swiftCode) {
  ...
  public PeLbtrDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public PeLbtrDTO accountType(@javax.annotation.Nonnull String accountType) {
  ...
  public boolean equals(Object o) {
    ...
    PeLbtrDTO peLbtr = (PeLbtrDTO) o;
    return Objects.equals(this.bankName, peLbtr.bankName) &&
        Objects.equals(this.swiftCode, peLbtr.swiftCode) &&
        Objects.equals(this.accountNumber, peLbtr.accountNumber) &&
        Objects.equals(this.accountType, peLbtr.accountType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, swiftCode, accountNumber, accountType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class PeLbtrDTO {\n");
