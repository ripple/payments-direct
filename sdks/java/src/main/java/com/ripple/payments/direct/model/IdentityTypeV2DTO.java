...
public enum IdentityTypeV2DTO {
  ...
  IdentityTypeV2DTO(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static IdentityTypeV2DTO fromValue(String value) {
    for (IdentityTypeV2DTO b : IdentityTypeV2DTO.values()) {
