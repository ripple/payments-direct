...
import com.ripple.payments.direct.model.StateTransitionV2DTO;
 ...
 */
@JsonPropertyOrder({
  StateTransitionsResponseV2DTO.JSON_PROPERTY_STATE_TRANSITIONS
})
@JsonTypeName("StateTransitionsResponseV2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class StateTransitionsResponseV2DTO {
  public static final String JSON_PROPERTY_STATE_TRANSITIONS = "stateTransitions";
  @javax.annotation.Nonnull
  private List<StateTransitionV2DTO> stateTransitions = new ArrayList<>();

  public StateTransitionsResponseV2DTO() {
  }

  public StateTransitionsResponseV2DTO stateTransitions(@javax.annotation.Nonnull List<StateTransitionV2DTO> stateTransitions) {
    
    this.stateTransitions = stateTransitions;
    return this;
  }

  public StateTransitionsResponseV2DTO addStateTransitionsItem(StateTransitionV2DTO stateTransitionsItem) {
  ...
  public List<StateTransitionV2DTO> getStateTransitions() {
    return stateTransitions;
  }
  ...
  @JsonProperty(JSON_PROPERTY_STATE_TRANSITIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setStateTransitions(@javax.annotation.Nonnull List<StateTransitionV2DTO> stateTransitions) {
    this.stateTransitions = stateTransitions;
  }
  ...
  public boolean equals(Object o) {
    ...
    StateTransitionsResponseV2DTO stateTransitionsResponseV2 = (StateTransitionsResponseV2DTO) o;
    return Objects.equals(this.stateTransitions, stateTransitionsResponseV2.stateTransitions);
  }
  ...
  public String toString() {
    ...
    sb.append("class StateTransitionsResponseV2DTO {\n");
