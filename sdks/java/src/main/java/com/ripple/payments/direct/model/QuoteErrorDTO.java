 ...
 */
@JsonPropertyOrder({
  QuoteErrorDTO.JSON_PROPERTY_CODE,
  QuoteErrorDTO.JSON_PROPERTY_TITLE,
  QuoteErrorDTO.JSON_PROPERTY_TYPE,
  QuoteErrorDTO.JSON_PROPERTY_DESCRIPTION,
  QuoteErrorDTO.JSON_PROPERTY_TIMESTAMP
})
@JsonTypeName("QuoteError")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class QuoteErrorDTO {
  ...
  public QuoteErrorDTO() {
  }

  public QuoteErrorDTO code(@javax.annotation.Nonnull String code) {
  ...
  public QuoteErrorDTO title(@javax.annotation.Nonnull String title) {
  ...
  public QuoteErrorDTO type(@javax.annotation.Nonnull String type) {
  ...
  public QuoteErrorDTO description(@javax.annotation.Nonnull String description) {
  ...
  public QuoteErrorDTO timestamp(@javax.annotation.Nonnull OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    QuoteErrorDTO quoteError = (QuoteErrorDTO) o;
    return Objects.equals(this.code, quoteError.code) &&
        Objects.equals(this.title, quoteError.title) &&
        Objects.equals(this.type, quoteError.type) &&
        Objects.equals(this.description, quoteError.description) &&
        Objects.equals(this.timestamp, quoteError.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, title, type, description, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QuoteErrorDTO {\n");
