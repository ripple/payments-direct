 ...
 */
@JsonPropertyOrder({
  BusinessIdentityAddressDTO.JSON_PROPERTY_STREET_ADDRESS,
  BusinessIdentityAddressDTO.JSON_PROPERTY_COUNTRY,
  BusinessIdentityAddressDTO.JSON_PROPERTY_CITY,
  BusinessIdentityAddressDTO.JSON_PROPERTY_STATE_OR_PROVINCE,
  BusinessIdentityAddressDTO.JSON_PROPERTY_POSTAL_CODE
})
@JsonTypeName("business_identity_address")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class BusinessIdentityAddressDTO {
  ...
  public BusinessIdentityAddressDTO() {
  }

  public BusinessIdentityAddressDTO streetAddress(@javax.annotation.Nonnull List<String> streetAddress) {
    
    this.streetAddress = streetAddress;
    return this;
  }

  public BusinessIdentityAddressDTO addStreetAddressItem(String streetAddressItem) {
  ...
  public BusinessIdentityAddressDTO country(@javax.annotation.Nonnull String country) {
  ...
  public BusinessIdentityAddressDTO city(@javax.annotation.Nonnull String city) {
  ...
  public BusinessIdentityAddressDTO stateOrProvince(@javax.annotation.Nullable String stateOrProvince) {
  ...
  public BusinessIdentityAddressDTO postalCode(@javax.annotation.Nullable String postalCode) {
  ...
  public boolean equals(Object o) {
    ...
    BusinessIdentityAddressDTO businessIdentityAddress = (BusinessIdentityAddressDTO) o;
    return Objects.equals(this.streetAddress, businessIdentityAddress.streetAddress) &&
        Objects.equals(this.country, businessIdentityAddress.country) &&
        Objects.equals(this.city, businessIdentityAddress.city) &&
        Objects.equals(this.stateOrProvince, businessIdentityAddress.stateOrProvince) &&
        Objects.equals(this.postalCode, businessIdentityAddress.postalCode);
  }

  @Override
  public int hashCode() {
    return Objects.hash(streetAddress, country, city, stateOrProvince, postalCode);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class BusinessIdentityAddressDTO {\n");
  ...
  public String toUrlQueryString(String prefix) {
      ...
      for (int i = 0; i < getStreetAddress().size(); i++) {
        try {
          joiner.add(String.format("%sstreetAddress%s%s=%s", prefix, suffix,
              ...
              URLEncoder.encode(String.valueOf(getStreetAddress().get(i)), "UTF-8").replaceAll("\\+", "%20")));
    ...
    if (getStateOrProvince() != null) {
      try {
        joiner.add(String.format("%sstateOrProvince%s=%s", prefix, suffix, URLEncoder.encode(String.valueOf(getStateOrProvince()), "UTF-8").replaceAll("\\+", "%20")));
      } catch (UnsupportedEncodingException e) {
        // Should never happen, UTF-8 is always supported
        throw new RuntimeException(e);
      }
