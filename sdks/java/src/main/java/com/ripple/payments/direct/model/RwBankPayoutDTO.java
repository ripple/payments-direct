 ...
 */
@JsonPropertyOrder({
  RwBankPayoutDTO.JSON_PROPERTY_BANK_NAME,
  RwBankPayoutDTO.JSON_PROPERTY_BANK_CODE,
  RwBankPayoutDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("rw-bank-payout")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class RwBankPayoutDTO {
  ...
  public RwBankPayoutDTO() {
  }

  public RwBankPayoutDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public RwBankPayoutDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public RwBankPayoutDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    RwBankPayoutDTO rwBankPayout = (RwBankPayoutDTO) o;
    return Objects.equals(this.bankName, rwBankPayout.bankName) &&
        Objects.equals(this.bankCode, rwBankPayout.bankCode) &&
        Objects.equals(this.accountNumber, rwBankPayout.accountNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class RwBankPayoutDTO {\n");
