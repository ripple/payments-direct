...
public class PaymentWithDetailsDTO {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentId, cryptoTransactionHash, initiatedAt, expiresAt, lastStateUpdatedAt, paymentState, originator, destination, adjustedExchangeRate, fees, sourceOfCash, purposeCode, transactionDetails, errors, paymentLabels);
  }
