 ...
 */
@JsonPropertyOrder({
  QuoteCollectionRequestV2DTO.JSON_PROPERTY_QUOTE_AMOUNT,
  QuoteCollectionRequestV2DTO.JSON_PROPERTY_QUOTE_AMOUNT_TYPE,
  QuoteCollectionRequestV2DTO.JSON_PROPERTY_SOURCE_CURRENCY,
  QuoteCollectionRequestV2DTO.JSON_PROPERTY_DESTINATION_CURRENCY,
  QuoteCollectionRequestV2DTO.JSON_PROPERTY_SOURCE_COUNTRY,
  QuoteCollectionRequestV2DTO.JSON_PROPERTY_DESTINATION_COUNTRY,
  QuoteCollectionRequestV2DTO.JSON_PROPERTY_PAYIN_CATEGORY,
  QuoteCollectionRequestV2DTO.JSON_PROPERTY_PAYMENT_RAIL
})
@JsonTypeName("QuoteCollectionRequestV2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class QuoteCollectionRequestV2DTO {
  ...
  public QuoteCollectionRequestV2DTO() {
  }

  public QuoteCollectionRequestV2DTO quoteAmount(@javax.annotation.Nonnull Double quoteAmount) {
  ...
  public QuoteCollectionRequestV2DTO quoteAmountType(@javax.annotation.Nonnull QuoteAmountTypeDTO quoteAmountType) {
  ...
  public QuoteCollectionRequestV2DTO sourceCurrency(@javax.annotation.Nonnull String sourceCurrency) {
  ...
  public QuoteCollectionRequestV2DTO destinationCurrency(@javax.annotation.Nonnull String destinationCurrency) {
  ...
  public QuoteCollectionRequestV2DTO sourceCountry(@javax.annotation.Nullable String sourceCountry) {
  ...
  public QuoteCollectionRequestV2DTO destinationCountry(@javax.annotation.Nullable String destinationCountry) {
  ...
  public QuoteCollectionRequestV2DTO payinCategory(@javax.annotation.Nonnull String payinCategory) {
  ...
  public QuoteCollectionRequestV2DTO paymentRail(@javax.annotation.Nullable String paymentRail) {
  ...
  public boolean equals(Object o) {
    ...
    QuoteCollectionRequestV2DTO quoteCollectionRequestV2 = (QuoteCollectionRequestV2DTO) o;
    return Objects.equals(this.quoteAmount, quoteCollectionRequestV2.quoteAmount) &&
        Objects.equals(this.quoteAmountType, quoteCollectionRequestV2.quoteAmountType) &&
        Objects.equals(this.sourceCurrency, quoteCollectionRequestV2.sourceCurrency) &&
        Objects.equals(this.destinationCurrency, quoteCollectionRequestV2.destinationCurrency) &&
        Objects.equals(this.sourceCountry, quoteCollectionRequestV2.sourceCountry) &&
        Objects.equals(this.destinationCountry, quoteCollectionRequestV2.destinationCountry) &&
        Objects.equals(this.payinCategory, quoteCollectionRequestV2.payinCategory) &&
        Objects.equals(this.paymentRail, quoteCollectionRequestV2.paymentRail);
  }

  @Override
  public int hashCode() {
    return Objects.hash(quoteAmount, quoteAmountType, sourceCurrency, destinationCurrency, sourceCountry, destinationCountry, payinCategory, paymentRail);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class QuoteCollectionRequestV2DTO {\n");
