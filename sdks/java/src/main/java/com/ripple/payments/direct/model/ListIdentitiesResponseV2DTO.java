...
import com.ripple.payments.direct.model.IdentityV2DTO;
 ...
 */
@JsonPropertyOrder({
  ListIdentitiesResponseV2DTO.JSON_PROPERTY_DATA
})
@JsonTypeName("list-identities-response-v2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class ListIdentitiesResponseV2DTO {
  public static final String JSON_PROPERTY_DATA = "data";
  @javax.annotation.Nullable
  private List<IdentityV2DTO> data = new ArrayList<>();

  public ListIdentitiesResponseV2DTO() {
  }

  public ListIdentitiesResponseV2DTO data(@javax.annotation.Nullable List<IdentityV2DTO> data) {
    
    this.data = data;
    return this;
  }

  public ListIdentitiesResponseV2DTO addDataItem(IdentityV2DTO dataItem) {
    if (this.data == null) {
  ...
  public List<IdentityV2DTO> getData() {
    return data;
  }
  ...
  @JsonProperty(JSON_PROPERTY_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setData(@javax.annotation.Nullable List<IdentityV2DTO> data) {
    this.data = data;
  }
  ...
  public boolean equals(Object o) {
    ...
    ListIdentitiesResponseV2DTO listIdentitiesResponseV2 = (ListIdentitiesResponseV2DTO) o;
    return Objects.equals(this.data, listIdentitiesResponseV2.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListIdentitiesResponseV2DTO {\n");
