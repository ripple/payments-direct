 ...
 */
public enum PaymentSortFieldDTO {
  ...
  LAST_STATE_UPDATED_AT("lastStateUpdatedAt"),
  
  PAYMENT_LABEL("paymentLabel");

  private String value;

  PaymentSortFieldDTO(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PaymentSortFieldDTO fromValue(String value) {
    for (PaymentSortFieldDTO b : PaymentSortFieldDTO.values()) {
