 ...
 */
@JsonPropertyOrder({
  GhBankPayoutDTO.JSON_PROPERTY_BANK_NAME,
  GhBankPayoutDTO.JSON_PROPERTY_BANK_CODE,
  GhBankPayoutDTO.JSON_PROPERTY_ACCOUNT_NUMBER
})
@JsonTypeName("gh-bank-payout")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class GhBankPayoutDTO {
  ...
  public GhBankPayoutDTO() {
  }

  public GhBankPayoutDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public GhBankPayoutDTO bankCode(@javax.annotation.Nonnull String bankCode) {
  ...
  public GhBankPayoutDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public boolean equals(Object o) {
    ...
    GhBankPayoutDTO ghBankPayout = (GhBankPayoutDTO) o;
    return Objects.equals(this.bankName, ghBankPayout.bankName) &&
        Objects.equals(this.bankCode, ghBankPayout.bankCode) &&
        Objects.equals(this.accountNumber, ghBankPayout.accountNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class GhBankPayoutDTO {\n");
