 ...
 */
@JsonPropertyOrder({
  DestinationV2DTO.JSON_PROPERTY_BENEFICIARY_FINANCIAL_INSTRUMENT_ID,
  DestinationV2DTO.JSON_PROPERTY_DESTINATION_AMOUNT,
  DestinationV2DTO.JSON_PROPERTY_DESTINATION_COUNTRY,
  DestinationV2DTO.JSON_PROPERTY_DESTINATION_CURRENCY,
  DestinationV2DTO.JSON_PROPERTY_DESTINATION_BLOCKCHAIN_NETWORK,
...
public class DestinationV2DTO {
  ...
  public DestinationV2DTO beneficiaryFinancialInstrumentId(@javax.annotation.Nullable String beneficiaryFinancialInstrumentId) {
  ...
  @JsonProperty(JSON_PROPERTY_BENEFICIARY_FINANCIAL_INSTRUMENT_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBeneficiaryFinancialInstrumentId(@javax.annotation.Nullable String beneficiaryFinancialInstrumentId) {
    this.beneficiaryFinancialInstrumentId = beneficiaryFinancialInstrumentId;
  }

  public DestinationV2DTO destinationAmount(@javax.annotation.Nullable Double destinationAmount) {
  ...
  public DestinationV2DTO destinationCountry(@javax.annotation.Nullable String destinationCountry) {
  ...
  public DestinationV2DTO destinationCurrency(@javax.annotation.Nullable String destinationCurrency) {
  ...
  public DestinationV2DTO destinationBlockchainNetwork(@javax.annotation.Nullable String destinationBlockchainNetwork) {
  ...
  public DestinationV2DTO beneficiaryIdentityId(@javax.annotation.Nullable String beneficiaryIdentityId) {
  ...
  @JsonProperty(JSON_PROPERTY_BENEFICIARY_IDENTITY_ID)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setBeneficiaryIdentityId(@javax.annotation.Nullable String beneficiaryIdentityId) {
    this.beneficiaryIdentityId = beneficiaryIdentityId;
  }

  public DestinationV2DTO beneficiaryIdentityVersion(@javax.annotation.Nullable Integer beneficiaryIdentityVersion) {
  ...
  public DestinationV2DTO beneficiaryIdentityNickName(@javax.annotation.Nullable String beneficiaryIdentityNickName) {
  ...
  public DestinationV2DTO payout(@javax.annotation.Nullable String payout) {
  ...
  public boolean equals(Object o) {
    ...
    DestinationV2DTO destinationV2 = (DestinationV2DTO) o;
    return Objects.equals(this.beneficiaryFinancialInstrumentId, destinationV2.beneficiaryFinancialInstrumentId) &&
        Objects.equals(this.destinationAmount, destinationV2.destinationAmount) &&
        Objects.equals(this.destinationCountry, destinationV2.destinationCountry) &&
        Objects.equals(this.destinationCurrency, destinationV2.destinationCurrency) &&
        Objects.equals(this.destinationBlockchainNetwork, destinationV2.destinationBlockchainNetwork) &&
  ...
  public String toString() {
    ...
    sb.append("class DestinationV2DTO {\n");
