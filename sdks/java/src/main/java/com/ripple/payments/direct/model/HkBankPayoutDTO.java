 ...
 */
@JsonPropertyOrder({
  HkBankPayoutDTO.JSON_PROPERTY_BANK_NAME,
  HkBankPayoutDTO.JSON_PROPERTY_ACCOUNT_NUMBER,
  HkBankPayoutDTO.JSON_PROPERTY_ACCOUNT_HOLDER_NAME,
  HkBankPayoutDTO.JSON_PROPERTY_SWIFT_CODE,
  HkBankPayoutDTO.JSON_PROPERTY_CURRENCY
})
@JsonTypeName("hk-bank-payout")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class HkBankPayoutDTO {
  ...
  public HkBankPayoutDTO() {
  }

  public HkBankPayoutDTO bankName(@javax.annotation.Nonnull String bankName) {
  ...
  public HkBankPayoutDTO accountNumber(@javax.annotation.Nonnull String accountNumber) {
  ...
  public HkBankPayoutDTO accountHolderName(@javax.annotation.Nonnull String accountHolderName) {
  ...
  public HkBankPayoutDTO swiftCode(@javax.annotation.Nonnull String swiftCode) {
  ...
  public HkBankPayoutDTO currency(@javax.annotation.Nullable String currency) {
  ...
  public boolean equals(Object o) {
    ...
    HkBankPayoutDTO hkBankPayout = (HkBankPayoutDTO) o;
    return Objects.equals(this.bankName, hkBankPayout.bankName) &&
        Objects.equals(this.accountNumber, hkBankPayout.accountNumber) &&
        Objects.equals(this.accountHolderName, hkBankPayout.accountHolderName) &&
        Objects.equals(this.swiftCode, hkBankPayout.swiftCode) &&
        Objects.equals(this.currency, hkBankPayout.currency);
  }

  @Override
  public int hashCode() {
    return Objects.hash(bankName, accountNumber, accountHolderName, swiftCode, currency);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class HkBankPayoutDTO {\n");
