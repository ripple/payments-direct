 ...
 */
@JsonPropertyOrder({
  SearchPaymentsRequestV2DTO.JSON_PROPERTY_FILTER,
  SearchPaymentsRequestV2DTO.JSON_PROPERTY_SORT,
  SearchPaymentsRequestV2DTO.JSON_PROPERTY_PAGE
})
@JsonTypeName("SearchPaymentsRequestV2")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.13.0")
public class SearchPaymentsRequestV2DTO {
  ...
  public SearchPaymentsRequestV2DTO() {
  }

  public SearchPaymentsRequestV2DTO filter(@javax.annotation.Nullable PaymentFilterV2DTO filter) {
  ...
  public SearchPaymentsRequestV2DTO sort(@javax.annotation.Nullable SortV2DTO sort) {
  ...
  public SearchPaymentsRequestV2DTO page(@javax.annotation.Nullable PageDTO page) {
  ...
  public boolean equals(Object o) {
    ...
    SearchPaymentsRequestV2DTO searchPaymentsRequestV2 = (SearchPaymentsRequestV2DTO) o;
    return Objects.equals(this.filter, searchPaymentsRequestV2.filter) &&
        Objects.equals(this.sort, searchPaymentsRequestV2.sort) &&
        Objects.equals(this.page, searchPaymentsRequestV2.page);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchPaymentsRequestV2DTO {\n");
