...
|**updatedAt** | **OffsetDateTime** | The time at which the identity was last updated |  |
...
|**internalId** | **String** | The client-provided unique identifier supplied when the identity was created or last updated. |  [optional] |
